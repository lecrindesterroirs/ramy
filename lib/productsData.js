...
export const PRODUCTS = [
  ...
  // ─── Madeleines ──────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: 'Madeleines Mado Paris pour entreprise — coffret 10 pièces livraison Paris',
    seoArticle: `
      <p>Le <strong>coffret de 10 madeleines Mado Paris</strong> est une façon délicate et mémorable de marquer une occasion en entreprise. Ces madeleines pur beurre, au zeste de citron, incarnent le savoir-faire français dans ce qu'il a de plus élégant : un produit simple, irréprochable, qui parle d'artisanat à chaque bouchée.</p>
      <h2>Mado Paris : les meilleures madeleines de Paris</h2>
      <p>Nous avons choisi de travailler avec <strong>Mado Paris</strong> pour une raison simple : leurs madeleines sont réputées comme <strong>les meilleures de Paris</strong>. Fabriquées chaque jour dans leur atelier parisien, sans huile de palme, avec des œufs et un beurre de qualité supérieure, elles offrent une texture moelleuse, une bosse généreuse et un parfum délicat qui réveille instantanément le souvenir d'une enfance gourmande.</p>
      <h2>Pour 4 à 6 personnes en pause gourmande</h2>
      <p>Ce coffret de 10 pièces est idéal pour une petite réunion, un entretien de recrutement ou un déjeuner de travail avec un ou deux clients. Proposer des madeleines artisanales plutôt que des biscuits industriels, c'est affirmer des valeurs — qualité, authenticité, attention au détail — que vos interlocuteurs associeront à votre marque.</p>
  ...
  },
  {
    ...
    allergens: ['Gluten', 'Lait', 'Œufs'],
    ingredients: 'Farine de blé, beurre, œufs, sucre de canne, miel, zeste de citron. Fabriqué par Mado Paris.',
    seoTitle: 'Coffret 20 madeleines entreprise Paris — pause gourmande Île-de-France',
    seoArticle: `
      ...
      <h2>Les meilleures madeleines de Paris à votre bureau</h2>
      <p>Les madeleines Mado Paris sont réputées comme <strong>les meilleures madeleines de Paris</strong>. Fabriquées chaque jour dans leur atelier parisien, sans huile de palme, elles portent un savoir-faire que vous pouvez mettre en avant auprès de vos équipes et de vos clients — un choix qui se remarque.</p>
      <h2>Un produit de qualité qui se distingue</h2>
      <p>La madeleine de Mado Paris n'est pas une madeleine générique. Elle est fabriquée à la main, avec un beurre fondu à la bonne température pour obtenir la bosse caractéristique — signe d'une cuisson maîtrisée. Le moelleux, la légèreté et le parfum citronné en font un produit que vos collaborateurs remarquent et dont ils se souviennent.</p>
  ...
  },
  {
    ...
    allergens: ['Gluten', 'Lait', 'Œufs'],
    ingredients: 'Farine de blé, beurre, œufs, sucre de canne, miel, zeste de citron. Fabriqué par Mado Paris.',
    seoTitle: 'Grand coffret 50 madeleines — traiteur événement entreprise Paris',
    seoArticle: `
      ...
      <p>Offrir 50 madeleines Mado Paris à vos collaborateurs lors d'un anniversaire d'entreprise, d'une clôture de projet ou d'une journée de cohésion, c'est un geste attentionné et mémorable. À la différence des boîtes de chocolats génériques, ces madeleines — réputées comme <strong>les meilleures de Paris</strong> — portent une histoire artisanale et un engagement qualité que vos équipes perçoivent immédiatement.</p>
      <h2>Format événementiel, rapport qualité-prix exceptionnel</h2>
      <p>À 2,38 € la madeleine, ce grand coffret offre un <strong>rapport qualité-prix imbattable</strong> pour un produit artisanal de cette qualité. Chaque madeleine est fabriquée à Paris, sans compromis sur les matières premières, dans le respect des normes de fabrication artisanale.</p>
