...
export const PRODUCTS = [
  // ─── Viennoiseries ───────────────────────────────────────────────────────────
  {
    ...
    name: 'Croissants & pains au chocolat pur beurre',
    shortName: 'Croissants & pains au chocolat pur beurre',
    price: 26.80,
    ...
    ingredients: 'Plateau de 16 mini viennoiseries : 8 croissants et 8 pains au chocolat pur beurre Charentes-Poitou. Feuilletage irréprochable, moelleux en bouche, cuits frais le matin même. Idéal pour un petit-déjeuner d\'équipe ou un accueil de partenaires. Pour 6 à 8 personnes.',
    ...
    seoArticle: `
      ...
      <p>Chez L'Écrin Traiteur, nous travaillons exclusivement avec des boulangers artisans parisiens qui utilisent un <strong>beurre Charentes-Poitou</strong> pour leurs viennoiseries. La différence est immédiate : une pâte aérée, un feuilletage qui se tient, un fondant en bouche qui laisse une impression durable sur vos collaborateurs et clients.</p>
      ...
      <p>Que vous soyez une <strong>PME parisienne</strong>, un cabinet de conseil du 8ème, ou un grand groupe en Île-de-France, ce plateau s'intègre naturellement dans votre budget traiteur. Simple à commander en ligne, sans engagement de volume, avec une facturation entreprise disponible sur demande.</p>
    `,
  },
  {
    id: 'chouquettes',
    ...
    seoArticle: `
      ...
      <p>Commandez en ligne avant <strong>14h la veille</strong> et recevez votre plateau dès 6h30. L'Écrin Traiteur assure la livraison dans tout Paris et les communes d'Île-de-France desservies. Pas d'abonnement, pas d'engagement de volume, à partir de 50 € HT de commande.</p>
    `,
  },
  {
    id: 'viennoiseries-melangees',
    name: 'Assortiment de viennoiseries pur beurre',
    shortName: 'Assortiment de viennoiseries pur beurre',
    price: 48.90,
    ...
    seoArticle: `
      ...
      <p>L'Écrin Traiteur travaille avec des artisans boulangers sélectionnés pour leur rigueur et la qualité de leurs matières premières. <strong>Beurre Charentes-Poitou, œufs frais, farines françaises</strong> : chaque pièce est fabriquée dans le respect des méthodes traditionnelles. Nous refusons les viennoiseries industrielles ou surgelées.</p>
  ...
  // ─── Madeleines ──────────────────────────────────────────────────────────────
  {
    ...
    name: 'Coffret de 10 madeleines Octobre Rose',
    shortName: 'Coffret Octobre Rose',
    price: 29.00,
    label: '10 madeleines · 29,00€',
    description: "Madeleines Mado Paris glaçage rose, édition Octobre Rose",
    qty: '10 pièces',
    category: 'patisserie',
    ...
    allergens: ['Gluten', 'Lait', 'Œufs'],
    ingredients: 'Farine de blé, beurre, œufs, sucre de canne, miel. Glaçage rose et décor filet. Fabriqué par Mado Paris.',
    seoTitle: 'Coffret de madeleines Octobre Rose, entreprise Paris',
    seoArticle: `
      <p>Nos madeleines Mado Paris déclinées en édition <strong>Octobre Rose</strong> : glaçage rose et décor filet, préparées par notre partenaire pâtissier Mado. Pour tout achat de ce coffret, <strong>1 € est reversé à l'association Ruban Rose</strong>, en plus de notre engagement général d'1 € par convive servi sur toutes les commandes du mois d'octobre.</p>
      <h2>Un goûter solidaire pour votre équipe</h2>
      <p>Dix pièces, la quantité idéale pour un petit-déjeuner d'équipe ou une pause de sensibilisation. Voir notre <a href="/creations/evenements-saisonniers/octobre-rose">offre Octobre Rose complète</a>.</p>
      <h2>Commander votre coffret Octobre Rose à Paris</h2>
      <p>Livré <strong>dès 6h30</strong> à Paris et en Île-de-France, commande jusqu'à <strong>14h la veille</strong>. Disponible durant tout le mois d'octobre.</p>
    `,
  },
  {
    id: 'madeleines-10',
...

  {
    ...
    category: 'patisserie',
    categoryLabel: 'Pâtisserie',
    img: '/prod-carrot-cake.webp',
    dietary: ['Végétarien'],
    allergens: ['Gluten', 'Lait', 'Œufs'],
    ingredients: 'Carrot cake maison, tranché sur plateau. Carotte râpée et épices douces, mie moelleuse et parfumée. Celui qui change du chocolat. Format 5 à 6 personnes.',
    seoTitle: 'Carrot cake maison traiteur Paris',
    seoArticle: `
      <p>Le <strong>carrot cake maison</strong> mise sur la carotte râpée et les épices douces : une mie dense et humide, parfumée sans être sucrée à l'excès. C'est le cake qui intrigue ceux qui ne l'ont jamais goûté et qui rassure ceux qui le connaissent déjà.</p>
      <h2>La carotte fait le moelleux</h2>
      <p>La <strong>carotte râpée</strong> libère son eau à la cuisson, et c'est elle qui donne cette mie humide qui se tient plusieurs heures sur un plateau, sans qu'on ait besoin de forcer sur le beurre. Les épices font le reste du travail.</p>
      <h2>Le choix qui sort du duo marbré-chocolat</h2>
      <p>Sur une pause d'après-midi ou un anniversaire d'équipe, le carrot cake change de ce que tout le monde attend. Il plaît largement, y compris à ceux qui trouvent les gâteaux d'entreprise trop sucrés.</p>
      <h2>Commander un carrot cake pour le bureau à Paris</h2>
      <p>Format 5 à 6 personnes, livré <strong>dès 6h30</strong> à Paris et en Île-de-France, commande jusqu'à <strong>14h la veille</strong>. Il complète bien un plateau de viennoiseries quand une corbeille de fruits ne suffit pas.</p>
    `,
  },
  ...
  {
    id: 'chocolat-chaud-noel',
    name: 'Chocolat Chaud de Noël',
    shortName: 'Chocolat Chaud de Noël',
    price: 19.50,
    label: '1 litre · 19,50€',
    description: '1 litre · Chocolat chaud artisanal Valrhona, pour vos goûters de fin d\'année',
    ...
    allergens: ['Lait'],
    ingredients: "Lait entier, chocolat noir Valrhona, sucre. Préparé artisanalement le matin même. Conditionné en thermos isotherme d'1 litre.",
    seoTitle: "Chocolat chaud de Noël pour l'arbre de Noël d'entreprise, Paris",
    seoArticle: `
      <p>Le <strong>chocolat chaud de Noël</strong> est la boisson qui réchauffe petits et grands lors d'un <a href="/journal/arbre-de-noel-entreprise-cse-paris">arbre de Noël d'entreprise</a>. Pas de poudre à diluer : chez L'Écrin, on fait fondre du <strong>chocolat noir Valrhona</strong> dans du lait entier, le matin même, pour un chocolat onctueux et franc en cacao.</p>
      <h2>Le format thermos, pensé pour un goûter d'enfants</h2>
      <p>Conditionné en thermos isotherme d'1 litre (6 à 8 tasses), il reste chaud pendant plusieurs heures : idéal pour un après-midi d'arbre de Noël où les enfants se resservent entre deux tours de manège ou de photomaton. On l'installe à côté des crêpes, des gaufres et de la fontaine au chocolat pour composer un vrai goûter de fête.</p>
      <h2>Un chocolat chaud pour tous les moments de décembre</h2>
      <p>Ce même chocolat chaud artisanal accompagne aussi bien un petit-déjeuner d'équipe en plein hiver qu'un séminaire de décembre. Commandé seul ou associé aux <a href="/creations/animations-culinaires">animations culinaires</a> de votre arbre de Noël, il se prépare et se livre le matin même à Paris et en Île-de-France.</p>
    `,
  },
  {
  ...
  },
  {
    ...
    dietary: ['Végétarien'],
    allergens: ['Gluten', 'Lait', 'Œufs'],
    ingredients: '6 cookies maison artisanaux assortis. Beurre fin, sucre roux, œufs, ingrédients de qualité premium selon les saveurs.',
    ...
    seoArticle: `
      ...
      <p>Laura Todd a importé à Paris la culture du <strong>vrai cookie américain</strong>, épais, chewy, généreux, en lui apportant l'exigence française des matières premières. Beurre fin, chocolat de couverture, farine française, sel de Guérande : chaque ingrédient est choisi pour contribuer à un résultat final irréprochable.</p>
  ...
  },
  {
    ...
    description: '12 Saumon Fumé & Cream Cheese, 12 Thon & Herbes Fraîches',
    qty: '24 pièces',
    category: 'petits-dejeuners',
    categoryLabel: 'Petits-Déjeuners & Pauses',
    ...
    ingredients: 'Pain brioché moelleux découpé en triangles.\nAssortiment :\n- 12 clubs Saumon Fumé & Cream Cheese\n- 12 clubs Thon & Herbes Fraîches',
    seoTitle: 'Plateau clubs sandwichs Paris',
    seoArticle: `
      <p>Notre plateau de clubs sandwichs moelleux, découpés en triangles, accompagne un déjeuner d'équipe ou une réunion de travail. Assortiment de 24 pièces : saumon fumé au cream cheese et thon aux herbes fraîches.</p>
    `,
  },
  {
    section: 'petit-dejeuner-sale',
