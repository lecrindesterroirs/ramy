...
export const BOISSONS = [
  ...
  },
  {
    ...
    category: 'jus',
    categoryLabel: 'Jus & Nectars',
    img: '/bois-jus-orange-presse.png',
    dietary: ['Vegan', 'Sans gluten'],
    allergens: [],
