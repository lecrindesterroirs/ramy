...
export const CITIES = [
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <h2>Petit-déjeuner d'entreprise à Boulogne-Billancourt, viennoiseries et coffrets</h2>
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <h2>Petit-déjeuner d'entreprise à Neuilly-sur-Seine, à la hauteur des exigences neuilléennes</h2>
      <p>Neuilly-sur-Seine est associée à un certain niveau d'exigence, en affaires comme en réception. Nos viennoiseries sont fabriquées au <strong>pur beurre</strong> par des artisans boulangers parisiens. Nos macarons sont signés Pierre Morel. Nos madeleines Mado Paris sont réputées comme les meilleures de la capitale. Des noms qui parlent à vos interlocuteurs.</p>
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <h2>Petit-déjeuner d'entreprise à Levallois-Perret, le hub créatif du 92</h2>
  ...
  },
  {
    ...
    metaDescription: "Petits-déjeuners, plateaux repas et cocktails livrés à Puteaux et sur les tours de La Défense. Livraison dès 6h30, sans minimum, devis sous 24h.",
    seoArticle: `
      ...
      <h2>Petit-déjeuner d'entreprise à Puteaux, pauses pour grandes organisations</h2>
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <h2>Petit-déjeuner d'entreprise à Nanterre, universités et entreprises</h2>
      <p>Qu'il s'agisse d'entreprises classiques, de structures universitaires ou d'organismes de formation, nous livrons vos petits-déjeuners d'équipe, viennoiseries artisanales et coffrets de madeleines dans l'ensemble de Nanterre avec le même niveau de qualité. Commandez avant <strong>14h la veille</strong> pour recevoir votre commande dès 6h30.</p>
    `,
  },
  {
  ...
  },
  {
    ...
    seoArticle: `
      <p><strong>Gennevilliers</strong> conjugue un port industriel actif et des zones d'activités tertiaires en pleine croissance, à deux pas d'Asnières et de La Défense. L'Écrin Traiteur y livre chaque matin entreprises, PME et sites logistiques avec la même exigence artisanale que dans tout le 92.</p>
      <h2>Petit-déjeuner d'entreprise à Gennevilliers, du port aux bureaux</h2>
      <p>Que votre équipe soit installée près du port de Gennevilliers, dans la ZAC des Grésillons ou en centre-ville, nous livrons viennoiseries artisanales, coffrets de madeleines et plateaux de fruits frais dès <strong>6h30</strong>, prêts pour votre première réunion.</p>
      <h2>Livraison traiteur Gennevilliers, zones industrielles et tertiaires</h2>
      <p>Nos livreurs connaissent les accès spécifiques aux sites industriels et logistiques comme aux immeubles de bureaux plus classiques. Procédures de sécurité, quais de livraison, horaires contraints : nous nous adaptons à chaque configuration.</p>
      <h2>Commander votre traiteur à Gennevilliers avant 14h</h2>
      <p>Commande en ligne avant <strong>14h la veille</strong>, livraison dès 6h30 dans tout Gennevilliers et les communes limitrophes. Facturation entreprise avec TVA disponible.</p>
    `,
  },
  {
    slug: 'clichy',
