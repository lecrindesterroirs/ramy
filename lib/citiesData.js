...
export const CITIES = [
  {
    ...
    heroDescription: 'De la Défense à Nation, de Montparnasse à l\'Opéra — L\'Écrin Traiteur livre dans tous les arrondissements de Paris dès 6h30.',
    ...
    quartiers: [
      {
        ...
        heroDescription: 'Le 8e arrondissement — Triangle d\'or, Madeleine, boulevard Haussmann — L\'Écrin Traiteur livre dans les sièges sociaux, cabinets et hôtels d\'affaires du quartier le plus corporate de Paris.',
        linkedZones: ['Paris 8e', 'Champs-Élysées'],
        seoTitle: 'Traiteur Paris 8e arrondissement — Livraison petit-déjeuner Champs-Élysées Triangle d\'or',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le 8e arrondissement de Paris : Champs-Élysées, Triangle d\'or, Madeleine. Artisans sélectionnés, livraison dès 6h30.',
        seoArticle: `
          ...
          <p>Le 8e arrondissement est le quartier des sièges sociaux premium, des banques d'affaires et des maisons de luxe. Nos produits artisanaux — viennoiseries pur beurre, macarons Pierre Morel, madeleines bio Mado Paris — s'inscrivent naturellement dans cet environnement où l'excellence est un standard attendu.</p>
      ...
      },
      {
        ...
        name: 'Paris 9e — Opéra',
        heroDescription: 'Le 9e arrondissement — Opéra, Grands Boulevards, Notre-Dame-de-Lorette — L\'Écrin Traiteur livre dans les agences, startups et grandes entreprises de ce quartier en plein essor digital.',
        linkedZones: ['Paris 9e', 'Opéra'],
        seoTitle: 'Traiteur Paris 9e arrondissement — Livraison petit-déjeuner entreprise Opéra Grands Boulevards',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le 9e arrondissement : Opéra, Grands Boulevards, Notre-Dame-de-Lorette. Livraison dès 6h30.',
        seoArticle: `
      ...
      },
      {
        ...
        heroDescription: 'Le 15e arrondissement — Front-de-Seine, Beaugrenelle, Montparnasse — L\'Écrin Traiteur livre dans les tours de bureaux et les sièges sociaux du plus grand arrondissement de Paris.',
        linkedZones: ['Paris 15e'],
        seoTitle: 'Traiteur Paris 15e arrondissement — Livraison petit-déjeuner Front-de-Seine Beaugrenelle',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le 15e arrondissement : Front-de-Seine, Beaugrenelle, Montparnasse. Artisans sélectionnés, livraison dès 6h30.',
        seoArticle: `
          ...
          <p>Au-delà des tours, le 15e abrite un tissu dense de PME, cabinets et agences autour de Montparnasse, de la Convention et de Vaugirard. Pour vos réunions matinales, vos accueils clients ou vos pauses d'équipe, L'Écrin Traiteur propose un choix complet de viennoiseries artisanales, coffrets bio et plateaux sur mesure.</p>
      ...
      },
      {
        ...
        heroDescription: 'Le 16e arrondissement — Trocadéro, Victor Hugo, Passy, La Muette — L\'Écrin Traiteur livre dans les family offices, cabinets d\'affaires et sièges internationaux de l\'arrondissement le plus huppé de Paris.',
        linkedZones: ['Paris 16e'],
        seoTitle: 'Traiteur Paris 16e arrondissement — Livraison petit-déjeuner entreprise Trocadéro Victor Hugo',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le 16e arrondissement : Trocadéro, Victor Hugo, Passy, La Muette. Standards premium, livraison dès 6h30.',
        seoArticle: `
      ...
      },
      {
        ...
        heroDescription: 'Le 17e arrondissement — Batignolles, Wagram, Ternes, Porte Maillot — L\'Écrin Traiteur livre dans les cabinets, agences et entreprises de ce quartier tertiaire haut de gamme.',
        linkedZones: ['Paris 17e'],
        seoTitle: 'Traiteur Paris 17e arrondissement — Livraison petit-déjeuner entreprise Batignolles Wagram',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le 17e : Batignolles, Wagram, Ternes, Pereire. Artisans sélectionnés, livraison dès 6h30.',
        seoArticle: `
      ...
      },
      {
        ...
        heroDescription: 'Le 1er arrondissement — Palais-Royal, Châtelet-Les-Halles, Louvre, Vendôme — L\'Écrin Traiteur livre dans les institutions financières, sièges premium et cabinets discrets du quartier le plus historique de Paris.',
        linkedZones: ['Paris 1er'],
        seoTitle: 'Traiteur Paris 1er arrondissement — Livraison petit-déjeuner Louvre Châtelet Palais-Royal',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le 1er arrondissement : Palais-Royal, Châtelet, Louvre, Vendôme. Artisans sélectionnés, livraison dès 6h30.',
        faq: [
      ...
      },
      {
        ...
        heroDescription: 'Le 2e arrondissement — Silicon Sentier, Bourse, Grands Boulevards — L\'Écrin Traiteur livre dans le quartier qui concentre le plus de startups au mètre carré en France.',
        linkedZones: ['Paris 2e'],
        seoTitle: 'Traiteur Paris 2e arrondissement — Livraison petit-déjeuner Sentier startups Bourse',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 2e arrondissement : Silicon Sentier, Bourse, Grands Boulevards. Livraison dès 6h30 pour startups et grandes entreprises.',
        faq: [
      ...
      },
      {
        ...
        heroDescription: 'Le 3e arrondissement — Haut-Marais, Carreau du Temple, République — L\'Écrin Traiteur livre dans les agences créatives, showrooms de mode et galeries d\'art du quartier le plus branché de Paris.',
        linkedZones: ['Paris 3e'],
        seoTitle: 'Traiteur Paris 3e arrondissement — Livraison petit-déjeuner Haut-Marais agences créatives',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 3e arrondissement : Haut-Marais, Carreau du Temple, agences et showrooms. Produits artisanaux, livraison dès 6h30.',
        faq: [
      ...
      },
      {
        ...
        heroDescription: 'Le 6e arrondissement — Saint-Germain-des-Prés, Odéon, Luxembourg — L\'Écrin Traiteur livre dans les maisons d\'édition, cabinets d\'avocats d\'affaires et sièges de luxe du quartier le plus intellectuel de Paris.',
        linkedZones: ['Paris 6e'],
        seoTitle: 'Traiteur Paris 6e arrondissement — Livraison petit-déjeuner Saint-Germain édition luxe cabinets',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 6e arrondissement : Saint-Germain-des-Prés, édition, cabinets d\'avocats, maisons de luxe. Livraison dès 6h30.',
        faq: [
      ...
      },
      {
        ...
        heroDescription: 'Le 7e arrondissement — Invalides, Assemblée Nationale, ministères, ambassades — L\'Écrin Traiteur livre dans les institutions gouvernementales, organisations internationales et think tanks de la rive gauche institutionnelle.',
        linkedZones: ['Paris 7e'],
        seoTitle: 'Traiteur Paris 7e arrondissement — Livraison petit-déjeuner Invalides ministères institutions',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 7e arrondissement : Invalides, ministères, ambassades, organisations internationales. Livraison discrète dès 6h30.',
        faq: [
      ...
      },
      {
        ...
        heroDescription: 'Le 12e arrondissement — Bercy, Nation, Gare de Lyon — L\'Écrin Traiteur livre dans les entreprises du ministère des Finances, les sièges tertiaires de l\'Est parisien et les espaces de travail autour de la Gare de Lyon.',
        linkedZones: ['Paris 12e'],
        seoTitle: 'Traiteur Paris 12e arrondissement — Livraison petit-déjeuner Bercy Nation Gare de Lyon',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 12e arrondissement : Bercy, Nation, Gare de Lyon. Livraison dès 6h30 pour entreprises et administrations.',
        faq: [
      ...
      },
      {
        ...
        heroDescription: 'Le 13e arrondissement — Paris Rive Gauche, BNF, Austerlitz, Tolbiac — L\'Écrin Traiteur livre dans l\'un des quartiers d\'affaires les plus dynamiques de la rive gauche, entre grandes entreprises, startups deeptech et campus universitaires.',
        linkedZones: ['Paris 13e'],
        seoTitle: 'Traiteur Paris 13e arrondissement — Livraison petit-déjeuner Paris Rive Gauche BNF entreprise',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 13e arrondissement : Paris Rive Gauche, BNF, Tolbiac, Austerlitz. Produits bio et artisanaux, livraison dès 6h30.',
        faq: [
          ...
          { q: 'Proposez-vous des produits bio et vegan pour les entreprises engagées du 13e ?', a: 'Oui. Nos madeleines Mado Paris sont certifiées Bio, nos brochettes de fruits et compotes sont vegan, nos produits sont sans huile de palme. Le 13e étant un quartier sensible aux valeurs RSE, nous sommes le bon partenaire.' },
        ],
        seoArticle: `
          ...
          <p>Les entreprises de Paris Rive Gauche partagent souvent des valeurs d'innovation et d'engagement. Nos produits artisanaux y trouvent une résonance naturelle : <strong>madeleines bio Mado Paris</strong> certifiées Agriculture Biologique, produits sans huile de palme, traçabilité complète de nos artisans. Commander chez L'Écrin Traiteur, c'est aussi une cohérence avec les valeurs RSE de votre organisation.</p>
      ...
      },
      {
        ...
        heroDescription: 'Le 14e arrondissement — Tour Montparnasse, Alésia, Denfert-Rochereau — L\'Écrin Traiteur livre dans les entreprises de la Tour Montparnasse, les cabinets et PME du quartier Alésia et les espaces tertiaires du 14e.',
        linkedZones: ['Paris 14e'],
        seoTitle: 'Traiteur Paris 14e arrondissement — Livraison petit-déjeuner Montparnasse bureau entreprise',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le 14e arrondissement : Tour Montparnasse, Alésia, Denfert. Artisans sélectionnés, livraison dès 6h30.',
        faq: [
    ...
    seoTitle: 'Traiteur d\'entreprise à Paris — Livraison petits-déjeuners & pauses dès 6h30',
    seoArticle: `
      <p>Paris est au cœur de l'activité de <strong>L'Écrin Traiteur</strong>. Que vous soyez installé dans un bureau du 8e arrondissement face aux Champs-Élysées, dans un open space du 9e near l'Opéra, ou dans une tour du 15e à Front-de-Seine, nous livrons votre petit-déjeuner d'entreprise <strong>dès 6h30</strong>, chaque matin, partout à Paris.</p>
      <h2>Traiteur Paris : une exigence à la hauteur de la capitale</h2>
      <p>Paris est exigeante — ses professionnels le sont aussi. Chez L'Écrin Traiteur, nous sélectionnons nos artisans boulangers, pâtissiers et épiciers fins dans les meilleurs ateliers parisiens. Chaque viennoiserie sort du four le matin même. Chaque coffret de madeleines est fabriqué par des artisans certifiés Bio. Chaque plateau est préparé avec le soin que méritent vos réunions.</p>
  ...
  },
  {
    ...
    heroDescription: 'Boulogne-Billancourt, capitale économique du 92 — L\'Écrin Traiteur livre dans le Trapèze, le centre-ville et tous les parcs d\'affaires.',
    zones: ['Le Trapèze', 'Pont-de-Sèvres', 'Centre-ville', 'Parc de Saint-Cloud', 'Île Seguin'],
    quartiers: [
      {
        slug: 'trapeze',
        name: 'Le Trapèze',
        heroDescription: 'Le Trapèze — quartier d\'affaires moderne de Boulogne-Billancourt, entre la Seine et les tours de Pont-de-Sèvres — L\'Écrin Traiteur livre dans tous les immeubles du secteur dès 6h30.',
        linkedZones: ['Le Trapèze', 'Pont-de-Sèvres', 'Île Seguin'],
        seoTitle: 'Traiteur Le Trapèze Boulogne-Billancourt — Livraison petit-déjeuner quartier d\'affaires',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners d\'entreprise dans le Trapèze à Boulogne-Billancourt. Pont-de-Sèvres, Île Seguin. Livraison dès 6h30.',
        seoArticle: `
    ...
    seoTitle: 'Traiteur Boulogne-Billancourt — Petit-déjeuner & pauses entreprise livraison 92',
    seoArticle: `
      ...
      <p>Que vous organisiez un CODIR matinal pour 8 personnes ou une journée de formation pour 50 collaborateurs, L'Écrin Traiteur vous propose la prestation adaptée : plateaux de viennoiseries artisanales, coffrets de madeleines bio, assortiments de cakes maison, brochettes de fruits frais. Tout est préparé le jour même.</p>
  ...
  },
  {
    ...
    heroDescription: 'Neuilly-sur-Seine, entre prestige et exigence — L\'Écrin Traiteur livre les bureaux de l\'avenue Charles-de-Gaulle et du quartier des Sablons.',
    ...
    seoTitle: 'Traiteur Neuilly-sur-Seine — Petit-déjeuner et pauses entreprise haut de gamme livraison',
    seoArticle: `
      ...
      <p>Neuilly-sur-Seine est associée à un certain niveau d'exigence — en affaires comme en réception. Nos viennoiseries sont fabriquées au <strong>beurre AOP</strong> par des artisans boulangers parisiens. Nos macarons sont signés Pierre Morel. Nos madeleines sont certifiées Agriculture Biologique par Mado Paris. Des noms qui parlent à vos interlocuteurs.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Levallois-Perret — Livraison petit-déjeuner entreprise 92',
    seoArticle: `
      ...
      <p>Entre les agences digitales du quartier Anatole France, les sièges du secteur Victor Hugo et les start-ups des bords de Seine, Levallois concentre une grande diversité de profils professionnels. Nos plateaux de petits-déjeuners s'adaptent à tous : du croissant traditionnel au coffret de madeleines bio, des cookies Laura Todd aux brochettes de fruits vegan.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur La Défense Courbevoie — Livraison petit-déjeuner tours de bureaux 92',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Puteaux La Défense — Petit-déjeuner entreprise livraison tours de bureaux',
    seoArticle: `
  ...
  },
  {
    ...
    quartiers: [
      {
        ...
        seoArticle: `
          ...
          <p>Les entreprises tech du Val-de-Seine sont souvent pionnières en matière de RSE et de bien-être au travail. Nos produits répondent à ces engagements : madeleines Mado Paris certifiées Bio, produits sans huile de palme, traçabilité complète des artisans. Commander chez L'Écrin Traiteur, c'est aussi renforcer la cohérence de vos valeurs.</p>
    ...
    seoTitle: 'Traiteur Issy-les-Moulineaux — Livraison petit-déjeuner entreprise tech & digital 92',
    seoArticle: `
      ...
      <p>Les entreprises tech d'Issy-les-Moulineaux sont souvent engagées dans des démarches RSE et de bien-être au travail. Nos madeleines bio Mado Paris, nos brochettes de fruits vegan, nos produits sans huile de palme s'inscrivent naturellement dans ces valeurs. Un traiteur qui respecte vos engagements.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Versailles — Livraison petit-déjeuner entreprise Yvelines 78',
    seoArticle: `
      ...
      <p>Versailles a une relation intime avec les arts de la table et la gastronomie française. Chez L'Écrin Traiteur, nous partageons cet attachement à l'excellence : viennoiseries pur beurre, macarons Pierre Morel, madeleines bio Mado Paris — des produits qui honorent cette tradition d'exigence.</p>
  ...
  },
  {
    ...
    quartiers: [
      {
        ...
        seoTitle: 'Traiteur Pleyel Saint-Denis — Livraison petit-déjeuner quartier d\'affaires 93',
        seoDescription: 'L\'Écrin Traiteur livre vos petits-déjeuners dans le quartier Pleyel à Saint-Denis. Village Olympique, ZAC Landy France. Livraison dès 6h30.',
        seoArticle: `
    ...
    seoTitle: 'Traiteur Saint-Denis 93 — Livraison petit-déjeuner entreprise Seine-Saint-Denis',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Nanterre — Livraison petit-déjeuner entreprise 92 La Défense',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Rueil-Malmaison — Livraison petit-déjeuner campus entreprise 92',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Asnières-sur-Seine — Livraison petit-déjeuner entreprise 92 livraison dès 6h30',
    seoArticle: `
      ...
      <p>Nos créneaux de livraison couvrent les horaires de réunion les plus courants. Que votre réunion commence à 8h ou à 9h30, nous nous adaptons à vos besoins. Viennoiseries artisanales, cakes maison, madeleines bio — un choix complet pour tous les appétits.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Clichy — Livraison petit-déjeuner entreprise créative et digitale 92',
    seoArticle: `
      ...
      <p>Dans un environnement créatif comme celui de Clichy, les détails comptent. Proposer des macarons Pierre Morel ou des madeleines bio Mado Paris à ses équipes, c'est soigner l'image de marque interne. Nos produits sont beaux, bons et mémorables.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Suresnes — Livraison petit-déjeuner entreprise pharmaceutique et tertiaire 92',
    seoArticle: `
      ...
      <p>Les entreprises de la santé et du pharmaceutique à Suresnes ont des standards élevés. Nos produits Bio, sans huile de palme, avec des ingrédients tracés et des artisans identifiés, s'inscrivent dans cette culture de rigueur et de transparence.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Montrouge — Livraison petit-déjeuner entreprise 92 porte de Paris',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Massy — Livraison petit-déjeuner entreprise technopôle Essonne 91',
    seoArticle: `
      ...
      <p>Les entreprises innovantes de Massy partagent souvent des valeurs de qualité et d'authenticité. Nos produits artisanaux — bio, sans huile de palme, fabriqués par des artisans identifiés — correspondent à ces valeurs et renforcent votre culture d'entreprise.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Vélizy-Villacoublay — Livraison petit-déjeuner campus entreprise Yvelines 78',
    seoArticle: `
  ...
  },
  {
    ...
    quartiers: [
      {
        ...
        seoTitle: 'Traiteur tours La Défense — Livraison petit-déjeuner Tour First, CB21, Ariane, Aurore',
        seoDescription: 'L\'Écrin Traiteur livre dans toutes les tours de La Défense : Tour First, CB21, Total Énergies, Ariane, Aurore, Eqho. Livraison petits-déjeuners dès 6h30, accès tours maîtrisés.',
        seoArticle: `
    ...
    seoTitle: 'Traiteur La Défense — Livraison petit-déjeuner entreprise tours de bureaux 92',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Vincennes — Livraison petit-déjeuner entreprise 94 porte de Paris',
    seoArticle: `
      ...
      <p>Vincennes a un profil socio-économique qui correspond parfaitement à notre positionnement : exigeant, attaché à la qualité, sensible à l'artisanat. Nos produits — macarons Pierre Morel, madeleines bio Mado Paris, viennoiseries pur beurre — y trouvent leur clientèle naturelle.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur Saint-Cloud — Livraison petit-déjeuner entreprise séminaire 92 premium',
    seoArticle: `
