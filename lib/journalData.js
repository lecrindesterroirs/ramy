export const articles = [
  {
    ...
    contenu: `
      ...
      <p>L'Écrin Traiteur prépare et livre vos coffrets de fin d'année à Paris et en Île-de-France, pour vos clients comme pour vos équipes. On adapte le format, la personnalisation et le mode de distribution à votre volume. Livraison soignée, facturation entreprise : <a href="/devis">demandez votre devis</a> et calons ensemble vos cadeaux avant la course de décembre.</p>
    `,
    ...
    faq: [
      ...
      { q: "Peut-on personnaliser les coffrets aux couleurs de l'entreprise ?", a: "Oui. Nos coffrets cadeaux se personnalisent : couleurs de votre marque, message, packaging co-créé. C'est ce qui distingue un cadeau d'entreprise d'une simple boîte de gourmandises." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Quel budget prévoir pour la restauration d'un séminaire par personne ?", a: "Cela dépend des formats retenus : petit-déjeuner d'accueil, deux pauses et un déjeuner individuel. Nous établissons un devis détaillé selon votre programme, vos effectifs et le lieu, avec réponse sous 24h." },
