...
export const articles = [
  {
    slug: 'emballage-traiteur-bois-peuplier-francais',
    titre: "Emballage traiteur : ce que vaut vraiment la boîte dans laquelle arrive votre déjeuner",
    categorie: 'Conseils',
    date: '26 août 2026',
    isoDate: '2026-08-26',
    extrait: "L'emballage est la première chose que vos équipes voient et la dernière qu'elles jettent. Bois de peuplier français certifié PEFC, fabrication dans l'Aude, ESAT : d'où viennent nos boîtes et pourquoi nous les payons plus cher.",
    img: '/hero-lunch-box.webp',
    contenu: `
      <p>Un plateau repas, c'est une recette. C'est aussi une boîte posée sur une table de réunion, ouverte devant des invités, puis jetée vingt minutes plus tard. Cette boîte, personne ne la commande vraiment, mais tout le monde la voit. Elle dit quelque chose de vous avant même que le déjeuner ne commence.</p>
      <p>Nous avons fait un choix qui coûte plus cher : la majorité de nos contenants sont en <strong>bois de peuplier français</strong>. Voici pourquoi, et ce que cela change concrètement pour vous.</p>

      <h2>Le bois de peuplier, un choix de matière avant d'être un argument</h2>
      <p>Le peuplier pousse vite, en France, souvent dans des peupleraies plantées pour cet usage. Il se travaille en feuilles fines, ce qui donne des barquettes légères et rigides, sans vernis ni traitement de surface. Le bois que nous utilisons est <strong>non traité</strong> et issu de forêts gérées durablement, <strong>certifié PEFC</strong>.</p>
      <p>Concrètement, au moment de servir, cela donne trois choses :</p>
      <ul>
        <li><strong>Pas de goût rapporté.</strong> Un contenant plastique chauffé ou une barquette vernie marquent les aliments délicats. Le bois brut, non.</li>
        <li><strong>Une tenue réelle.</strong> Le peuplier absorbe l'humidité sans se déformer : une salade ou un plat en sauce arrive intact après la livraison.</li>
        <li><strong>Une présentation qui tient debout.</strong> Le bois clair met en valeur les couleurs d'une assiette. C'est la raison la moins technique, et probablement celle qui compte le plus quand vous recevez.</li>
      </ul>

      <h2>D'où viennent nos boîtes</h2>
      <p>Nous ne fabriquons pas nos emballages : nous les achetons. Autant dire à qui. Notre fournisseur principal est <strong>Comatec</strong>, une entreprise installée à <strong>Carcassonne, dans l'Aude</strong>, spécialisée depuis 1994 dans l'emballage alimentaire pour les métiers de bouche.</p>
      <p>Ce qui nous a décidés tient en quelques faits vérifiables :</p>
      <ul>
        <li><strong>Une fabrication française</strong> pour l'essentiel de leur gamme manufacturée, et des produits bois certifiés <strong>FSC® et PEFC</strong>.</li>
        <li><strong>Un travail avec quatre ESAT de l'Aude depuis 1994</strong>, qui fait travailler plus de 80 personnes en situation de handicap sur le conditionnement et l'assemblage.</li>
        <li><strong>Une notation extra-financière publique</strong> : Comatec est évaluée par EcoVadis, organisme indépendant, et figure parmi les entreprises les mieux notées de son secteur.</li>
        <li><strong>Un affichage environnemental produit par produit</strong> via leur outil PlanetScore, qui note chaque référence de A à E selon sa fabrication, son transport et sa fin de vie.</li>
      </ul>
      <p>Aucun de ces engagements n'est le nôtre : ce sont ceux de notre fournisseur. Mais choisir un fournisseur, c'est déjà un acte d'achat responsable, et c'est la partie de la chaîne sur laquelle nous avons la main.</p>

      <h2>Ce que ça change pour votre entreprise</h2>
      <h3>Un poste d'achat qui se documente</h3>
      <p>Si vous pilotez une démarche RSE, la restauration est l'un des rares postes visibles chaque semaine par vos équipes. Un contenant en bois certifié, fabriqué en France, par une entreprise évaluée par un organisme indépendant : c'est une ligne qui se justifie dans un rapport, pièces à l'appui. Nous vous transmettons les références et certifications sur demande.</p>
      <h3>Un tri plus simple après le repas</h3>
      <p>Le bois non traité se trie avec les biodéchets là où la collecte existe, ou avec les déchets non recyclables ailleurs. Pas de film à séparer, pas de barquette à rincer. Pour un office manager qui gère la salle après le déjeuner, c'est un problème en moins.</p>
      <h3>Une table qui n'a pas l'air d'un plateau-repas</h3>
      <p>C'est l'argument le moins mesurable et le plus décisif. Quand vous recevez un client ou un comité de direction, la différence entre une barquette plastique et un contenant bois se voit à trois mètres.</p>

      <h2>Ce que nous ne faisons pas</h2>
      <p>Le bois ne convient pas à tout. Une soupe chaude, un jus, une sauce liquide demandent d'autres contenants. Nous utilisons alors du carton, de la pulpe de canne ou du verre consigné selon les cas, et nous récupérons ce qui est réutilisable après votre événement, thermos compris.</p>
      <p>Nous n'affichons pas non plus de mention « zéro déchet » ou « neutre en carbone ». Livrer des déjeuners dans Paris produit des déchets et des émissions. Ce que nous pouvons dire, c'est d'où viennent nos contenants, qui les fabrique et dans quelles conditions. Le reste relèverait de l'argument marketing.</p>

      <h2>Voir nos contenants avant de commander</h2>
      <p>Si l'emballage compte dans votre choix de traiteur, dites-le nous : nous vous montrons les contenants prévus pour votre prestation avant de valider la commande, et nous transmettons les certifications correspondantes à votre service achats.</p>
      <p>Pour composer votre prestation, <a href="/devis">demandez un devis</a> ou parcourez nos <a href="/creations/plateaux-repas">plateaux repas</a> et nos <a href="/creations/lunch-box">lunch box</a>. Le détail de notre façon de travailler est sur la page <a href="/univers/nos-engagements">nos engagements</a>.</p>
    `,
  },
  {
    ...
    contenu: `
      ...
      <ul>
        ...
        <li><strong>Chocolat chaud de Noël</strong> et lait chaud, pour réchauffer les petits</li>
      ...
      <div style="display: flex; align-items: flex-start; gap: 28px; margin: 40px 0; flex-wrap: wrap;">
        <img src="/bois-thermos-chocolat.webp" alt="Chocolat chaud de Noël en thermos, pour l'arbre de Noël d'entreprise" style="width: 220px; max-width: 100%; height: auto; display: block; flex-shrink: 0;" />
        <div style="flex: 1; min-width: 240px;">
          <h3 style="font-family: 'Neue Montreal', sans-serif; font-size: 11px; font-weight: 500; letter-spacing: 0.14em; text-transform: uppercase; color: var(--text-primary); margin-bottom: 16px;">Le chocolat chaud de Noël</h3>
          <p>Chocolat noir Valrhona fondu dans du lait entier, le matin même, conditionné en thermos isotherme d'1 litre (6 à 8 tasses). Il reste chaud tout l'après-midi, posé à côté du goûter pour que les enfants se resservent entre deux animations. <strong>1 litre · 19,50€.</strong></p>
        </div>
      </div>

      <div style="display: flex; align-items: flex-start; gap: 28px; margin: 40px 0; flex-wrap: wrap;">
        <img src="/bonbonniere-noel.webp" alt="Bonbonnière de Noël, bocal de bonbons assortis pour l'arbre de Noël d'entreprise" style="width: 220px; max-width: 100%; height: auto; display: block; flex-shrink: 0;" />
        <div style="flex: 1; min-width: 240px;">
          <h3 style="font-family: 'Neue Montreal', sans-serif; font-size: 11px; font-weight: 500; letter-spacing: 0.14em; text-transform: uppercase; color: var(--text-primary); margin-bottom: 16px;">La bonbonnière de Noël</h3>
          <p>Un bocal de bonbons assortis, posé en libre-service à côté du goûter pour que les enfants se servent entre deux animations. La sélection et les quantités se composent sur mesure selon votre effectif. <strong>Prix sur devis.</strong></p>
        </div>
      </div>
  ...
  {
    slug: 'bonbonniere-noel-entreprise-paris',
    titre: "Bonbonnière de Noël en entreprise : composer un bar à bonbons pour l'arbre de Noël",
    categorie: 'Conseils',
    date: '26 septembre 2026',
    isoDate: '2026-09-26',
    extrait: "Un coin sucré où les enfants se servent eux-mêmes, entre deux crêpes et une visite du Père Noël. Voici comment composer une bonbonnière de Noël qui tient la route, pour l'arbre de Noël de votre CSE à Paris et en Île-de-France.",
    img: '/grand-buffet-signature.webp',
    contenu: `
      <h2>La bonbonnière, le coin qui aimante les enfants</h2>
      <p>Sur un <a href="/journal/arbre-de-noel-entreprise-cse-paris">arbre de Noël d'entreprise</a>, il y a toujours un stand devant lequel les enfants s'attardent plus longtemps que les autres : la bonbonnière. Un assortiment de douceurs présenté en bocaux ou en corbeilles, où chacun se sert selon ses envies. Pas d'animation, pas de file d'attente : juste un coin gourmand en libre-service, posé à côté du goûter et des ateliers.</p>
      <p>C'est un complément simple aux <a href="/creations/animations-culinaires">animations culinaires</a> de votre après-midi, et un repère visuel qui marque la fête dès l'entrée dans la salle.</p>

      <h2>Ce qui compose une bonbonnière de Noël réussie</h2>
      <p>Une bonbonnière ne s'improvise pas avec un sachet de bonbons acheté en dernière minute. Chez L'Écrin Traiteur, on la compose à partir de nos douceurs artisanales, présentées dans des bocaux et des corbeilles aux couleurs de Noël :</p>
      <ul>
        <li><strong><a href="/creations/petits-dejeuners-et-pauses/macarons">Macarons</a></strong> aux parfums de saison, pour la touche pâtissière</li>
        <li><strong><a href="/creations/petits-dejeuners-et-pauses/cookies">Cookies</a></strong> maison, la valeur sûre qui plaît à tous les âges</li>
        <li><strong>Guimauves et chamallows</strong>, à tremper dans un chocolat chaud ou à picorer tels quels</li>
        <li><strong>Papillotes et chocolats de Noël</strong>, pour l'esprit calendrier de l'avent</li>
        <li>Un <strong>chocolat chaud de Noël</strong> installé juste à côté, pour réchauffer entre deux bonbons</li>
      </ul>
      <p>On adapte la sélection et les quantités à votre nombre d'enfants, en gardant toujours une base accessible à tous : halal et sans porc par défaut, avec des options sans gluten sur demande.</p>

      <h2>Où l'installer et comment la présenter</h2>
      <p>La bonbonnière fonctionne le mieux installée en libre-service, à hauteur d'enfant, avec des pinces ou des petits sachets à disposition pour se servir proprement. Un coin dédié, distinct du buffet du goûter, évite les bousculades et donne à cet espace des allures de vitrine plutôt que de simple présentoir. On l'habille de touches rouges et dorées pour qu'elle s'intègre à la décoration de votre arbre de Noël.</p>

      <h2>Un stand qui se combine avec le reste du goûter</h2>
      <p>La bonbonnière n'est pas pensée pour remplacer le goûter, mais pour le prolonger. Elle s'installe naturellement aux côtés d'un <a href="/creations/animations-culinaires/atelier-crepes-et-pancakes">atelier crêpes</a>, d'une fontaine au chocolat ou d'un bar à glaces : les enfants circulent d'un stand à l'autre, et repartent avec un petit sachet de douceurs à la fin de l'après-midi si vous le souhaitez.</p>

      <h2>Organiser votre bonbonnière de Noël à Paris et en Île-de-France</h2>
      <p>Comme pour le reste de votre arbre de Noël, on compose la bonbonnière sur mesure : effectif d'enfants, sélection de douceurs, présentation. Livraison, installation et reprise des bocaux sont incluses. Facturation entreprise avec TVA.</p>
      <p><strong>Envie d'ajouter une bonbonnière à votre arbre de Noël ?</strong> <a href="/devis">Demandez votre devis</a>, on compose la sélection avec vous.</p>

      <h2>Questions fréquentes sur la bonbonnière de Noël</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Qu'est-ce qu'une bonbonnière pour un arbre de Noël ?</strong></summary>
          <p>C'est un stand de douceurs en libre-service, présenté en bocaux ou en corbeilles, où les enfants se servent entre deux animations. Macarons, cookies, guimauves et chocolats de Noël en sont les incontournables.</p>
        </details>
        <details>
          <summary><strong>Peut-on personnaliser le contenu de la bonbonnière ?</strong></summary>
          <p>Oui, la sélection se compose sur devis selon vos envies et le nombre d'enfants attendus, en gardant une base accessible à tous (halal, sans porc, options sans gluten).</p>
        </details>
        <details>
          <summary><strong>La bonbonnière remplace-t-elle le goûter de Noël ?</strong></summary>
          <p>Non, elle vient en complément. Elle s'installe à côté du buffet de goûter et des animations culinaires comme un stand supplémentaire, pas comme un substitut.</p>
        </details>
      </div>
    `,
    relatedProducts: ['macarons', 'cookies'],
    faq: [
      {
        q: "Qu'est-ce qu'une bonbonnière pour un arbre de Noël ?",
        a: "C'est un stand de douceurs en libre-service, présenté en bocaux ou en corbeilles, où les enfants se servent entre deux animations. Macarons, cookies, guimauves et chocolats de Noël en sont les incontournables.",
      },
      {
        q: "Peut-on personnaliser le contenu de la bonbonnière ?",
        a: "Oui, la sélection se compose sur devis selon vos envies et le nombre d'enfants attendus, en gardant une base accessible à tous (halal, sans porc, options sans gluten).",
      },
      {
        q: "La bonbonnière remplace-t-elle le goûter de Noël ?",
        a: "Non, elle vient en complément. Elle s'installe à côté du buffet de goûter et des animations culinaires comme un stand supplémentaire, pas comme un substitut.",
      },
    ],
  },
  {
    ...
    contenu: `
      ...
      <p><em>Avec la rentrée, les demandes de goûter d'anniversaire en entreprise reprennent dès septembre : comptez au moins 3 jours ouvrés d'avance pour les jeudis et vendredis, jours les plus demandés.</em></p>
    `,
  ...
  },
  {
    ...
    metaTitle: "Traiteur séminaire d'entreprise à Paris : le guide",
    categorie: 'Conseils',
    date: '11 juillet 2026',
    isoDate: '2026-07-11',
    ...
    contenu: `
      ...
      <p>L'Écrin Traiteur compose l'ensemble de la journée, du petit-déjeuner d'accueil au déjeuner en passant par les pauses et, si besoin, un cocktail ou une animation culinaire, avec des produits d'artisans identifiés et une livraison dès 6h30 sur votre lieu de séminaire. On adapte les formats à votre programme, à vos effectifs et aux régimes de chacun : <a href="/devis">demandez votre devis</a> et construisons ensemble le fil rouge gourmand de votre journée. Retrouvez aussi nos formules et nos tarifs sur notre page <a href="/occasions/seminaire-entreprise">traiteur séminaire d'entreprise</a>.</p>
    `,
  ...
  },
  {
    ...
    metaTitle: "Traiteur de rentrée en entreprise à Paris : le guide",
    categorie: 'Conseils',
    date: '8 juillet 2026',
    isoDate: '2026-07-08',
    ...
    contenu: `
      ...
      <p>Un nouveau collaborateur se fait une opinion de l'entreprise dans les toutes premières heures. Prévoir un <a href="/creations/petits-dejeuners-et-pauses"><strong>petit-déjeuner de bienvenue</strong></a> le jour de son arrivée, ou l'associer à une <a href="/creations/pauses-gourmandes">pause gourmande</a> avec son équipe, crée immédiatement du lien. C'est un détail d'accueil qui dit : « on t'attendait ».</p>
      <ul>
        ...
        <li><strong>Le premier déjeuner</strong>, un <a href="/creations/plateaux-repas">plateau repas</a> ou des <a href="/creations/lunch-box">lunch box</a> partagés pour présenter la recrue à son équipe autour d'une table.</li>
      ...
      <p>Beaucoup d'entreprises profitent de septembre pour réunir leurs équipes : kick-off, plénière, journée de cohésion. Un accueil petit-déjeuner suivi d'un cocktail déjeunatoire ou d'un buffet rythme la journée et évite les temps morts. L'organisation détaillée d'une journée complète est sur notre page <a href="/occasions/seminaire-entreprise">traiteur séminaire d'entreprise</a>. La qualité de ce qui est servi participe directement à l'énergie du moment.</p>
      ...
      <p><strong>Anticipez.</strong> Septembre est chargé : réservez vos dates dès la fin août. Notre <a href="/creations/evenements-saisonniers/rentree">offre de rentrée</a> détaille les formules et la plaque chocolat personnalisée. <strong>Pensez à tous les profils</strong>, options végétariennes, sans gluten, halal et sans porc pour que chaque recrue se sente incluse dès le premier jour. <strong>Indiquez le nombre de convives</strong> et les éventuelles allergies à la commande : nous composons une sélection adaptée et clairement identifiée.</p>
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    metaTitle: "Petit-déjeuner de rentrée en entreprise : le guide",
    categorie: 'Inspirations',
    date: '14 juin 2026',
    isoDate: '2026-06-14',
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    contenu: `
      ...
      <p><em>Avec la rentrée, de nombreuses équipes RH renouvellent leur politique de petit-déjeuner sain au bureau pour l'année à venir : c'est le bon moment pour ajuster votre formule.</em></p>
        `,
    faq: [
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    contenu: `
      ...
      <p><em>Le brunch d'entreprise reste une valeur sûre pour les kick-off de rentrée et les événements conviviaux de mi-journée organisés dès septembre.</em></p>
        `,
    faq: [
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    contenu: `
      ...
      <p><em>En cette rentrée, les commandes de viennoiseries pour les réunions du lundi matin et les kick-off d'équipe repartent fortement : commandez la veille avant 14h pour une livraison dès 6h30.</em></p>
        `,
    faq: [
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    contenu: `
      ...
      <p><em>Point d'actualisation septembre 2026 : les fourchettes de prix indiquées restent valables à la rentrée. En période de forte demande (septembre à décembre), mieux vaut sécuriser son budget et ses dates plusieurs semaines à l'avance plutôt qu'en dernière minute.</em></p>
        `,
    faq: [
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    contenu: `
      ...
      <p><em>Point d'actualisation septembre 2026 : les tarifs et formules ci-dessus restent représentatifs du marché parisien à la rentrée. En haute saison (septembre-décembre), les délais de réponse s'allongent chez la plupart des traiteurs : la réactivité du devis reste un critère de sélection à vérifier en priorité.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>Avec la rentrée, le goûter d'entreprise du mercredi ou du vendredi après-midi redevient un rituel fréquent dans les équipes qui cherchent à marquer une pause conviviale.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>En 2026, de plus en plus d'entreprises intègrent des critères RSE explicites dans leurs appels d'offres traiteur, notamment sur l'origine des produits et la gestion des déchets.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>La rentrée marque le début de la saison des séminaires et team buildings, période où les animations culinaires sont les plus demandées jusqu'en décembre.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>En septembre, avec le retour des équipes au bureau à temps plein, la demande de corbeilles de fruits frais repart nettement à la hausse.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>Point d'actualisation septembre 2026 : en pleine rentrée, les délais des traiteurs d'entreprise à Paris s'allongent (haute saison séminaires et kick-off). Vérifiez toujours le délai de commande minimum avant de vous engager, et privilégiez un prestataire capable de confirmer un devis sous 24h même en période chargée.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>La rentrée de septembre reste la période la plus demandée pour les petits-déjeuners d'entreprise, entre kick-off annuel et accueil des nouvelles recrues : pensez à réserver vos dates récurrentes tôt.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>Avec le retour des équipes en septembre, les pauses gourmandes régulières redeviennent un rituel apprécié pour marquer le rythme de la semaine de travail.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>La saison des cocktails d'entreprise reprend dès septembre avec la rentrée et s'intensifie jusqu'aux fêtes de fin d'année : c'est le bon moment pour caler vos dates avant que les créneaux se remplissent.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>Depuis la rentrée de septembre, la demande de plateaux repas pour les réunions de reprise et de planification annuelle est particulièrement forte : anticipez vos commandes dès le début de semaine.</em></p>
        `,
    faq: [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p><em>En cette rentrée 2026, de plus en plus d'entreprises inscrivent une ligne budgétaire dédiée à l'alimentation au bureau dans leur politique QVT annuelle, une tendance qui se confirme d'année en année.</em></p>
        `,
    faq: [
  ...
  {
    slug: 'soiree-fin-annee-entreprise-paris',
    titre: "Soirée de fin d'année en entreprise à Paris : formats, budget et organisation",
    metaTitle: "Soirée de fin d'année en entreprise à Paris : le guide",
    categorie: 'Conseils',
    date: '19 août 2026',
    isoDate: '2026-08-19',
    extrait: "Cocktail dînatoire, buffet debout ou simple pot de fin d'année : le format que vous choisissez décide de l'ambiance, du budget et de la logistique. Les repères pour organiser votre soirée de fin d'année sans mauvaise surprise.",
    img: '/hero-cocktail.webp',
    contenu: `
      <h2>La soirée de fin d'année, le seul moment où toute l'entreprise est réunie</h2>
      <p>C'est souvent la seule fois dans l'année où les équipes se retrouvent toutes au même endroit, en même temps. Une <strong>soirée de fin d'année</strong> réussie ne tient pas au budget dépensé mais à trois décisions prises tôt : le format, l'horaire, et la quantité servie par personne. Voici comment les prendre, à <strong>Paris et en Île-de-France</strong>.</p>
      <p>Nous livrons ces soirées depuis nos débuts, et le retour est toujours le même : ce qui rate, c'est rarement le menu. C'est le calage. Trop peu de pièces, une livraison trop tôt qui refroidit, un buffet posé dans un couloir de passage.</p>

      <h2>Trois formats, trois ambiances différentes</h2>
      <h3>Le pot de fin d'année, 1h à 1h30</h3>
      <p>Format le plus léger. On trinque, on remercie, chacun repart. Comptez <strong>8 pièces par personne</strong>, salées et sucrées. C'est notre formule L'Invitation, à 29,90 € HT par personne. Convient bien aux équipes de 15 à 40 personnes qui veulent marquer le coup sans y passer la soirée.</p>

      <h3>Le cocktail dînatoire, 2h à 3h</h3>
      <p>Le format le plus courant pour une vraie soirée de fin d'année. Il remplace le dîner, donc il faut monter en quantité : <strong>12 à 16 pièces par personne</strong>. La Réception (12 pièces, 40,90 € HT) suffit si la soirée démarre à 19h et que les gens dînent parfois après. La Célébration (16 pièces, 51,90 € HT) est le bon choix si personne ne dînera ailleurs.</p>

      <h3>Le repas assis</h3>
      <p>Plus solennel, plus contraignant en logistique et en place. À réserver aux effectifs restreints ou aux soirées où l'on remet des trophées, où l'on fait des discours, où l'on veut que tout le monde soit assis face à une scène. Nos plateaux repas vont de 28,90 à 35,90 € HT par personne selon la collection.</p>

      <h2>Quel format pour quel effectif ?</h2>
      <ul>
        <li><strong>10 à 25 personnes</strong> : pot de fin d'année ou cocktail, dans vos locaux. Aucune logistique lourde, un buffet posé sur deux tables suffit.</li>
        <li><strong>25 à 60 personnes</strong> : cocktail dînatoire. C'est le format à privilégier. Prévoyez deux points de buffet plutôt qu'un seul, sinon la file se forme.</li>
        <li><strong>60 à 150 personnes</strong> : cocktail dînatoire avec un espace dédié, et idéalement une animation culinaire en direct pour créer un point de rassemblement.</li>
        <li><strong>Au delà de 150</strong> : il faut un lieu externe, et le traiteur doit être calé plusieurs semaines à l'avance.</li>
      </ul>

      <h2>L'erreur la plus fréquente : sous-estimer les quantités</h2>
      <p>Sur une soirée de fin d'année, les gens mangent plus que sur un afterwork classique. L'horaire y est pour beaucoup : à 19h30, après une journée de travail, les premières pièces salées partent très vite. Notre repère : les pièces salées disparaissent environ <strong>deux fois plus vite</strong> que les sucrées sur la première heure.</p>
      <p>Si vous hésitez entre deux formules, prenez la supérieure. Un buffet vide à 20h30 dans une soirée qui doit durer jusqu'à 22h, c'est le seul incident dont les équipes se souviennent l'année suivante. Nous détaillons le calcul dans notre guide <a href="/journal/combien-pieces-cocktail-par-personne-entreprise">combien de pièces cocktail par personne</a>.</p>

      <h2>Les boissons, souvent oubliées dans le budget</h2>
      <p>Nous livrons les jus Alain Milliat, les eaux et les gobelets avec les plateaux, dans la même commande. Pour le vin et les bulles, la plupart de nos clients les achètent de leur côté : c'est plus simple et souvent moins cher. Prévoyez de la glace, c'est le grand oublié des soirées de décembre organisées dans des bureaux chauffés.</p>
      <p>Pensez aussi à une offre sans alcool réelle, pas juste des bouteilles d'eau. Sur une soirée d'entreprise, une part significative des équipes ne boit pas d'alcool, et proposer autre chose qu'un verre d'eau change leur soirée.</p>

      <h2>Quand réserver sa soirée de fin d'année ?</h2>
      <p>Décembre est le mois le plus chargé de l'année pour tous les traiteurs d'Île-de-France. Les deuxième et troisième semaines de décembre, en particulier les jeudis, partent en premier. Si votre date est déjà fixée, réservez dès <strong>octobre</strong>. Si vous avez de la souplesse, une soirée début décembre ou en janvier pour la galette est plus facile à caler et souvent mieux servie.</p>

      <h2>Toute la carte halal et sans porc</h2>
      <p>C'est notre standard, pas une option à demander. Sur une soirée qui réunit toute l'entreprise, cela évite d'avoir à gérer une commande séparée ou à faire la liste des gens qui ne peuvent pas manger. Les options végétariennes, véganes et sans gluten se précisent à la commande, avec les effectifs concernés.</p>

      <h2>Organiser votre soirée de fin d'année</h2>
      <p>Commande avant 14h la veille pour les formats simples, mais pour une soirée de fin d'année, prévoyez plusieurs semaines. Livraison 29 € HT sur Paris et les communes proches, facturation entreprise avec TVA. Voir aussi notre page <a href="/creations/evenements-saisonniers/noel">traiteur de Noël en entreprise</a> et les <a href="/creations/cocktails">formules cocktail</a>. <a href="/devis">Demandez votre devis</a>, réponse sous 24h.</p>

      <h2>Questions fréquentes sur la soirée de fin d'année en entreprise</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Combien de pièces prévoir pour une soirée de fin d'année ?</strong></summary>
          <p>Pour un pot de 1h à 1h30, comptez 8 pièces par personne. Pour un cocktail dînatoire qui remplace le dîner, montez à 12 pièces, et à 16 si la soirée dure plus de deux heures et que personne ne dînera ailleurs. Les pièces salées partent environ deux fois plus vite que les sucrées sur la première heure.</p>
        </details>
        <details>
          <summary><strong>Quel budget pour une soirée de fin d'année d'entreprise ?</strong></summary>
          <p>Comptez 29,90 € HT par personne en formule L'Invitation (8 pièces), 40,90 € HT en La Réception (12 pièces) et 51,90 € HT en La Célébration (16 pièces), plus 29 € HT de livraison sur Paris et les communes proches. Pour 40 personnes en cocktail dînatoire 12 pièces, cela représente environ 1 665 € HT hors boissons alcoolisées.</p>
        </details>
        <details>
          <summary><strong>Quand faut-il réserver son traiteur pour décembre ?</strong></summary>
          <p>Dès octobre si votre date est fixée. Les jeudis des deuxième et troisième semaines de décembre sont les créneaux les plus demandés d'Île-de-France et partent en premier. Une soirée début décembre ou une galette en janvier se cale beaucoup plus facilement.</p>
        </details>
        <details>
          <summary><strong>Faut-il un service sur place pour une soirée d'entreprise ?</strong></summary>
          <p>Pas pour un cocktail classique : nos plateaux arrivent dressés et prêts à poser, votre équipe n'a rien à préparer. Le service devient utile au delà de 60 personnes, ou si vous voulez une animation culinaire en direct qui serve de point de rassemblement.</p>
        </details>
        <details>
          <summary><strong>Proposez-vous une offre sans alcool pour la soirée ?</strong></summary>
          <p>Oui. Jus Alain Milliat, eaux plates et gazeuses, et sur demande des mocktails. Sur une soirée d'entreprise, proposer autre chose que de l'eau à ceux qui ne boivent pas d'alcool change réellement leur soirée.</p>
        </details>
      </div>
    `,
    relatedProducts: ['navettes-salees', 'macarons', 'plateau-fromages-affines'],
    faq: [
      { q: "Combien de pièces prévoir pour une soirée de fin d'année ?", a: "Pour un pot de 1h à 1h30, comptez 8 pièces par personne. Pour un cocktail dînatoire qui remplace le dîner, montez à 12 pièces, et à 16 si la soirée dure plus de deux heures et que personne ne dînera ailleurs. Les pièces salées partent environ deux fois plus vite que les sucrées sur la première heure." },
      { q: "Quel budget pour une soirée de fin d'année d'entreprise ?", a: "Comptez 29,90 € HT par personne en formule L'Invitation (8 pièces), 40,90 € HT en La Réception (12 pièces) et 51,90 € HT en La Célébration (16 pièces), plus 29 € HT de livraison sur Paris et les communes proches. Pour 40 personnes en cocktail dînatoire 12 pièces, cela représente environ 1 665 € HT hors boissons alcoolisées." },
      { q: "Quand faut-il réserver son traiteur pour décembre ?", a: "Dès octobre si votre date est fixée. Les jeudis des deuxième et troisième semaines de décembre sont les créneaux les plus demandés d'Île-de-France et partent en premier. Une soirée début décembre ou une galette en janvier se cale beaucoup plus facilement." },
      { q: "Faut-il un service sur place pour une soirée d'entreprise ?", a: "Pas pour un cocktail classique : nos plateaux arrivent dressés et prêts à poser, votre équipe n'a rien à préparer. Le service devient utile au delà de 60 personnes, ou si vous voulez une animation culinaire en direct qui serve de point de rassemblement." },
      { q: "Proposez-vous une offre sans alcool pour la soirée ?", a: "Oui. Jus Alain Milliat, eaux plates et gazeuses, et sur demande des mocktails. Sur une soirée d'entreprise, proposer autre chose que de l'eau à ceux qui ne boivent pas d'alcool change réellement leur soirée." },
    ],
  },
  {
    slug: 'menu-noel-livre-entreprise-paris',
    titre: "Menu de Noël livré au bureau : buffet, plateau repas ou cocktail dînatoire ?",
    metaTitle: "Menu de Noël livré au bureau : quel format choisir ?",
    categorie: 'Conseils',
    date: '19 août 2026',
    isoDate: '2026-08-19',
    extrait: "Buffet de Noël, plateau repas de fête ou cocktail dînatoire : les trois formats ne demandent ni le même budget, ni la même place, ni la même organisation. Comment choisir celui qui correspond à votre équipe.",
    img: '/grand-buffet-signature.webp',
    contenu: `
      <h2>Un menu de Noël au bureau, sans quitter les locaux</h2>
      <p>Beaucoup d'équipes veulent marquer Noël sans bloquer une soirée entière ni réserver un restaurant six semaines à l'avance. Le <strong>menu de Noël livré au bureau</strong> répond exactement à ça : le repas de fête arrive dans vos locaux, à l'heure choisie, et chacun rentre chez soi ensuite. Voici les trois formats possibles à <strong>Paris et en Île-de-France</strong>, et comment choisir.</p>

      <h2>Format 1 : le buffet de Noël</h2>
      <p>C'est le format le plus festif. Les grands classiques de saison sont posés sur la table et chacun se sert : <strong>foie gras</strong>, <strong>saumon fumé</strong>, pains spéciaux, plateau de fromages affinés, et la <strong>bûche artisanale</strong> pour finir. Les chocolats chauds Mariage Frères tournent bien sur un buffet de décembre.</p>
      <p>Le buffet demande de la place : une table dédiée, un espace de circulation, et idéalement une salle qui n'est pas un lieu de passage. Il fonctionne très bien à partir de 15 personnes. En dessous, il y a trop de restes.</p>

      <h3>Ce qu'il faut prévoir</h3>
      <ul>
        <li>Une table de 2 mètres minimum pour 25 personnes</li>
        <li>Des assiettes et des couverts, que nous livrons sur demande</li>
        <li>Un créneau de 1h30 minimum, sinon le buffet est expédié</li>
      </ul>

      <h2>Format 2 : le plateau repas de fête</h2>
      <p>Chacun reçoit son plateau individuel complet, entrée, plat, dessert et pain, filmé et étiqueté. C'est le format qui convient quand la place manque, quand l'équipe est répartie sur plusieurs étages, ou quand le déjeuner de Noël se fait pendant une réunion.</p>
      <p>Nos plateaux vont de 28,90 € HT par personne pour la collection Essentiel à 35,90 € HT pour la Signature. Le détail est sur la page <a href="/creations/plateaux-repas">plateaux repas</a>. C'est aussi le format le plus simple à chiffrer : un plateau, un prix, pas de calcul de quantité.</p>

      <h2>Format 3 : le cocktail dînatoire de Noël</h2>
      <p>Le format debout, qui fait circuler les gens. Il convient aux équipes qui veulent que le moment ressemble à une fête plutôt qu'à un déjeuner. Comptez 12 pièces par personne (La Réception, 40,90 € HT) si le cocktail remplace le repas, 16 pièces (La Célébration, 51,90 € HT) s'il dure plus de deux heures.</p>
      <p>C'est le format à choisir si vous organisez une vraie soirée. Nous détaillons l'organisation dans notre guide <a href="/journal/soiree-fin-annee-entreprise-paris">soirée de fin d'année en entreprise</a>.</p>

      <h2>Comment choisir : le tableau de décision</h2>
      <ul>
        <li><strong>Vous avez une salle et 1h30 devant vous</strong> : buffet de Noël.</li>
        <li><strong>La place manque, ou l'équipe est éclatée sur plusieurs étages</strong> : plateaux repas de fête.</li>
        <li><strong>Vous voulez une soirée, pas un déjeuner</strong> : cocktail dînatoire.</li>
        <li><strong>Vous recevez des clients ou des partenaires</strong> : plateau repas si c'est un déjeuner de travail, cocktail si c'est une réception.</li>
        <li><strong>Il y a des enfants</strong> : c'est un arbre de Noël, pas un menu de Noël. Voir notre guide <a href="/journal/arbre-de-noel-entreprise-cse-paris">arbre de Noël d'entreprise et CSE</a>.</li>
      </ul>

      <h2>Foie gras, saumon, bûche : ce qui fait un menu de Noël</h2>
      <p>Un menu de fête se reconnaît à trois ou quatre produits, pas à une carte entière. Le foie gras et le saumon fumé signent l'entrée. La bûche artisanale signe la fin. Entre les deux, mieux vaut une pièce bien exécutée qu'une accumulation. Nous préparons chaque année une carte de saison spécifique, détaillée sur la page <a href="/creations/evenements-saisonniers/noel">traiteur de Noël en entreprise</a>.</p>

      <h2>Toute la carte halal et sans porc</h2>
      <p>C'est notre standard toute l'année, y compris sur la carte de Noël. C'est un point qui compte particulièrement en décembre, où les menus de fête traditionnels excluent souvent une partie de l'équipe sans qu'on y pense. Les options végétariennes, véganes et sans gluten se précisent à la commande, avec les effectifs concernés.</p>

      <h2>Quand commander son menu de Noël ?</h2>
      <p>Pour un déjeuner de Noël simple, une commande avant 14h la veille reste possible sur notre sélection du jour. Mais pour un buffet de fête complet ou un cocktail avec une carte de saison, prévoyez <strong>plusieurs semaines</strong>. Décembre est le mois le plus tendu de l'année en Île-de-France, et les créneaux de la mi-décembre partent dès octobre.</p>

      <h2>Commander votre menu de Noël</h2>
      <p>Livraison dès 6h30 et jusqu'en fin de journée, à Paris et en Île-de-France. Minimum de commande 50 € HT, livraison 29 € HT sur Paris et les communes proches, facturation entreprise avec TVA. <a href="/devis">Demandez votre devis</a>, réponse sous 24h.</p>

      <h2>Questions fréquentes sur le menu de Noël en entreprise</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Quel format choisir pour un repas de Noël au bureau ?</strong></summary>
          <p>Le buffet si vous avez une salle et 1h30 devant vous, à partir de 15 personnes. Le plateau repas individuel si la place manque ou si l'équipe est répartie sur plusieurs étages. Le cocktail dînatoire si vous voulez une soirée debout plutôt qu'un déjeuner assis.</p>
        </details>
        <details>
          <summary><strong>Combien coûte un menu de Noël livré au bureau ?</strong></summary>
          <p>De 28,90 à 35,90 € HT par personne pour un plateau repas de fête selon la collection. Pour un cocktail dînatoire de Noël, comptez 40,90 € HT par personne en 12 pièces et 51,90 € HT en 16 pièces. La livraison est à 29 € HT sur Paris et les communes proches.</p>
        </details>
        <details>
          <summary><strong>Que contient un menu de Noël L'Écrin ?</strong></summary>
          <p>Les classiques de saison : foie gras, saumon fumé, pains spéciaux, plateau de fromages affinés et bûche artisanale, avec des chocolats chauds Mariage Frères sur les formats buffet. La carte est adaptée chaque année et l'ensemble reste halal et sans porc.</p>
        </details>
        <details>
          <summary><strong>Quand commander son menu de Noël pour l'entreprise ?</strong></summary>
          <p>Dès octobre pour un buffet de fête ou un cocktail à date fixée, car les créneaux de la mi-décembre partent en premier. Pour un déjeuner de Noël simple, une commande avant 14h la veille reste possible sur notre sélection du jour.</p>
        </details>
        <details>
          <summary><strong>Le menu de Noël convient-il aux régimes de toute l'équipe ?</strong></summary>
          <p>Toute notre carte est halal et sans porc par défaut, y compris à Noël. Les options végétariennes, véganes et sans gluten se demandent à la commande en indiquant les effectifs concernés, sans supplément caché sur le devis.</p>
        </details>
      </div>
    `,
    relatedProducts: ['plateau-fromages-affines', 'plateau-clubs-signature', 'macarons'],
    faq: [
      { q: "Quel format choisir pour un repas de Noël au bureau ?", a: "Le buffet si vous avez une salle et 1h30 devant vous, à partir de 15 personnes. Le plateau repas individuel si la place manque ou si l'équipe est répartie sur plusieurs étages. Le cocktail dînatoire si vous voulez une soirée debout plutôt qu'un déjeuner assis." },
      { q: "Combien coûte un menu de Noël livré au bureau ?", a: "De 28,90 à 35,90 € HT par personne pour un plateau repas de fête selon la collection. Pour un cocktail dînatoire de Noël, comptez 40,90 € HT par personne en 12 pièces et 51,90 € HT en 16 pièces. La livraison est à 29 € HT sur Paris et les communes proches." },
      { q: "Que contient un menu de Noël L'Écrin ?", a: "Les classiques de saison : foie gras, saumon fumé, pains spéciaux, plateau de fromages affinés et bûche artisanale, avec des chocolats chauds Mariage Frères sur les formats buffet. La carte est adaptée chaque année et l'ensemble reste halal et sans porc." },
      { q: "Quand commander son menu de Noël pour l'entreprise ?", a: "Dès octobre pour un buffet de fête ou un cocktail à date fixée, car les créneaux de la mi-décembre partent en premier. Pour un déjeuner de Noël simple, une commande avant 14h la veille reste possible sur notre sélection du jour." },
      { q: "Le menu de Noël convient-il aux régimes de toute l'équipe ?", a: "Toute notre carte est halal et sans porc par défaut, y compris à Noël. Les options végétariennes, véganes et sans gluten se demandent à la commande en indiquant les effectifs concernés, sans supplément caché sur le devis." },
    ],
  },
  {
    slug: 'petit-dejeuner-noel-bureau-entreprise',
    titre: "Petit-déjeuner de Noël au bureau : idées, produits et organisation",
    metaTitle: "Petit-déjeuner de Noël au bureau : idées et budget",
    categorie: 'Conseils',
    date: '19 août 2026',
    isoDate: '2026-08-19',
    extrait: "Le format le plus simple pour marquer Noël en équipe : une heure le matin, pas de soirée à bloquer, et tout le monde est là. Ce qu'il faut commander et comment l'organiser.",
    img: '/hero-petitdej.webp',
    contenu: `
      <h2>Le format le plus simple pour fêter Noël en équipe</h2>
      <p>Toutes les entreprises ne peuvent pas bloquer une soirée en décembre. Entre les congés posés, les fins de projet et les agendas saturés, la soirée de fin d'année laisse toujours des absents. Le <strong>petit-déjeuner de Noël au bureau</strong> résout ce problème : une heure le matin, tout le monde est présent, et la journée continue normalement ensuite.</p>
      <p>C'est aussi le format le plus accessible en budget, et celui qui se cale le plus tard dans le mois le plus chargé de l'année.</p>

      <h2>Ce qui distingue un petit-déjeuner de Noël d'un petit-déjeuner classique</h2>
      <p>Trois éléments suffisent à faire la différence. Ce n'est pas la peine d'en faire plus.</p>
      <ul>
        <li><strong>Les viennoiseries de saison</strong>, en plus des croissants et pains au chocolat habituels</li>
        <li><strong>Le chocolat chaud</strong>, qui change tout un petit-déjeuner de décembre. Nous servons les chocolats Mariage Frères.</li>
        <li><strong>Une pièce sucrée de fête</strong> : bûche à partager, macarons Pierre Morel, ou un coffret de madeleines Mado Paris à ouvrir sur la table</li>
      </ul>
      <p>Le reste ne change pas : corbeille de fruits frais découpés, jus Alain Milliat, café. La base de nos <a href="/creations/petits-dejeuners-et-pauses">petits-déjeuners et pauses</a>.</p>

      <h2>Quel budget pour un petit-déjeuner de Noël ?</h2>
      <p>C'est le format de fin d'année le plus abordable, très en dessous d'un cocktail ou d'un repas assis. Le budget dépend surtout de ce que vous ajoutez à la base : un petit-déjeuner de Noël reste un petit-déjeuner enrichi, pas un repas.</p>
      <p>Repère utile : le minimum de commande est de 50 € HT et la livraison est à 29 € HT sur Paris et les communes proches. Pour une équipe de 20 personnes, un petit-déjeuner de Noël complet reste dans un ordre de grandeur très inférieur à celui d'une soirée. Nous détaillons la méthode de calcul dans notre guide <a href="/journal/budget-petit-dejeuner-equipe-personnes">budget petit-déjeuner d'entreprise</a>.</p>

      <h2>À quelle heure l'organiser ?</h2>
      <p>Entre <strong>9h et 10h</strong>. Plus tôt, une partie de l'équipe n'est pas encore arrivée. Plus tard, on empiète sur le déjeuner et les gens ne mangent pas. Nous livrons dès 6h30, donc le plateau peut être posé bien avant l'arrivée des premiers.</p>
      <p>Un conseil qui revient souvent de nos clients : ne le faites pas le dernier jour avant les congés. Ce jour-là, la moitié de l'équipe est déjà partie ou en train de boucler. La semaine du 8 au 15 décembre fonctionne beaucoup mieux.</p>

      <h2>Où le poser dans les bureaux</h2>
      <p>Pas dans une salle de réunion fermée : les gens n'y vont pas. Le meilleur endroit est un espace de passage où l'on peut rester debout, cuisine commune ou open space. Le but est que les gens s'arrêtent naturellement, pas qu'ils aient à décider d'aller à un événement.</p>

      <h2>Petit-déjeuner de Noël ou goûter de Noël ?</h2>
      <p>Le petit-déjeuner s'adresse aux équipes, le matin, sans enfants. Le goûter de Noël concerne l'après-midi et, le plus souvent, l'arbre de Noël du CSE avec les enfants des salariés. Ce ne sont pas les mêmes produits ni la même organisation : voir notre guide sur l'<a href="/journal/arbre-de-noel-entreprise-cse-paris">arbre de Noël d'entreprise et le CSE</a>.</p>

      <h2>Toute la carte halal et sans porc</h2>
      <p>Par défaut, y compris sur la carte de fin d'année. Les options végétariennes, véganes et sans gluten se demandent à la commande avec les effectifs concernés. Sur un petit-déjeuner, la version sans gluten demande un peu d'anticipation, mieux vaut la signaler dès le devis.</p>

      <h2>Commander votre petit-déjeuner de Noël</h2>
      <p>Commande avant <strong>14h la veille</strong>, livraison dès 6h30 à Paris et en Île-de-France. En décembre, prenez de l'avance : c'est le mois le plus chargé de l'année, même sur les formats simples. Voir aussi la page <a href="/creations/evenements-saisonniers/noel">traiteur de Noël en entreprise</a>. <a href="/devis">Demandez votre devis</a>, réponse sous 24h.</p>

      <h2>Questions fréquentes sur le petit-déjeuner de Noël au bureau</h2>
      <div class="faq-block">
        <details>
          <summary><strong>À quelle heure organiser un petit-déjeuner de Noël au bureau ?</strong></summary>
          <p>Entre 9h et 10h. Plus tôt, une partie de l'équipe n'est pas arrivée ; plus tard, on empiète sur le déjeuner et les gens ne mangent pas. Nous livrons dès 6h30, le plateau peut donc être posé avant l'arrivée des premiers.</p>
        </details>
        <details>
          <summary><strong>Qu'est-ce qui rend un petit-déjeuner « de Noël » ?</strong></summary>
          <p>Trois ajouts suffisent : des viennoiseries de saison en plus des croissants habituels, du chocolat chaud, et une pièce sucrée de fête comme une bûche à partager ou des macarons. Le reste, fruits frais, jus et café, ne change pas.</p>
        </details>
        <details>
          <summary><strong>Quel jour de décembre choisir ?</strong></summary>
          <p>La semaine du 8 au 15 décembre est la plus efficace. Évitez le dernier jour avant les congés : une partie de l'équipe est déjà partie ou occupée à boucler ses dossiers.</p>
        </details>
        <details>
          <summary><strong>Le petit-déjeuner de Noël est-il moins cher qu'une soirée ?</strong></summary>
          <p>Nettement. C'est le format de fin d'année le plus accessible, très en dessous d'un cocktail dînatoire à 40,90 € HT par personne ou d'un repas assis. Le minimum de commande est de 50 € HT, la livraison à 29 € HT sur Paris et les communes proches.</p>
        </details>
        <details>
          <summary><strong>Où installer le petit-déjeuner dans les bureaux ?</strong></summary>
          <p>Dans un espace de passage où l'on peut rester debout, cuisine commune ou open space, plutôt que dans une salle de réunion fermée où les gens ne vont pas spontanément.</p>
        </details>
      </div>
    `,
    relatedProducts: ['viennoiseries-melangees', 'madeleines-20', 'plateau-fruits-frais'],
    faq: [
      { q: "À quelle heure organiser un petit-déjeuner de Noël au bureau ?", a: "Entre 9h et 10h. Plus tôt, une partie de l'équipe n'est pas arrivée ; plus tard, on empiète sur le déjeuner et les gens ne mangent pas. Nous livrons dès 6h30, le plateau peut donc être posé avant l'arrivée des premiers." },
      { q: "Qu'est-ce qui rend un petit-déjeuner « de Noël » ?", a: "Trois ajouts suffisent : des viennoiseries de saison en plus des croissants habituels, du chocolat chaud, et une pièce sucrée de fête comme une bûche à partager ou des macarons. Le reste, fruits frais, jus et café, ne change pas." },
      { q: "Quel jour de décembre choisir ?", a: "La semaine du 8 au 15 décembre est la plus efficace. Évitez le dernier jour avant les congés : une partie de l'équipe est déjà partie ou occupée à boucler ses dossiers." },
      { q: "Le petit-déjeuner de Noël est-il moins cher qu'une soirée ?", a: "Nettement. C'est le format de fin d'année le plus accessible, très en dessous d'un cocktail dînatoire à 40,90 € HT par personne ou d'un repas assis. Le minimum de commande est de 50 € HT, la livraison à 29 € HT sur Paris et les communes proches." },
      { q: "Où installer le petit-déjeuner dans les bureaux ?", a: "Dans un espace de passage où l'on peut rester debout, cuisine commune ou open space, plutôt que dans une salle de réunion fermée où les gens ne vont pas spontanément." },
    ],
  },
  {
    slug: 'budget-repas-noel-entreprise',
    titre: "Budget repas de Noël en entreprise : combien prévoir par personne ?",
    metaTitle: "Budget repas de Noël en entreprise : combien par personne",
    categorie: 'Conseils',
    date: '19 août 2026',
    isoDate: '2026-08-19',
    extrait: "Petit-déjeuner, buffet, plateau repas ou cocktail dînatoire : quatre formats, quatre budgets. Les montants réels par personne, les postes qu'on oublie, et ce que dit l'URSSAF sur les cadeaux de fin d'année.",
    img: '/hero-plateau-signature.webp',
    contenu: `
      <h2>Combien coûte un repas de Noël en entreprise ?</h2>
      <p>La réponse dépend d'un seul choix : le format. Entre un petit-déjeuner de Noël et un cocktail dînatoire de 16 pièces, l'écart va du simple au quadruple par personne. Voici les <strong>budgets réels par personne</strong>, tels que nous les facturons à <strong>Paris et en Île-de-France</strong>, sans fourchette vague.</p>

      <h2>Les quatre formats et leur budget par personne</h2>
      <ul>
        <li><strong>Petit-déjeuner de Noël</strong> : le format le plus accessible. Viennoiseries de saison, chocolat chaud, fruits frais, une pièce sucrée de fête.</li>
        <li><strong>Plateau repas de fête</strong> : de <strong>28,90 à 35,90 € HT</strong> par personne selon la collection, entrée, plat, dessert et pain compris.</li>
        <li><strong>Cocktail dînatoire, 12 pièces</strong> : <strong>40,90 € HT</strong> par personne. Le format qui remplace le dîner.</li>
        <li><strong>Cocktail dînatoire, 16 pièces</strong> : <strong>51,90 € HT</strong> par personne. Pour une soirée de plus de deux heures.</li>
      </ul>
      <p>À cela s'ajoute la <strong>livraison, 29 € HT</strong> sur Paris et les communes proches. Les autres zones d'Île-de-France sont chiffrées au devis. Le minimum de commande est de 50 € HT.</p>

      <h2>Trois exemples chiffrés</h2>
      <h3>Une équipe de 20 personnes, déjeuner de Noël en plateaux</h3>
      <p>20 plateaux Essentiel à 28,90 € HT, soit 578 € HT, plus 29 € HT de livraison : <strong>607 € HT</strong>. C'est le format le plus simple à budgéter, un plateau égale un prix.</p>

      <h3>Une équipe de 40 personnes, cocktail dînatoire</h3>
      <p>40 personnes en formule La Réception à 40,90 € HT, soit 1 636 € HT, plus 29 € HT de livraison : <strong>1 665 € HT</strong>, hors boissons alcoolisées que la plupart de nos clients achètent de leur côté.</p>

      <h3>Une équipe de 60 personnes, soirée de fin d'année</h3>
      <p>60 personnes en formule La Célébration à 51,90 € HT, soit 3 114 € HT, plus livraison : <strong>3 143 € HT</strong>. C'est le haut de la fourchette, pour une soirée qui remplace vraiment le dîner et dure plus de deux heures.</p>

      <h2>Les postes qu'on oublie dans le budget</h2>
      <p>C'est là que les devis dérapent, rarement sur le prix par personne.</p>
      <ul>
        <li><strong>Les boissons alcoolisées</strong>, presque jamais incluses chez un traiteur. Prévoyez-les séparément.</li>
        <li><strong>La glace</strong>, oubliée systématiquement sur les soirées de décembre dans des bureaux chauffés.</li>
        <li><strong>La vaisselle</strong>, facturée de 3 à 8 € par personne chez beaucoup de prestataires.</li>
        <li><strong>Le personnel de service</strong>, utile au delà de 60 personnes.</li>
        <li><strong>La zone de livraison</strong>, souvent au delà du forfait annoncé dès qu'on sort de Paris et des communes proches.</li>
        <li><strong>Le minimum de commande</strong>, qui monte à 200 ou 500 € chez certains traiteurs. Le nôtre est à 50 € HT.</li>
      </ul>

      <h2>Sous-évaluer les quantités coûte plus cher que de bien les prévoir</h2>
      <p>L'économie la plus tentante consiste à descendre d'une formule. C'est aussi la plus visible : un buffet vide à 20h30 sur une soirée qui doit durer jusqu'à 22h annule tout le bénéfice de l'événement. Notre repère est constant : sur la première heure, les pièces salées partent environ <strong>deux fois plus vite</strong> que les sucrées. Le calcul complet est dans notre guide <a href="/journal/combien-pieces-cocktail-par-personne-entreprise">combien de pièces cocktail par personne</a>.</p>

      <h2>Et les cadeaux de fin d'année ?</h2>
      <p>Ils relèvent d'un budget différent, souvent porté par le CSE, et obéissent à des règles URSSAF propres aux bons cadeaux et cadeaux en nature. Nous traitons le sujet séparément dans notre guide <a href="/journal/cadeaux-gourmands-entreprise-fin-annee-paris">cadeaux gourmands d'entreprise en fin d'année</a>. Ne mélangez pas les deux lignes budgétaires : le repas de Noël est une dépense de fonctionnement, le cadeau salarié relève d'un cadre distinct.</p>

      <h2>Comment arbitrer si le budget est serré</h2>
      <p>Dans l'ordre de ce que nous conseillons à nos clients :</p>
      <ul>
        <li><strong>Changez de format avant de changer de quantité.</strong> Un petit-déjeuner de Noël réussi vaut mieux qu'un cocktail sous-dimensionné.</li>
        <li><strong>Décalez la date.</strong> Début décembre ou une galette en janvier se calent plus facilement et laissent plus de choix.</li>
        <li><strong>Achetez les boissons alcoolisées de votre côté.</strong> C'est presque toujours moins cher.</li>
        <li><strong>Gardez la pièce signature.</strong> C'est ce dont les équipes se souviennent, pas le nombre total de bouchées.</li>
      </ul>

      <h2>Obtenir un budget précis</h2>
      <p>Le devis se fait sur l'effectif, la date, le format et l'adresse de livraison, avec facturation entreprise et TVA. Toute notre carte est halal et sans porc par défaut, options végétariennes, véganes et sans gluten sur demande, sans supplément caché. Voir la page <a href="/creations/evenements-saisonniers/noel">traiteur de Noël en entreprise</a>. <a href="/devis">Demandez votre devis</a>, réponse sous 24h.</p>

      <h2>Questions fréquentes sur le budget d'un repas de Noël en entreprise</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Quel budget par personne pour un repas de Noël en entreprise ?</strong></summary>
          <p>De 28,90 à 35,90 € HT par personne pour un plateau repas de fête, 40,90 € HT pour un cocktail dînatoire de 12 pièces et 51,90 € HT pour 16 pièces. Le petit-déjeuner de Noël reste nettement en dessous. Ajoutez 29 € HT de livraison sur Paris et les communes proches.</p>
        </details>
        <details>
          <summary><strong>Combien coûte un repas de Noël pour 40 personnes ?</strong></summary>
          <p>En cocktail dînatoire 12 pièces à 40,90 € HT par personne, comptez 1 636 € HT plus 29 € HT de livraison, soit environ 1 665 € HT, hors boissons alcoolisées. En plateaux repas Essentiel, comptez environ 1 185 € HT livraison comprise.</p>
        </details>
        <details>
          <summary><strong>Quels coûts sont souvent oubliés dans un budget de Noël ?</strong></summary>
          <p>Les boissons alcoolisées, presque jamais incluses, la glace, la vaisselle facturée de 3 à 8 € par personne chez beaucoup de prestataires, le personnel de service au delà de 60 personnes, et la zone de livraison dès qu'on sort de Paris et des communes proches.</p>
        </details>
        <details>
          <summary><strong>Y a-t-il un minimum de commande pour un repas de Noël ?</strong></summary>
          <p>Le minimum de commande est de 50 € HT, sans minimum de participants. Certains traiteurs imposent 200 à 500 € de minimum en décembre : c'est un point à vérifier avant de comparer deux devis.</p>
        </details>
        <details>
          <summary><strong>Comment réduire le budget sans rater la soirée ?</strong></summary>
          <p>Changez de format plutôt que de quantité : un petit-déjeuner de Noël réussi vaut mieux qu'un cocktail sous-dimensionné. Décalez la date vers début décembre ou une galette en janvier, et achetez les boissons alcoolisées de votre côté.</p>
        </details>
      </div>
    `,
    relatedProducts: ['plateau-clubs-signature', 'navettes-salees', 'viennoiseries-melangees'],
    faq: [
      { q: "Quel budget par personne pour un repas de Noël en entreprise ?", a: "De 28,90 à 35,90 € HT par personne pour un plateau repas de fête, 40,90 € HT pour un cocktail dînatoire de 12 pièces et 51,90 € HT pour 16 pièces. Le petit-déjeuner de Noël reste nettement en dessous. Ajoutez 29 € HT de livraison sur Paris et les communes proches." },
      { q: "Combien coûte un repas de Noël pour 40 personnes ?", a: "En cocktail dînatoire 12 pièces à 40,90 € HT par personne, comptez 1 636 € HT plus 29 € HT de livraison, soit environ 1 665 € HT, hors boissons alcoolisées. En plateaux repas Essentiel, comptez environ 1 185 € HT livraison comprise." },
      { q: "Quels coûts sont souvent oubliés dans un budget de Noël ?", a: "Les boissons alcoolisées, presque jamais incluses, la glace, la vaisselle facturée de 3 à 8 € par personne chez beaucoup de prestataires, le personnel de service au delà de 60 personnes, et la zone de livraison dès qu'on sort de Paris et des communes proches." },
      { q: "Y a-t-il un minimum de commande pour un repas de Noël ?", a: "Le minimum de commande est de 50 € HT, sans minimum de participants. Certains traiteurs imposent 200 à 500 € de minimum en décembre : c'est un point à vérifier avant de comparer deux devis." },
      { q: "Comment réduire le budget sans rater la soirée ?", a: "Changez de format plutôt que de quantité : un petit-déjeuner de Noël réussi vaut mieux qu'un cocktail sous-dimensionné. Décalez la date vers début décembre ou une galette en janvier, et achetez les boissons alcoolisées de votre côté." },
    ],
  },

  {
    slug: 'petit-dejeuner-entreprise-paris',
    titre: "Petit-déjeuner d'entreprise à Paris : budget, composition et organisation",
    metaTitle: "Petit-déjeuner d'entreprise à Paris : le guide",
    categorie: 'Conseils',
    date: '19 août 2026',
    isoDate: '2026-08-19',
    extrait: "À partir de 2,90 € HT par personne en formule simple et 6,90 € en petit-déjeuner complet : budget, composition, quantités et organisation, avec des paniers chiffrés sur nos tarifs réels.",
    img: '/hero-petitdej.webp',
    contenu: `
      <p>Le <strong>petit-déjeuner d'entreprise</strong> est devenu le format le plus utilisé pour réunir une équipe : il coûte moins cher qu'un déjeuner, il ne prend qu'une heure, et tout le monde est présent. Encore faut-il le calibrer correctement. Voici les repères que nous donnons à nos clients, avec des budgets calculés sur nos tarifs réels, à <strong>Paris et en Île-de-France</strong>.</p>

      <h2>Combien coûte un petit-déjeuner d'entreprise ?</h2>
      <p>Cela dépend surtout de ce que vous mettez dedans. Plutôt que d'annoncer un chiffre sans le justifier, voici deux paniers réels, calculés sur nos tarifs.</p>
      <p><strong>La formule simple, à partir de 2,90 € HT par personne.</strong> Des viennoiseries et du café, rien de plus, pour un point d'équipe de trente minutes : croissants et pains au chocolat pur beurre 16 pièces (26,80 € HT) et un thermos de café bio (19,50 € HT), soit <strong>46,30 € HT pour 16 personnes</strong>.</p>
      <p><strong>Le petit-déjeuner complet, à partir de 6,90 € HT par personne.</strong> Celui qu'on sert quand on reçoit ou qu'on veut marquer le coup :</p>
      <ul>
        <li>Assortiment de viennoiseries pur beurre, 30 pièces : <strong>48,90 € HT</strong></li>
        <li>Corbeille de fruits de saison : <strong>38,90 € HT</strong></li>
        <li>Thermos de café bio : <strong>19,50 € HT</strong></li>
        <li>Deux jus Alain Milliat : <strong>19,00 € HT</strong></li>
      </ul>
      <p>Soit <strong>126,30 € HT pour 20 personnes</strong>, ou 6,32 € par personne. Le coût par tête baisse avec l'effectif : sur une équipe de 10, le même panier tourne plutôt autour de 9 à 10 € par personne, parce que les plateaux se partagent moins bien. Comptez en plus la livraison, 29 € HT sur Paris et les communes proches, et un minimum de commande de 50 € HT.</p>
      <p>Pour le détail par tranche d'effectif, de 5 à 100 personnes, nous avons publié des tableaux dédiés dans notre guide <a href="/journal/budget-petit-dejeuner-equipe-personnes">budget petit-déjeuner d'entreprise</a>.</p>

      <h2>Que mettre dans un petit-déjeuner d'entreprise ?</h2>
      <p>Un bon petit-déjeuner de bureau tient sur quatre briques. En retirer une se voit immédiatement.</p>
      <ul>
        <li><strong>Le sucré chaud</strong> : viennoiseries pur beurre, croissants et pains au chocolat. C'est la base, et c'est là que la différence entre artisanal et industriel se sent le plus.</li>
        <li><strong>Le frais</strong> : fruits découpés ou brochettes. C'est la brique qu'on oublie le plus souvent, et celle qui part le plus vite.</li>
        <li><strong>Les boissons chaudes</strong> : café et thé, en thermos, en quantité suffisante. Un thermos pour vingt personnes ne suffit pas.</li>
        <li><strong>Les jus</strong> : de vrais jus, pas du concentré. Nous livrons les jus et nectars Alain Milliat. Les quantités à prévoir sont détaillées dans notre guide <a href="/journal/boissons-petit-dejeuner-entreprise">boissons pour un petit-déjeuner d'entreprise</a>.</li>
      </ul>
      <p>Au-delà, tout est optionnel : madeleines, cookies, cakes maison, yaourts fermiers, brioche babka. C'est ce qui transforme un petit-déjeuner correct en petit-déjeuner dont l'équipe reparle. Toute la carte est sur notre page <a href="/creations/petits-dejeuners-et-pauses">petits-déjeuners et pauses</a>.</p>

      <h2>Combien de viennoiseries par personne ?</h2>
      <p>Le repère : <strong>1,5 viennoiserie par personne</strong> quand il y a autre chose à côté (fruits, yaourts), et <strong>2 par personne</strong> si les viennoiseries sont seules. En dessous, il en manque toujours ; au-dessus, il en reste. Nous détaillons le calcul, y compris pour les gros effectifs, dans notre guide <a href="/journal/combien-viennoiseries-par-personne">combien de viennoiseries par personne</a>.</p>
      <p>La même logique vaut pour les autres pièces : voir <a href="/journal/combien-macarons-commander-entreprise">combien de macarons commander</a> pour les formats plus festifs.</p>

      <h2>Pour quelles occasions ?</h2>
      <ul>
        <li><strong>La réunion du matin</strong> ou le comité de direction, avec un petit-déjeuner d'accueil posé avant l'arrivée des participants</li>
        <li><strong>L'onboarding</strong> d'une nouvelle recrue, ou l'accueil d'un client ou d'un partenaire</li>
        <li><strong>Le rituel hebdomadaire</strong>, une fois par semaine, qui fait venir les gens au bureau un jour donné</li>
        <li><strong>Le séminaire</strong> et la journée de formation, où il faut souvent gérer deux services</li>
        <li><strong>Les moments de fête</strong>, comme le <a href="/journal/petit-dejeuner-noel-bureau-entreprise">petit-déjeuner de Noël</a> en décembre</li>
      </ul>

      <h2>À quelle heure le prévoir ?</h2>
      <p>Entre <strong>9h et 10h</strong> pour un petit-déjeuner d'équipe. Plus tôt, une partie des gens n'est pas encore arrivée ; plus tard, on empiète sur le déjeuner et personne ne mange. Pour une réunion, faites livrer trente minutes avant le début, pas à l'heure pile.</p>
      <p>Nous livrons à partir de <strong>6h30</strong>, ce qui permet de poser le plateau bien avant l'arrivée des premiers. Vous donnez une heure précise, pas une plage de deux heures.</p>

      <h2>Où l'installer dans les bureaux ?</h2>
      <p>Pas dans une salle de réunion fermée : les gens n'y vont pas spontanément. Le meilleur emplacement est un espace de passage où l'on peut rester debout, cuisine commune ou open space. L'objectif est que l'on s'arrête naturellement, pas que l'on doive décider d'aller à un événement.</p>

      <h2>Et les régimes de l'équipe ?</h2>
      <p>Toute notre carte est <strong>halal et sans porc par défaut</strong>, sans que vous ayez à le demander et sans supplément. Les options végétariennes, véganes et sans gluten se précisent au moment du devis, avec les effectifs concernés. Sur le sans gluten, prévenez-nous en amont : notre atelier manipule de la farine, nous sommes transparents sur le risque de traces.</p>
      <p>C'est le point qui règle le plus de problèmes en interne : sur une équipe de trente personnes, personne n'a à se signaler ni à manger à part.</p>

      <h2>Livraison à Paris et en Île-de-France</h2>
      <p>Nous livrons avec notre propre équipe, jamais en sous-traitance. C'est ce qui nous permet de tenir un créneau précis et de connaître les accès de nos secteurs : les tours de <a href="/traiteur/puteaux">La Défense côté Puteaux</a>, <a href="/traiteur/neuilly-sur-seine">Neuilly-sur-Seine</a>, <a href="/traiteur/levallois-perret">Levallois</a>, <a href="/traiteur/boulogne-billancourt">Boulogne-Billancourt</a> où se trouve notre atelier, et l'ensemble des communes listées sur notre page <a href="/traiteur">traiteur entreprise Paris et Île-de-France</a>.</p>
      <p>Sur les sites à accès contrôlé, quai de livraison ou accueil filtré, indiquez-le à la commande : c'est ce qui évite qu'un livreur attende à une barrière pendant que le café refroidit.</p>

      <h2>Commander</h2>
      <p>Commande avant <strong>14h la veille</strong> pour une livraison dès 6h30. Minimum 50 € HT, livraison 29 € HT sur Paris et les communes proches, facturation entreprise avec TVA, et un interlocuteur unique si vous commandez régulièrement. <a href="/devis">Demandez votre devis</a>, vous l'avez sous 24h.</p>

      <h2>Questions fréquentes sur le petit-déjeuner d'entreprise</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Quel budget par personne pour un petit-déjeuner d'entreprise ?</strong></summary>
          <p>À partir de 2,90 € HT par personne pour une formule simple viennoiseries et café, et à partir de 6,90 € HT pour un petit-déjeuner complet. Exemple réel pour 20 personnes : assortiment de 30 viennoiseries (48,90 €), corbeille de fruits (38,90 €), thermos de café (19,50 €) et deux jus (19,00 €), soit 126,30 € HT, ou 6,32 € par personne. S'ajoutent la livraison, 29 € HT, et un minimum de commande de 50 € HT.</p>
        </details>
        <details>
          <summary><strong>Combien de viennoiseries faut-il par personne ?</strong></summary>
          <p>Comptez 1,5 viennoiserie par personne s'il y a des fruits et des yaourts à côté, et 2 par personne si les viennoiseries sont servies seules. En dessous il en manque systématiquement.</p>
        </details>
        <details>
          <summary><strong>À quelle heure livrer un petit-déjeuner au bureau ?</strong></summary>
          <p>Entre 9h et 10h pour un petit-déjeuner d'équipe, ou trente minutes avant le début d'une réunion. Nous livrons dès 6h30, le plateau peut donc être posé avant l'arrivée des premiers collaborateurs.</p>
        </details>
        <details>
          <summary><strong>Quel délai pour commander ?</strong></summary>
          <p>Avant 14h la veille pour une livraison le lendemain matin. Sur Boulogne-Billancourt, où se trouve notre atelier, nous acceptons encore des commandes jusqu'à 10h le matin même sur notre sélection disponible du jour.</p>
        </details>
        <details>
          <summary><strong>Les régimes alimentaires sont-ils pris en charge ?</strong></summary>
          <p>Toute la carte est halal et sans porc par défaut, sans supplément. Les options végétariennes, véganes et sans gluten se demandent au devis en indiquant les effectifs concernés. Notre atelier manipulant de la farine, nous signalons le risque de traces sur le sans gluten.</p>
        </details>
      </div>
    `,
    relatedProducts: ['viennoiseries-melangees', 'plateau-fruits-frais', 'madeleines-20'],
    faq: [
      { q: "Quel budget par personne pour un petit-déjeuner d'entreprise ?", a: "À partir de 2,90 € HT par personne pour une formule simple viennoiseries et café, et à partir de 6,90 € HT pour un petit-déjeuner complet. Exemple réel pour 20 personnes : assortiment de 30 viennoiseries (48,90 €), corbeille de fruits (38,90 €), thermos de café (19,50 €) et deux jus (19,00 €), soit 126,30 € HT, ou 6,32 € par personne. S'ajoutent la livraison, 29 € HT, et un minimum de commande de 50 € HT." },
      { q: "Combien de viennoiseries faut-il par personne ?", a: "Comptez 1,5 viennoiserie par personne s'il y a des fruits et des yaourts à côté, et 2 par personne si les viennoiseries sont servies seules. En dessous il en manque systématiquement." },
      { q: "À quelle heure livrer un petit-déjeuner au bureau ?", a: "Entre 9h et 10h pour un petit-déjeuner d'équipe, ou trente minutes avant le début d'une réunion. Nous livrons dès 6h30, le plateau peut donc être posé avant l'arrivée des premiers collaborateurs." },
      { q: "Quel délai pour commander ?", a: "Avant 14h la veille pour une livraison le lendemain matin. Sur Boulogne-Billancourt, où se trouve notre atelier, nous acceptons encore des commandes jusqu'à 10h le matin même sur notre sélection disponible du jour." },
      { q: "Les régimes alimentaires sont-ils pris en charge ?", a: "Toute la carte est halal et sans porc par défaut, sans supplément. Les options végétariennes, véganes et sans gluten se demandent au devis en indiquant les effectifs concernés. Notre atelier manipulant de la farine, nous signalons le risque de traces sur le sans gluten." },
    ],
  },

  {
    slug: 'boissons-petit-dejeuner-entreprise',
    titre: "Boissons pour un petit-déjeuner d'entreprise : combien prévoir par personne ?",
    metaTitle: "Quelles boissons pour un petit-déjeuner d'entreprise ?",
    categorie: 'Conseils',
    date: '19 août 2026',
    isoDate: '2026-08-19',
    extrait: "Un thermos couvre 6 à 8 tasses, pas une équipe entière. Combien de café, de thé, de jus et d'eau commander selon l'effectif, avec le budget correspondant.",
    img: '/hero-petitdej.webp',
    contenu: `
      <p>C'est le poste qu'on calcule en dernier, et c'est celui qui rate le plus souvent. Les viennoiseries, tout le monde sait les compter. Les <strong>boissons d'un petit-déjeuner d'entreprise</strong>, presque personne. Résultat : le café est fini au bout de vingt minutes et la moitié de l'équipe boit de l'eau du robinet.</p>
      <p>Voici les repères que nous utilisons pour chiffrer nos commandes, à <strong>Paris et en Île-de-France</strong>.</p>

      <h2>Le chiffre qu'il faut retenir : un thermos couvre 6 à 8 tasses</h2>
      <p>C'est là que tout se joue. Un thermos, c'est <strong>un litre, soit 6 à 8 tasses</strong>. Pas une équipe. Sur un petit-déjeuner de 20 personnes, un seul thermos de café couvre à peine un tiers des participants, et personne ne reprend une seconde tasse.</p>
      <p>Le café est de loin la boisson la plus demandée le matin : comptez que <strong>7 personnes sur 10</strong> en prendront, et qu'une bonne partie reviendra pour une deuxième tasse si l'occasion dure plus d'une heure.</p>

      <h2>Combien commander selon l'effectif</h2>
      <p>Nos repères pour un petit-déjeuner classique d'une heure, café et thé servis ensemble :</p>
      <ul>
        <li><strong>10 personnes</strong> : 1 à 2 thermos de café, 1 thermos de thé, 1 litre de jus</li>
        <li><strong>20 personnes</strong> : 2 à 3 thermos de café, 1 thermos de thé, 2 litres de jus</li>
        <li><strong>30 personnes</strong> : 4 thermos de café, 2 thermos de thé, 3 litres de jus</li>
        <li><strong>50 personnes</strong> : 6 à 7 thermos de café, 3 thermos de thé, 5 litres de jus</li>
      </ul>
      <p>Si votre petit-déjeuner dure plus d'une heure et demie, ou s'il n'y a pas de machine à café dans les locaux, montez d'un cran sur le café. C'est le seul poste sur lequel nous conseillons systématiquement de prendre large.</p>

      <h2>Les jus : un litre pour six à sept verres</h2>
      <p>Un litre remplit <strong>6 à 7 verres</strong> de 15 cl. Tout le monde ne prend pas de jus au petit-déjeuner, comptez plutôt une personne sur deux. Pour 20 participants, deux litres suffisent dans la grande majorité des cas.</p>
      <p>Nous livrons les jus et nectars Alain Milliat en bouteille d'un litre : jus de pomme, pomme-framboise, tomate, citronnade gingembre à <strong>9,50 € HT</strong>, nectars de pêche, fraise, mangue et fruit de la passion à <strong>10,50 € HT</strong>. La carte complète est sur notre page <a href="/creations/boissons">boissons</a>.</p>
      <p>Un conseil de terrain : deux parfums valent mieux qu'un seul en double. Un jus classique que tout le monde boit, un nectar plus marqué pour ceux qui veulent autre chose. C'est la combinaison qui laisse le moins de fond de bouteille.</p>

      <h2>Le thé et le chocolat chaud</h2>
      <p>Le thé se commande dans un rapport d'environ <strong>un thermos pour quinze à vingt personnes</strong> : il est nettement moins demandé que le café, mais ne pas en avoir se remarque tout de suite. Nous servons les thés Mariage Frères, en thermos d'un litre à <strong>19,50 € HT</strong>, au même prix que le café bio.</p>
      <p>Le chocolat chaud, également à 19,50 € HT, n'a pas d'intérêt sur un petit-déjeuner d'équipe classique. En revanche il devient la boisson principale sur un goûter, un arbre de Noël ou dès qu'il y a des enfants.</p>

      <h2>Faut-il commander l'eau ?</h2>
      <p>Souvent non. La plupart des bureaux ont une fontaine ou des carafes, et l'eau est la boisson qu'on oublie le plus facilement de servir sans que personne ne s'en plaigne.</p>
      <p>Elle devient utile dans deux cas : quand vous recevez des invités externes, et quand le petit-déjeuner se tient dans une salle sans point d'eau. Nous livrons alors Evian et Badoit en 75 cl à <strong>4,80 € HT</strong>, Evian 33 cl à <strong>3,80 € HT</strong>, et L'Eau Neuve en brique carton recyclable de 50 cl à <strong>4,50 € HT</strong> si vous voulez éviter le plastique et le verre.</p>

      <h2>Le budget boissons, concrètement</h2>
      <p>Pour un petit-déjeuner de 20 personnes, une configuration courante :</p>
      <ul>
        <li>2 thermos de café bio : <strong>39,00 € HT</strong></li>
        <li>1 thermos de thé Mariage Frères : <strong>19,50 € HT</strong></li>
        <li>2 litres de jus Alain Milliat : <strong>19,00 € HT</strong></li>
      </ul>
      <p>Soit <strong>77,50 € HT</strong>, ou 3,88 € par personne. Les boissons représentent en général un tiers à 40 % du budget d'un petit-déjeuner complet : ce n'est pas un détail, et c'est pour ça qu'il vaut mieux les chiffrer que les ajouter au dernier moment. Le calcul d'ensemble est dans notre guide <a href="/journal/petit-dejeuner-entreprise-paris">petit-déjeuner d'entreprise à Paris</a>, et le détail par effectif dans <a href="/journal/budget-petit-dejeuner-equipe-personnes">budget petit-déjeuner d'entreprise</a>.</p>

      <h2>Les gros effectifs et les séminaires</h2>
      <p>Au-delà de 60 personnes, les thermos deviennent peu pratiques : il en faut trop, et ils refroidissent. Pour les journées de formation et les séminaires, nous proposons des <strong>jarres de 10 litres</strong> d'infusion bio, gingembre ou passion, à <strong>59,90 € HT</strong>, qui tiennent une matinée entière et se servent en libre accès.</p>

      <h2>Sans sucre, sans alcool, régimes</h2>
      <p>Les jus Alain Milliat sont sans sucre ajouté, sans concentré et sans conservateur, et l'ensemble de notre carte boissons est végane et sans gluten. Sur une équipe où certains évitent le sucre, une infusion ou une eau aromatisée à côté des jus règle la question sans avoir à faire une commande à part.</p>

      <h2>Commander vos boissons</h2>
      <p>Les boissons se commandent avec les plateaux, dans la même livraison : gobelets compris, rien à préparer de votre côté. Commande avant <strong>14h la veille</strong>, livraison dès 6h30, minimum 50 € HT et livraison 29 € HT sur Paris et les communes proches. <a href="/devis">Demandez votre devis</a>, réponse sous 24h.</p>

      <h2>Questions fréquentes sur les boissons d'un petit-déjeuner d'entreprise</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Combien de thermos de café pour 20 personnes ?</strong></summary>
          <p>Deux à trois. Un thermos contient un litre, soit 6 à 8 tasses, et environ 7 personnes sur 10 prennent un café au petit-déjeuner. Si l'événement dure plus d'une heure et demie ou s'il n'y a pas de machine sur place, prenez-en trois.</p>
        </details>
        <details>
          <summary><strong>Combien de litres de jus par personne ?</strong></summary>
          <p>Un litre remplit 6 à 7 verres de 15 cl, et environ une personne sur deux prend un jus. Comptez donc 2 litres pour 20 personnes, 3 litres pour 30. Mieux vaut deux parfums différents qu'une même référence en double.</p>
        </details>
        <details>
          <summary><strong>Quel budget boissons pour un petit-déjeuner d'entreprise ?</strong></summary>
          <p>Environ 3,90 € HT par personne pour une configuration classique : pour 20 personnes, 2 thermos de café (39,00 €), 1 thermos de thé (19,50 €) et 2 litres de jus (19,00 €), soit 77,50 € HT. Les boissons pèsent en général un tiers à 40 % du budget total.</p>
        </details>
        <details>
          <summary><strong>Faut-il commander de l'eau ?</strong></summary>
          <p>Le plus souvent non, la plupart des bureaux ont une fontaine ou des carafes. Elle devient utile si vous recevez des invités externes ou si la salle n'a pas de point d'eau. Nous livrons Evian et Badoit en 75 cl à 4,80 € HT et L'Eau Neuve en brique carton recyclable à 4,50 € HT.</p>
        </details>
        <details>
          <summary><strong>Comment gérer les boissons sur un séminaire de plus de 60 personnes ?</strong></summary>
          <p>Au-delà de 60 personnes, les thermos deviennent peu pratiques et refroidissent. Nous proposons des jarres de 10 litres d'infusion bio, gingembre ou passion, à 59,90 € HT, qui tiennent toute une matinée en libre service.</p>
        </details>
      </div>
    `,
    relatedProducts: ['jus-orange-presse', 'viennoiseries-melangees', 'plateau-fruits-frais'],
    faq: [
      { q: "Combien de thermos de café pour 20 personnes ?", a: "Deux à trois. Un thermos contient un litre, soit 6 à 8 tasses, et environ 7 personnes sur 10 prennent un café au petit-déjeuner. Si l'événement dure plus d'une heure et demie ou s'il n'y a pas de machine sur place, prenez-en trois." },
      { q: "Combien de litres de jus par personne ?", a: "Un litre remplit 6 à 7 verres de 15 cl, et environ une personne sur deux prend un jus. Comptez donc 2 litres pour 20 personnes, 3 litres pour 30. Mieux vaut deux parfums différents qu'une même référence en double." },
      { q: "Quel budget boissons pour un petit-déjeuner d'entreprise ?", a: "Environ 3,90 € HT par personne pour une configuration classique : pour 20 personnes, 2 thermos de café (39,00 €), 1 thermos de thé (19,50 €) et 2 litres de jus (19,00 €), soit 77,50 € HT. Les boissons pèsent en général un tiers à 40 % du budget total." },
      { q: "Faut-il commander de l'eau ?", a: "Le plus souvent non, la plupart des bureaux ont une fontaine ou des carafes. Elle devient utile si vous recevez des invités externes ou si la salle n'a pas de point d'eau. Nous livrons Evian et Badoit en 75 cl à 4,80 € HT et L'Eau Neuve en brique carton recyclable à 4,50 € HT." },
      { q: "Comment gérer les boissons sur un séminaire de plus de 60 personnes ?", a: "Au-delà de 60 personnes, les thermos deviennent peu pratiques et refroidissent. Nous proposons des jarres de 10 litres d'infusion bio, gingembre ou passion, à 59,90 € HT, qui tiennent toute une matinée en libre service." },
    ],
  },
  {
    slug: 'petit-dejeuner-journee-presse-entreprise',
    titre: 'Petit-déjeuner journée presse : le format qui marche vraiment',
    metaTitle: 'Petit-déjeuner journée presse : le format qui marque les esprits',
    categorie: 'Conseils',
    date: '2 septembre 2026',
    isoDate: '2026-09-02',
    extrait: "Les journées presse d'entreprise vivent ou meurent par le détail du petit-déjeuner. Découvrez comment transformer un moment logistique en opportunité de couverture presse — et pourquoi le budget y joue moins qu'on ne le croit.",
    img: '/hero-petitdej.webp',
    contenu: `
      <p>Le petit-déjeuner d'une journée presse n'est pas anodin.</p>
      <p>C'est le premier moment avec les journalistes. Avant la conférence, avant le discours, avant la démo produit, il y a cette demi-heure autour d'un plateau de viennoiseries où se créent — ou ne se créent pas — les connivences qui décident si votre histoire sera couverte ou ignorée.</p>
      <p>Nous avons organisé des centaines de petits-déjeuners pour des agences de relations presse, des marques en lancement, des PME qui voulaient forcer la porte des grands médias. Voici ce que nous avons appris.</p>

      <h2>Pourquoi le petit-déjeuner journée presse est votre vrai levier</h2>
      <p>La plupart des journalistes arrivent à une journée presse sans avoir lu votre dossier. Ils ont cinq autres événements ce mois-ci. Votre pitch les touchera peut-être, votre produit les intéressera peut-être. Mais le petit-déjeuner ? <strong>C'est l'endroit où vous montrez que vous les respectez.</strong></p>
      <p>Les journalistes se souviennent de trois choses :</p>
      <ul>
        <li><strong>Le timing du petit-déj.</strong> Vous avez commencé pile à l'heure, ou attendu ?</li>
        <li><strong>La qualité des viennoiseries.</strong> Industrielles ou artisanales ?</li>
        <li><strong>L'ambiance créée autour.</strong> Pressé, stressé, ou welcoming ?</li>
      </ul>
      <p>Une journée presse sur une marque de cosmétiques avec des viennoiseries surgelées se lit comme : « Vous ne valez pas le prix du vrai beurre ». Une journée presse avec des madeleines artisanales maison et du café décent se lit comme : « On a pris soin de vous ». C'est bête, mais c'est vrai. Et les journalistes confirmés le savent.</p>

      <h2>Le budget petit-déjeuner journée presse, réalité</h2>
      <p>Pour une journée presse de 30 à 50 personnes, comptez :</p>
      <ul>
        <li><strong>Petit-déjeuner classique :</strong> 4 € à 6 € HT par personne (viennoiseries industrielles, café de machine)</li>
        <li><strong>Petit-déjeuner de marque :</strong> 8 € à 12 € HT par personne (viennoiseries artisanales pur beurre, jus pressés, pâtisseries)</li>
        <li><strong>Petit-déjeuner premium :</strong> 14 € à 18 € HT par personne (viennoiseries + fruits découpés + coffret de pâtisseries + service soigné)</li>
      </ul>
      <p>Pour 40 journalistes, la différence entre classique et premium ? <strong>320 € HT</strong>. Soit 0,8 € par article de couverture presse si vous en récoltez 5. <strong>0,8 € pour mettre votre story devant les bons médias.</strong> C'est pas cher.</p>

      <h2>Ce que les journalistes observent (même s'ils ne le disent pas)</h2>
      <p><strong>Les viennoiseries.</strong> Elles doivent être encore chaudes ou très frais. Si elles sont froides depuis deux heures, ça se voit. Et ça dit « on a commandé hier pour demain ».</p>
      <p><strong>Le choix.</strong> Deux croissants et quatre pains au chocolat ennuyent. Huit références créent de la conversation. On se demande quelle maison les a faites. On goûte. C'est un moment.</p>
      <p><strong>Le jus.</strong> Un jus d'orange en briquette dit « nous avons un budget ». Un vrai jus pressé ou un néctar artisanal dit « nous pensons à vous ».</p>
      <p><strong>La vaisselle.</strong> Gobelets en carton vs assiettes en porcelaine. Serviettes papier vs tissus. Les journalistes remarquent si vous traitez cette demi-heure comme un moment, ou comme une formalité.</p>

      <h2>Formule standard : le petit-déjeuner qui marche</h2>
      <p>Pour 40 personnes, 45 minutes, c'est cette composition qui marche vraiment :</p>
      <p><strong>Pièces sucrées :</strong></p>
      <ul>
        <li>30 viennoiseries pures beurre (croissants, pains au chocolat mélangés)</li>
        <li>20 madeleines artisanales (2 saveurs pour créer du choix)</li>
        <li>1 plateau de 15 macarons assortis</li>
      </ul>
      <p><strong>Éléments frais :</strong></p>
      <ul>
        <li>1 corbeille de 30 fruits frais (raisin, fraise, kiwi)</li>
        <li>1 plateau de 20 brioches mini</li>
      </ul>
      <p><strong>Boissons :</strong></p>
      <ul>
        <li>1 thermos de café bio (8 tasses)</li>
        <li>1 thermos de thé (4 tasses)</li>
        <li>2 litres de jus artisanal</li>
        <li>Eau plate et pétillante</li>
      </ul>
      <p><strong>Service :</strong></p>
      <ul>
        <li>Assiettes vraies (pas de carton)</li>
        <li>Serviettes tissus</li>
        <li>Vrai sucre en morceaux</li>
        <li>Beurre frais, confitures artisanales</li>
      </ul>
      <p><strong>Budget :</strong> 420 € HT pour 40 personnes = 10,50 € par personne. Livraison 6h30 matin, prêt à servir.</p>

      <h2>Les erreurs à ne pas faire</h2>
      <p><strong>Arriver en retard.</strong> Si votre traiteur arrive 20 minutes avant le début, les viennoiseries refroidissent. C'est le contraire de l'effet recherché.</p>
      <p><strong>Mélanger le sucré et le salé.</strong> Proposer des croissants ET des sandwichs au jambon confond le message. Choisissez. Pour une journée presse : sucré.</p>
      <p><strong>Oublier les fruits.</strong> C'est le détail qui montre que vous avez pensé à la santé des gens, pas juste à les gaver.</p>
      <p><strong>Servir du café de machine.</strong> C'est moins cher, mais c'est la première chose que les gens oublient. Un bon café est la première chose dont ils se souviennent.</p>

      <h2>Questions fréquentes sur la journée presse</h2>
      <div class="faq-block">
        <details>
          <summary><strong>Combien de viennoiseries par personne sur une journée presse ?</strong></summary>
          <p>1 à 1,5 viennoiserie par personne si la durée est de 45 minutes à 1 heure. Les journalistes ne viennent pas pour manger; ils viennent pour vous écouter. Trop = ils se gavent et s'en vont. Pas assez = vous semblez chiche.</p>
        </details>
        <details>
          <summary><strong>Faut-il prévoir salé pour une journée presse ?</strong></summary>
          <p>Non, sauf si c'est un petit-déjeuner qui se prolonge en buffet déjeunatoire. Si c'est juste petit-déj, restez sucré.</p>
        </details>
        <details>
          <summary><strong>Quel budget pour 20 personnes ?</strong></summary>
          <p>Minimum 200 € HT (petit-déj classique). Recommandé 250-300 € HT (petit-déj de marque). Livraison comprise, 6h30-9h30.</p>
        </details>
        <details>
          <summary><strong>Qui livre les petits-déjeuners journée presse ?</strong></summary>
          <p>Les traiteurs artisanaux qui connaissent ce format, pas les chaînes. Les chaînes vous livrent des plateaux plastique; les artisans comprennent que ce moment compte.</p>
        </details>
      </div>
    `,
    relatedProducts: ['viennoiseries-melangees', 'madeleines-20', 'plateau-fruits-frais', 'jus-orange-presse', 'thermos-cafe-bio'],
    faq: [
      { q: "Combien de viennoiseries par personne sur une journée presse ?", a: "1 à 1,5 viennoiserie par personne pour 45 minutes à 1 heure. Les journalistes ne viennent pas pour manger; ils viennent pour vous écouter." },
      { q: "Quel budget petit-déjeuner pour une journée presse ?", a: "8 à 15 € HT par personne selon la qualité. Pour 40 personnes : 320 à 600 € HT. Le premium (15 €) vaut l'investissement." },
      { q: "Faut-il du salé ou du sucré pour une journée presse ?", a: "Sucré uniquement, sauf si c'est un petit-déj qui devient buffet déjeunatoire. Vous visez le mémorable, pas le rassasiant." },
    ],
  },
  {
    slug: 'dejeuner-entreprise-guide-complet',
    titre: "Déjeuner d'entreprise : guide complet & budgets 2026",
    metaTitle: "Déjeuner d'entreprise : format, budget, recette — guide traiteur",
    categorie: 'Conseils',
    date: '3 septembre 2026',
    isoDate: '2026-09-03',
    extrait: "La vraie règle du déjeuner d'entreprise n'est pas le budget, c'est le timing. Découvrez comment organiser un déjeuner qui dure (et ne distrait personne), du choix des plats à la livraison pile à l'heure.",
    img: '/hero-plateau-signature.webp',
    contenu: `
      <p>Le déjeuner d'entreprise est différent du petit-déjeuner. Le matin, tout le monde arrive affamé et pressé. À midi, les gens ont déjà mangé quelque chose, ils ne vous demandent pas une performance gastronomique, ils demandent un plateau qui arrive à l'heure et ne les colle pas à table pendant une heure.</p>

      <p>C'est pour ça que la plupart des déjeuners d'entreprise réussis ressemblent à ça : plateaux individuels, équilibrés, prêts à manger dans une salle de réunion, sans que personne ne se lève ni ne fasse la vaisselle après.</p>

      <h2>Pourquoi le plateau individuel plutôt que le buffet ?</h2>
      <p>Le buffet c'est pour les réceptions de fin d'année. Pour un déjeuner de réunion ou de formation, c'est un piège :</p>
      <ul>
        <li><strong>Tout le monde se lève en même temps.</strong> La réunion s'arrête.</li>
        <li><strong>Les gens choisissent leur part.</strong> Moitié s'éternisent, moitié reprennent trois fois.</li>
        <li><strong>La table devient un champ de bataille.</strong> Des miettes, des sauces, du vin renversé.</li>
      </ul>
      <p>Le plateau individuel, c'est l'inverse :</p>
      <ul>
        <li>Chacun reçoit le sien. Personne ne se lève.</li>
        <li>Tout le monde mange à la même heure.</li>
        <li>La réunion continue, la nourriture c'est du contexte.</li>
        <li>À 14h, tout est terminé, personne ne demande « tu veux un café ? »</li>
      </ul>

      <h2>Les deux collections de plateaux : Essentiel vs Signature</h2>
      <p><strong>Collection Essentiel</strong> (à partir de <strong>28,90 € HT/pers</strong>)</p>
      <ul>
        <li><strong>La Romaine</strong> : salade, poulet fermier, petit dessert</li>
        <li><strong>La Champêtre</strong> : terrine de campagne, œuf dur, salade</li>
        <li><strong>La Boréale</strong> : filet de poisson blanc, légumes, sauce citron</li>
        <li><strong>La Solaire</strong> (végé) : quinoa, pois chiches, tomate confite</li>
        <li><strong>La Provençale</strong> (végé) : aubergines grillées, chèvre frais, tomate</li>
        <li><strong>La Potagère</strong> (végé) : carottes, betteraves, œuf dur, huile de noisette</li>
      </ul>
      <p>Format : entrée + plat + petit dessert + pain. C'est le classique. Pour les déjeuners réguliers, les réunions de travail, les journées de formation.</p>

      <p><strong>Collection Signature</strong> (à partir de <strong>33,90 € HT/pers</strong>)</p>
      <ul>
        <li><strong>Le Riviera</strong> : pâtes fraîches, crevettes, sauce safran</li>
        <li><strong>La Parisienne</strong> : rôti de veau, sauce aux truffes, légumes</li>
        <li><strong>La Souveraine</strong> : pavé de bœuf, réduction vin rouge</li>
        <li><strong>La Dolce Vita</strong> (végé) : pâtes au pistou, ricotta, légumes grillés</li>
        <li><strong>La Levantine</strong> (végé) : mezze libanaise, feta, crudités</li>
      </ul>
      <p>Format : même que l'Essentiel, mais avec un plat plus travaillé. Pour les déjeuners où vous recevez des clients ou des administrateurs.</p>
      <p>La différence ? Moins de 5 € par personne. Pour 20 personnes, ça fait 100 €. Pour une image, c'est rien.</p>

      <h2>Combien de végétariens prévoir ?</h2>
      <p>C'est la question qu'on reçoit le plus. Réponse : <strong>un tiers</strong>, point.</p>
      <p>Si tu connais la répartition exacte de ton équipe, utilise-la. Sinon, compte un tiers de végé sur le total. C'est presque toujours juste. Sur 30 personnes : 10 végé, 20 omnivores.</p>

      <h2>Livraison à l'heure exacte</h2>
      <p>Tu donnes une heure : 12h30, 13h15, 14h. Pas une plage horaire. On livre à cette heure exacte, directement en salle de réunion ou en espace de restauration.</p>
      <p>Ça veut dire :</p>
      <ul>
        <li>✅ Les plateaux arrivent frais</li>
        <li>✅ Tout le monde peut manger tout de suite</li>
        <li>✅ Si la réunion d'avant déborde, tu nous dis et on retarde</li>
        <li>✅ Pas de plateau qui sèche</li>
      </ul>
      <p><strong>Condition</strong> : commande avant <strong>14h la veille</strong>. Livraison à Paris et Île-de-France.</p>

      <h2>Budget total pour un déjeuner d'entreprise (exemple 20 pers)</h2>
      <table style="width:100%; border-collapse:collapse;">
        <tr><th style="border:1px solid #ccc; padding:8px;">Ligne</th><th style="border:1px solid #ccc; padding:8px;">Budget HT</th></tr>
        <tr><td style="border:1px solid #ccc; padding:8px;">Plateaux Essentiel</td><td style="border:1px solid #ccc; padding:8px;">20 × 28,90 € = <strong>577,80 €</strong></td></tr>
        <tr><td style="border:1px solid #ccc; padding:8px;">Livraison</td><td style="border:1px solid #ccc; padding:8px;"><strong>29 € HT</strong></td></tr>
        <tr><td style="border:1px solid #ccc; padding:8px;"><strong>Total</strong></td><td style="border:1px solid #ccc; padding:8px;"><strong>606,80 € HT</strong></td></tr>
      </table>
      <p>Par personne : <strong>30,34 € HT</strong></p>

      <h2>Halal, sans porc, sans gluten</h2>
      <p><strong>Par défaut</strong>, toute la carte Essentiel et Signature est <strong>halal et sans porc</strong>. Zéro surcoût.</p>
      <p>Les options : Végane et sans gluten sur demande, à préciser avec les effectifs.</p>

      <h2>Erreurs courantes</h2>
      <ul>
        <li><strong>Trop peu de plateaux.</strong> Si tu invites 15 personnes, commande 15 plateaux.</li>
        <li><strong>Plateaux froids.</strong> Si tu commandes pour 12h30 mais que la réunion traîne, les plateaux perdent leur coup.</li>
        <li><strong>Mélange sucré-salé.</strong> Ne demande pas un buffet fruits + plateaux chauds.</li>
      </ul>

      <h2>Comment commander</h2>
      <p>1. Va sur <a href="/devis">/devis</a>, dis le nombre, la date, l'heure exacte et le lieu</p>
      <p>2. Je chiffre, tu reçois le devis sous 24h</p>
      <p>3. Tu confirmes, je te reconfirme 48h avant</p>
      <p>4. Livraison à l'heure</p>
      <p><strong>Délai minimum</strong> : commande avant 14h la veille pour lendemain 12h-15h.</p>
    `,
    relatedProducts: ['plateau-repas-essentiel', 'plateau-repas-signature', 'cafe-bio', 'corbeille-fruits-frais'],
    faq: [
      { q: "Quel est le prix d'un plateau repas d'entreprise ?", a: "Essentiel : à partir de 28,90 € HT/pers. Signature : à partir de 33,90 € HT/pers. S'ajoute livraison 29 € HT. Minimum 50 € HT." },
      { q: "Peut-on mélanger Essentiel et Signature dans la même commande ?", a: "Oui. Tu indiques juste la répartition au devis. 5 Romaine + 3 Riviera + 2 Solaire = zéro problème." },
      { q: "Livrez-vous à une heure précise ou une plage ?", a: "Heure précise. Tu dis 12h30, on livre 12h30. Pas ±30 minutes." },
      { q: "Combien de temps faut-il pour manger un plateau ?", a: "Entre 20-30 minutes en salle, tranquille. Après, les gens reprennent le travail." },
      { q: "Est-ce qu'on peut rajouter des desserts ou de la boisson ?", a: "Oui. Demande-moi un devis pour des thés, des cafés, une corbeille de fruits. Tout se rajoute à la commande." },
    ],
  },
  {
    slug: 'traiteur-puteaux-la-defense-guide-complet',
    titre: 'Comment choisir son traiteur à Puteaux et La Défense : le guide',
    metaTitle: 'Choisir son traiteur à Puteaux & La Défense : guide complet',
    categorie: 'Conseils',
    date: '5 septembre 2026',
    isoDate: '2026-09-05',
    extrait: "Puteaux accueille les plus grands sièges d'Europe. Les équipes pressées, les déjeuners de réunion serrés, les tours qui demandent une logistique de pro. Voici comment commander un traiteur à La Défense rive Puteaux.",
    img: '/hero-la-defense.webp',
    contenu: `
      <p>Puteaux n'est pas Paris. C'est une commune de décision, d'étapes rapides, de réunions qui commencent à 9h pétantes et finissent à 17h pétantes.</p>
      
      <h2>Puteaux, c'est la logistique avant tout</h2>
      <p>La tour Ariane, la tour Aurore, le quartier Bellini, les bords de Seine. Chacun de ces secteurs a ses propres règles d'accès, ses procédures de livraison.</p>
      <p><strong>Ce qu'il faut nous donner :</strong></p>
      <ul>
        <li>Nom exact de la tour + étage</li>
        <li>Nom + numéro du contact sur place</li>
        <li>Heure de réception (pas "entre 9h et 9h30", 9h pile)</li>
        <li>Procédure d'accès (badge, appel en réception ?)</li>
      </ul>

      <h2>Petit-déjeuner à Puteaux : formules et budgets</h2>
      <p><strong>Formule Classique</strong> (8€ HT/pers)</p>
      <ul>
        <li>2 viennoiseries pur beurre par personne</li>
        <li>Jus Alain Milliat (2 litres pour 20 pers)</li>
        <li>Café chaud (thermos 1L)</li>
        <li>Corbeille de fruits frais</li>
      </ul>
      <p>Budget 20 pers = 160 € HT + livraison 29 € HT = <strong>189 € HT</strong> (9,45 €/pers livraison incluse)</p>

      <p><strong>Formule Signature</strong> (12€ HT/pers)</p>
      <ul>
        <li>Viennoiseries + madeleines Mado Paris</li>
        <li>Jus + thé</li>
        <li>Fruits + yaourts</li>
        <li>Petit pain au chocolat</li>
      </ul>
      <p>Budget 20 pers = 240 € HT + livraison = <strong>269 € HT</strong> (13,45 €/pers)</p>

      <h2>Réunions de direction, CODIR, accueil client</h2>
      <p>À Puteaux, les réunions qui comptent c'est les petits-déj de direction.</p>
      <p><strong>Plateaux individuels Signature</strong> (33€ HT/pers)</p>
      <ul>
        <li>Entrée travaillée</li>
        <li>Plat qualitatif (poisson, viande)</li>
        <li>Petit dessert</li>
        <li>Pain + beurre</li>
      </ul>
      <p>Pour 10 pers = 330 € HT + livraison 29 € HT = <strong>359 € HT</strong> (35,90 €/pers)</p>

      <h2>Afterwork & cocktail à La Défense</h2>
      <p><strong>Formule Classique</strong> (8€ HT/pers)</p>
      <ul>
        <li>8 pièces par personne (mix salé-sucré)</li>
        <li>Prêt à servir</li>
      </ul>
      <p>Budget 40 pers = 320 € HT + livraison = <strong>349 € HT</strong> (8,70 €/pers)</p>

      <h2>Délais et logistique</h2>
      <p>Minimum de commande : 50 € HT. Délai : avant 14h la veille. Livraison 6h30 à 18h, créneaux au choix.</p>
      <p>On livre à Puteaux plus qu'à n'importe quelle autre commune. On connaît les temps, les accès, les feux.</p>

      <p>Retrouvez le détail de nos formules et tarifs sur notre page dédiée <a href="/traiteur/puteaux">traiteur d'entreprise à Puteaux</a>, ou <a href="/devis">demandez directement un devis</a> pour votre équipe.</p>
    `,
    relatedProducts: ['petit-dejeuner-classique', 'plateau-repas-signature', 'cocktail-appetitif', 'cafe-bio'],
    faq: [
      { q: "Livrez-vous avant 7h à Puteaux ?", a: "Oui. 6h30 possible. Commande avant 14h la veille." },
      { q: "Pouvez-vous livrer à chaque étage ?", a: "Oui. Pas de surcoût, juste le créneau doit être clair." },
      { q: "Budget pour 50 personnes à La Défense ?", a: "Classique = 400 € HT. Signature = 670 € HT. Livraison incluse." },
    ],
  },
  {
    slug: 'traiteur-gennevilliers-la-defense-ouest-guide-complet',
    titre: 'Comment choisir son traiteur à Gennevilliers : le guide complet',
    metaTitle: 'Choisir son traiteur à Gennevilliers La Défense : le guide',
    categorie: 'Conseils',
    date: '5 septembre 2026',
    isoDate: '2026-09-05',
    extrait: "Gennevilliers, c'est l'autre rive de La Défense. Les tours Société Générale, EDF, Hermès. Logistique différente de Puteaux. Voici comment commander un traiteur à Gennevilliers.",
    img: '/hero-la-defense.webp',
    contenu: `
      <p>Gennevilliers accueille les sièges de géants. C'est pas Paris, c'est pas tout à fait La Défense non plus. C'est une logistique propre, avec ses accès, ses horaires, ses procédures strictes.</p>
      
      <h2>Gennevilliers : particularités logistiques</h2>
      <p>Quai de Seine, boulevard de la République, cours Michelet. Les accès sont contrôlés. Les livraisons se font entre 7h et 18h, avec badge ou passage en réception.</p>
      <p><strong>Ce qu'il faut donner :</strong></p>
      <ul>
        <li>Adresse exacte + bâtiment + étage</li>
        <li>Horaire précis de livraison (pas de plage)</li>
        <li>Nom + téléphone du contact direct</li>
        <li>Restrictions d'accès (badge? appel? réception?)</li>
      </ul>

      <h2>Petit-déjeuner à Gennevilliers : formules</h2>
      <p><strong>Formule Classique</strong> (8€ HT/pers)</p>
      <ul>
        <li>2 viennoiseries pur beurre</li>
        <li>Jus Alain Milliat 2L</li>
        <li>Café chaud thermos</li>
        <li>Corbeille fruits frais</li>
      </ul>
      <p>Budget 20 pers = 160 € HT + livraison 29 € HT = <strong>189 € HT</strong></p>

      <p><strong>Formule Bio</strong> (10€ HT/pers)</p>
      <ul>
        <li>Viennoiseries bio Maison Landemaine</li>
        <li>Jus bio Alain Milliat</li>
        <li>Café bio torréfié local</li>
        <li>Fruits bio corbeille</li>
      </ul>
      <p>Budget 20 pers = 200 € HT + livraison 29 € HT = <strong>229 € HT</strong></p>

      <h2>Plateaux repas Gennevilliers</h2>
      <p><strong>Plateau Essentiel</strong> (28,90€ HT/pers)</p>
      <ul>
        <li>Entrée simple</li>
        <li>Plat qualitatif</li>
        <li>Petit dessert</li>
        <li>Pain + beurre</li>
      </ul>

      <p><strong>Plateau Signature</strong> (33,90€ HT/pers)</p>
      <ul>
        <li>Entrée travaillée</li>
        <li>Plat premium (poisson ou viande)</li>
        <li>Dessert gourmand</li>
        <li>Pain + fromage</li>
      </ul>
      <p>Pour 10 pers Signature = 339 € HT + 29 € livraison = <strong>368 € HT</strong></p>

      <h2>Afterwork Gennevilliers</h2>
      <p><strong>Formule Classique</strong> (8€ HT/pers, 8 pièces)</p>
      <ul>
        <li>Mix salé-sucré</li>
        <li>Prêt à servir</li>
      </ul>
      <p>Budget 40 pers = 320 € HT + livraison = <strong>349 € HT</strong></p>

      <h2>Délais et commande</h2>
      <p>Minimum 50 € HT. Commande avant 14h la veille pour livraison 6h30-18h. On connaît les accès Gennevilliers sur le bout des doigts.</p>

      <p>Retrouvez le détail de nos formules et tarifs sur notre page dédiée <a href="/traiteur/gennevilliers">traiteur d'entreprise à Gennevilliers</a>, notre page <a href="/petit-dejeuner-entreprise/gennevilliers">petit-déjeuner d'entreprise à Gennevilliers</a>, ou <a href="/devis">demandez directement un devis</a> pour votre équipe.</p>
    `,
    relatedProducts: ['petit-dejeuner-bio', 'plateau-repas-essentiel', 'plateau-repas-signature', 'cocktail-appetitif'],
    faq: [
      { q: "Quelle est la différence Gennevilliers vs Puteaux ?", a: "Accès contrôlés à Gennevilliers (badge). Horaires : 6h30-18h mais plage étroite. Pas de surcoût, juste planifier plus tôt." },
      { q: "Livrez-vous avant 7h à Gennevilliers ?", a: "Oui, 6h30 possible. À condition que le bâtiment soit accessible. Confirmer au devis." },
      { q: "Plateau repas moins cher pour 30 personnes ?", a: "Essentiel = 28,90€ HT/pers. 30 pers = 867 € HT + 29 € livraison = 896 € HT total." },
    ],
  },
  {
    slug: 'halloween-entreprise-paris',
    titre: "Halloween en entreprise à Paris : un goûter qui change du quotidien",
    categorie: 'Conseils',
    date: '23 septembre 2026',
    isoDate: '2026-09-23',
    extrait: "Fin octobre, une pause un peu décalée fait toujours son effet. Cookies, macarons orange et noir, brochettes de fruits façon bonbons : comment organiser un goûter d'Halloween en entreprise à Paris sans y passer des heures.",
    img: '/prod-cookies.webp',
    contenu: `
      <h2>Halloween au bureau : la pause qui sort du rituel</h2>
      <p>Fin octobre, les équipes tournent déjà vers les fêtes de fin d'année, et un petit rendez-vous décalé fait toujours du bien avant la ligne droite de décembre. L'<strong>Halloween d'entreprise</strong> n'a rien d'un goûter d'enfants : c'est une pause sucrée à thème, facile à organiser, qui change du café-croissant habituel et donne un prétexte pour rassembler l'équipe un après-midi.</p>
      <p>Pas besoin de décoration hantée ni de costumes obligatoires : une sélection gourmande aux couleurs d'Halloween, orange et noir, suffit à créer l'ambiance. Voici comment organiser ça à <strong>Paris et en Île-de-France</strong>.</p>

      <h2>Pourquoi marquer le coup pour Halloween ?</h2>
      <h3>✓ Une pause qui rompt la routine</h3>
      <p>Entre la rentrée de septembre et les fêtes de décembre, octobre est souvent le mois le plus plat de l'année côté événements internes. Un goûter Halloween comble ce vide à moindre effort : pas de logistique lourde, juste une sélection à thème et un créneau de 30 minutes.</p>
      <h3>✓ Facile à improviser, même tardivement</h3>
      <p>Contrairement à un arbre de Noël qui se prépare des semaines à l'avance, un goûter Halloween se cale en quelques jours. C'est l'occasion parfaite pour un office manager qui veut créer un moment sans y consacrer une semaine d'organisation.</p>
      <h3>✓ Un bon prétexte pour les équipes avec enfants</h3>
      <p>Beaucoup de salariés emmènent leurs enfants faire du porte-à-porte le soir même : un goûter Halloween au bureau en journée leur permet de partager l'esprit de la fête avec leurs collègues avant de rentrer costumer les enfants.</p>

      <h2>Une sélection sucrée aux couleurs d'Halloween</h2>
      <p>Chez L'Écrin Traiteur, tout est halal et sans porc par défaut, avec des options sans gluten sur demande. Pour un goûter Halloween, nous composons une sélection qui joue sur les couleurs et les textures plutôt que sur des produits gadgets :</p>
      <ul>
        <li><strong>Cookies</strong> signés Laura Todd, chocolat et caramel beurre salé, la touche gourmande et foncée</li>
        <li><strong>Macarons</strong> signés Pierre Morel, en particulier les parfums orange, caramel et chocolat pour le camaïeu de saison</li>
        <li><strong>Brochettes de fruits frais</strong>, mandarine et fraise pour la note orange et rouge, vitaminée face au tout-sucré</li>
        <li><strong>Cake marbré</strong> et <strong>cake pépites de chocolat</strong>, tranchés sur plateau pour le côté partage</li>
        <li><strong>Madeleines Mado Paris</strong>, la valeur sûre qui plaît toujours en pause d'équipe</li>
      </ul>
      <p>On peut composer une sélection uniquement à base de ces produits, ou l'intégrer à une pause gourmande classique en y ajoutant simplement une touche saisonnière. Voir toutes nos <a href="/creations/pauses-gourmandes">pauses gourmandes</a>.</p>

      <h2>Animer la pause : simple et sans prise de tête</h2>
      <p>Pas besoin d'un dispositif complexe. Une table dressée avec la sélection, quelques éléments de déco orange et noir apportés par l'équipe, et le moment fonctionne de lui-même. Pour les équipes qui veulent aller plus loin, un <a href="/creations/animations-culinaires">atelier crêpes</a> en fin d'après-midi transforme le goûter en vrai rendez-vous, sans lien direct avec le thème mais toujours efficace pour rassembler.</p>

      <h2>Quel budget pour un goûter Halloween en entreprise ?</h2>
      <p>C'est l'un des formats les plus légers à budgétiser de l'année, comparable à une pause gourmande classique. Quelques repères pour une équipe de 20 à 30 personnes :</p>
      <table>
        <thead>
          <tr><th>Format</th><th>Ce qui est inclus</th><th>Idéal pour</th></tr>
        </thead>
        <tbody>
          <tr><td>Sélection simple</td><td>Cookies, macarons et brochettes de fruits, dressés sur plateau</td><td>Pause courte, budget maîtrisé</td></tr>
          <tr><td>Goûter complet</td><td>Sélection élargie avec cakes tranchés, boissons chaudes et jus</td><td>Après-midi complet, équipe réunie</td></tr>
        </tbody>
      </table>
      <p>Comptez la même logique tarifaire qu'une <a href="/creations/pauses-gourmandes">pause gourmande</a> classique : à partir de 6€ HT/pers pour une sélection simple, livraison 29€ HT en plus.</p>

      <h2>Commander votre goûter Halloween à Paris</h2>
      <p>Commande avant <strong>14h la veille</strong>, livraison dès 6h30 dans vos bureaux à Paris et en Île-de-France. Facturation entreprise avec TVA. Pour une commande de dernière minute, contactez-nous directement : sur ce type de format léger, on peut souvent accompagner même un délai plus court. <a href="/devis">Demandez votre devis</a>.</p>

      <div style="margin-top: 40px;">
        <h2>Questions fréquentes</h2>
        <details>
          <summary><strong>Peut-on commander un goûter Halloween en dernière minute ?</strong></summary>
          <p>C'est un format léger qui se prête bien aux délais courts. La règle reste une commande avant 14h la veille, mais contactez-nous si votre délai est plus serré : sur une sélection simple, on peut souvent s'adapter.</p>
        </details>
        <details>
          <summary><strong>Faut-il une décoration spéciale ?</strong></summary>
          <p>Non, ce n'est pas nécessaire. Une sélection sucrée aux couleurs orange et noir (macarons, cookies, brochettes de fruits) suffit à créer l'ambiance. La décoration reste à votre initiative si vous voulez aller plus loin.</p>
        </details>
        <details>
          <summary><strong>Proposez-vous des options sans gluten pour Halloween ?</strong></summary>
          <p>Oui. Tout est halal et sans porc par défaut, et nous proposons des options sans gluten sur demande. Indiquez vos contraintes lors de la commande.</p>
        </details>
        <details>
          <summary><strong>Quel budget prévoir pour 20 personnes ?</strong></summary>
          <p>À partir de 6€ HT/pers pour une sélection simple (cookies, macarons, brochettes de fruits), soit environ 120€ HT + 29€ HT de livraison pour 20 personnes.</p>
        </details>
      </div>
    `,
    relatedProducts: ['cookies', 'macarons', 'brochettes-fruits', 'cake-marbre'],
    faq: [
      { q: "Peut-on commander un goûter Halloween en dernière minute ?", a: "C'est un format léger qui se prête bien aux délais courts. La règle reste une commande avant 14h la veille, mais contactez-nous si votre délai est plus serré : sur une sélection simple, on peut souvent s'adapter." },
      { q: "Faut-il une décoration spéciale ?", a: "Non, ce n'est pas nécessaire. Une sélection sucrée aux couleurs orange et noir (macarons, cookies, brochettes de fruits) suffit à créer l'ambiance. La décoration reste à votre initiative si vous voulez aller plus loin." },
      { q: "Proposez-vous des options sans gluten pour Halloween ?", a: "Oui. Tout est halal et sans porc par défaut, et nous proposons des options sans gluten sur demande. Indiquez vos contraintes lors de la commande." },
      { q: "Quel budget prévoir pour 20 personnes ?", a: "À partir de 6€ HT/pers pour une sélection simple (cookies, macarons, brochettes de fruits), soit environ 120€ HT + 29€ HT de livraison pour 20 personnes." },
    ],
  },
  {
    slug: 'budget-cocktail-entreprise-paris',
    titre: "Budget cocktail d'entreprise à Paris : combien ça coûte vraiment",
    categorie: 'Conseils',
    date: '23 septembre 2026',
    isoDate: '2026-09-23',
    extrait: "Formule classique ou signature, apéritif ou dînatoire, 20 ou 100 personnes : le budget d'un cocktail d'entreprise varie du simple au triple. Grille de prix détaillée et exemples chiffrés pour construire le vôtre.",
    img: '/hero-cocktail.webp',
    contenu: `
      <h2>Le budget cocktail, la question qu'on nous pose en premier</h2>
      <p>Avant même de parler menu, la plupart des demandes de devis pour un <strong>cocktail d'entreprise</strong> commencent par la même question : combien ça va coûter ? La réponse dépend de trois choses : le nombre de pièces par personne, le niveau de gamme de la formule, et le nombre d'invités. Voici une grille claire pour construire votre budget avant même de demander un devis, à <strong>Paris et en Île-de-France</strong>.</p>

      <h2>Les trois variables qui font le prix</h2>
      <h3>1. Apéritif, déjeunatoire ou dînatoire</h3>
      <p>Un <strong>cocktail apéritif</strong> avant un dîner se limite à 6-8 pièces par personne : c'est le format le moins cher. Un <strong>cocktail déjeunatoire</strong>, qui remplace le repas de midi, monte à 12-14 pièces. Un <strong>cocktail dînatoire</strong> en soirée, qui remplace le dîner, demande 16-18 pièces avec des formats plus consistants. Plus le cocktail remplace un repas, plus le budget grimpe.</p>
      <h3>2. Le niveau de gamme de la formule</h3>
      <p>Nos trois formules couvrent des besoins différents : <strong>L'Invitation</strong> pour un budget maîtrisé, <strong>La Réception</strong> pour un équilibre qualité-prix, <strong>La Célébration</strong> pour les réceptions qui doivent marquer les esprits.</p>
      <h3>3. Le nombre d'invités</h3>
      <p>La livraison (29€ HT) est fixe quel que soit l'effectif : elle pèse proportionnellement moins sur un budget élevé. À l'inverse, sur un petit groupe, elle représente une part plus visible du total, à intégrer dans votre calcul.</p>

      <h2>Grille de prix par formule</h2>
      <table>
        <thead>
          <tr><th>Formule</th><th>Prix</th><th>Pièces par personne</th><th>Idéal pour</th></tr>
        </thead>
        <tbody>
          <tr><td>L'Invitation</td><td>29,90€ HT/pers</td><td>8 pièces</td><td>Afterwork, pot d'équipe, budget maîtrisé</td></tr>
          <tr><td>La Réception</td><td>40,90€ HT/pers</td><td>12 pièces</td><td>Réception client, lancement, événement soigné</td></tr>
          <tr><td>La Célébration</td><td>51,90€ HT/pers</td><td>16 pièces</td><td>Soirée dînatoire, événement de prestige</td></tr>
        </tbody>
      </table>
      <p>Détail des formules sur la page <a href="/creations/cocktails">cocktails d'entreprise</a>.</p>

      <h2>Exemples de budget total</h2>
      <table>
        <thead>
          <tr><th>Effectif</th><th>Formule</th><th>Calcul</th><th>Budget total</th></tr>
        </thead>
        <tbody>
          <tr><td>20 pers</td><td>L'Invitation</td><td>598€ + 29€ livraison</td><td><strong>627€ HT</strong></td></tr>
          <tr><td>40 pers</td><td>L'Invitation</td><td>1 196€ + 29€ livraison</td><td><strong>1 225€ HT</strong></td></tr>
          <tr><td>50 pers</td><td>La Réception</td><td>2 045€ + 29€ livraison</td><td><strong>2 074€ HT</strong></td></tr>
          <tr><td>100 pers</td><td>La Réception</td><td>4 090€ + 29€ livraison</td><td><strong>4 119€ HT</strong></td></tr>
          <tr><td>30 pers</td><td>La Célébration</td><td>1 557€ + 29€ livraison</td><td><strong>1 586€ HT</strong></td></tr>
        </tbody>
      </table>

      <h2>Comment réduire le budget sans dégrader l'expérience</h2>
      <p>Trois leviers simples : choisir un format apéritif plutôt que dînatoire si l'horaire le permet, rester sur la formule L'Invitation plutôt que La Réception quand le contexte est informel (afterwork d'équipe plutôt que réception client), et grouper plusieurs petits événements en une seule commande plus grande, la livraison étant fixe quel que soit l'effectif.</p>

      <h2>Demander votre devis cocktail</h2>
      <p>Commande avant <strong>14h la veille</strong>, livraison dès 6h30 à 18h. Minimum de commande 50€ HT. Facturation entreprise avec TVA. Halal et sans porc par défaut, options végétariennes, véganes et sans gluten sur demande. <a href="/devis">Demandez votre devis</a>, réponse sous 24h avec un budget calé sur votre effectif exact.</p>

      <div style="margin-top: 40px;">
        <h2>Questions fréquentes</h2>
        <details>
          <summary><strong>Quel est le budget minimum pour un cocktail d'entreprise ?</strong></summary>
          <p>À partir de 29,90€ HT/pers en formule L'Invitation (8 pièces), pour un minimum de commande de 50€ HT. Plus 29€ HT de frais de livraison.</p>
        </details>
        <details>
          <summary><strong>Combien coûte un cocktail pour 50 personnes ?</strong></summary>
          <p>En formule La Réception (recommandée pour un événement soigné) : 2 045€ HT + 29€ HT de livraison, soit 2 074€ HT. En L'Invitation : 1 495€ HT + 29€ HT, soit 1 524€ HT.</p>
        </details>
        <details>
          <summary><strong>La livraison est-elle incluse dans le prix par personne ?</strong></summary>
          <p>Non, elle s'ajoute au total : 29€ HT quel que soit l'effectif. Sur un grand groupe, son poids relatif dans le budget total diminue.</p>
        </details>
        <details>
          <summary><strong>Quelle formule choisir pour un afterwork d'équipe ?</strong></summary>
          <p>La formule L'Invitation (29,90€ HT/pers, 8 pièces) suffit largement pour un afterwork informel. Réservez La Réception ou La Célébration aux réceptions clients ou événements qui doivent marquer les esprits.</p>
        </details>
      </div>
    `,
    faq: [
      { q: "Quel est le budget minimum pour un cocktail d'entreprise ?", a: "À partir de 29,90€ HT/pers en formule L'Invitation (8 pièces), pour un minimum de commande de 50€ HT. Plus 29€ HT de frais de livraison." },
      { q: "Combien coûte un cocktail pour 50 personnes ?", a: "En formule La Réception (recommandée pour un événement soigné) : 2 045€ HT + 29€ HT de livraison, soit 2 074€ HT. En L'Invitation : 1 495€ HT + 29€ HT, soit 1 524€ HT." },
      { q: "La livraison est-elle incluse dans le prix par personne ?", a: "Non, elle s'ajoute au total : 29€ HT quel que soit l'effectif. Sur un grand groupe, son poids relatif dans le budget total diminue." },
      { q: "Quelle formule choisir pour un afterwork d'équipe ?", a: "La formule L'Invitation (29,90€ HT/pers, 8 pièces) suffit largement pour un afterwork informel. Réservez La Réception ou La Célébration aux réceptions clients ou événements qui doivent marquer les esprits." },
    ],
  },
  {
    slug: 'octobre-rose-entreprise-paris',
    titre: "Petit-déjeuner Octobre Rose en entreprise à Paris : organiser un moment de sensibilisation",
    metaTitle: "Petit-déjeuner Octobre Rose en entreprise à Paris",
    categorie: 'Conseils',
    date: '25 septembre 2026',
    isoDate: '2026-09-25',
    extrait: "Chaque mois d'octobre, de nombreuses entreprises marquent Octobre Rose par un petit-déjeuner ou une pause en équipe. Sélection rose, notre engagement solidaire, budget : comment mettre en place ce moment à Paris et en Île-de-France.",
    img: '/octobre-rose-hero-madeleines.webp',
    isoModified: '2026-09-25',
    contenu: `
      <h2>Octobre Rose en entreprise : un moment simple à organiser</h2>
      <p><strong>Octobre Rose</strong> est la campagne annuelle de sensibilisation au dépistage du cancer du sein, portée en France notamment par l'association Ruban Rose. De nombreuses entreprises marquent l'occasion par un temps fort convivial : petit-déjeuner d'équipe, pause l'après-midi, ou collecte associée à un événement plus large. C'est un moment simple à organiser qui donne un vrai sens à une pause au bureau, à <strong>Paris et en Île-de-France</strong>.</p>
      <p>Cet article couvre le côté pratique : comment composer une sélection à dominante rose, quel budget prévoir, et comment l'organiser sans y passer des heures. Retrouvez le détail complet de notre engagement sur notre page <a href="/creations/evenements-saisonniers/octobre-rose">Octobre Rose en entreprise</a>.</p>

      <h2>Notre engagement : 1 € reversé par convive en octobre</h2>
      <p>Pendant tout le mois d'octobre, L'Écrin Traiteur reverse <strong>1 € par convive servi</strong> à la recherche contre le cancer du sein, sur l'ensemble des commandes du mois, pas seulement sur les sélections roses. Un petit-déjeuner de 40 personnes, ce sont 40 € de don. Le montant total collecté est publié en fin de mois, et le reçu du don est disponible sur simple demande.</p>

      <h2>Pourquoi marquer Octobre Rose en entreprise</h2>
      <h3>✓ Un signal de sensibilisation simple et concret</h3>
      <p>Un petit-déjeuner ou une pause aux couleurs d'Octobre Rose rappelle à toute l'équipe l'importance du dépistage, sans discours lourd : la couleur et le geste suffisent à porter le message.</p>
      <h3>✓ Un temps fort qui rassemble</h3>
      <p>Comme pour tout rendez-vous convivial au bureau, c'est un prétexte pour réunir les équipes autour d'un moment de partage, souvent fédérateur au-delà des services et des équipes habituelles.</p>
      <h3>✓ Un engagement chiffré, pas seulement symbolique</h3>
      <p>Contrairement à un simple geste de communication, notre don d'1 € par convive s'applique automatiquement à toute commande passée en octobre. Le petit-déjeuner devient le point de départ d'une contribution réelle, sans démarche supplémentaire de votre part.</p>

      <h2>Une sélection à dominante rose</h2>
      <p>Chez L'Écrin Traiteur, tout est halal et sans porc par défaut, avec des options sans gluten sur demande. Pour Octobre Rose, notre partenaire pâtissier Mado a composé une sélection dédiée :</p>
      <ul>
        <li><strong><a href="/creations/pauses-gourmandes/madeleines-octobre-rose">Coffret de 10 madeleines Octobre Rose</a></strong> (29 € HT), glaçage rose et décor filet signés Mado : pour chaque coffret vendu, 1 € supplémentaire est reversé à Ruban Rose, en plus de notre engagement général</li>
        <li><strong>Plateau macarons et cakes fruits rouges</strong>, framboise et fraise, pour un camaïeu naturellement rose</li>
        <li><strong>Tartelettes framboise</strong>, individuelles, pour une pause légère</li>
        <li><strong>Smoothie fruits rouges</strong> et <strong>thé Mariage Frères</strong>, pour accompagner la sélection sucrée</li>
        <li>Emballages avec ruban rose sur simple demande</li>
      </ul>
      <p>On peut composer une sélection entièrement dédiée, ou l'intégrer à un petit-déjeuner ou une pause gourmande classique en y ajoutant une touche rose. Voir toutes nos <a href="/creations/petits-dejeuners-et-pauses">créations petit-déjeuner</a> et <a href="/creations/pauses-gourmandes">pauses gourmandes</a>.</p>

      <h2>Quel budget prévoir ?</h2>
      <p>C'est un format comparable à un petit-déjeuner ou une pause gourmande classique, sans surcoût lié au thème, en plus du don automatique d'1 € par convive. Quelques repères pour une équipe de 20 à 30 personnes :</p>
      <table>
        <thead>
          <tr><th>Format</th><th>Ce qui est inclus</th><th>Idéal pour</th></tr>
        </thead>
        <tbody>
          <tr><td>Pause simple</td><td>Coffret de madeleines Octobre Rose et plateau macarons fruits rouges</td><td>Pause courte, budget maîtrisé</td></tr>
          <tr><td>Petit-déjeuner complet</td><td>Viennoiseries, café, jus et sélection rose (macarons, tartelettes framboise, smoothie)</td><td>Moment fédérateur en équipe</td></tr>
        </tbody>
      </table>
      <p>Comptez à partir de 12,50€ HT/pers pour un <a href="/creations/petits-dejeuners-et-pauses">petit-déjeuner</a> classique enrichi d'une touche rose, ou à partir de 6€ HT/pers pour une <a href="/creations/pauses-gourmandes">pause gourmande</a> dédiée. Livraison 29€ HT en plus.</p>

      <h2>Organiser votre moment Octobre Rose à Paris</h2>
      <p>Commande avant <strong>14h la veille</strong>, livraison dès 6h30 dans vos bureaux à Paris et en Île-de-France. Facturation entreprise avec TVA. Découvrez le détail de notre offre et de notre engagement sur la page <a href="/creations/evenements-saisonniers/octobre-rose">Octobre Rose en entreprise</a>, ou <a href="/devis">demandez votre devis</a> directement.</p>

      <div style="margin-top: 40px;">
        <h2>Questions fréquentes</h2>
        <details>
          <summary><strong>Qu'est-ce qu'Octobre Rose ?</strong></summary>
          <p>C'est la campagne annuelle de sensibilisation au dépistage du cancer du sein, qui se déroule chaque mois d'octobre en France, portée notamment par l'association Ruban Rose.</p>
        </details>
        <details>
          <summary><strong>Quel est l'engagement de L'Écrin Traiteur pour Octobre Rose ?</strong></summary>
          <p>1 € reversé à la recherche contre le cancer du sein pour chaque convive servi sur l'ensemble des commandes d'octobre, pas seulement sur les sélections roses. Un montant supplémentaire d'1 € est reversé pour chaque Coffret de madeleines Octobre Rose vendu.</p>
        </details>
        <details>
          <summary><strong>Quels produits composent une sélection rose ?</strong></summary>
          <p>Le Coffret de 10 madeleines Octobre Rose signé Mado, un plateau de macarons et cakes fruits rouges, des tartelettes framboise, et un smoothie fruits rouges pour accompagner.</p>
        </details>
        <details>
          <summary><strong>Peut-on commander en dernière minute ?</strong></summary>
          <p>La règle reste une commande avant 14h la veille. Pour un événement prévu tôt en octobre, mieux vaut commander dès maintenant pour sécuriser votre date.</p>
        </details>
        <details>
          <summary><strong>Quel budget pour 20 personnes ?</strong></summary>
          <p>À partir de 120€ HT pour une pause gourmande dédiée (6€ HT/pers), ou à partir de 250€ HT pour un petit-déjeuner complet (12,50€ HT/pers). Plus 29€ HT de livraison.</p>
        </details>
      </div>
    `,
    relatedProducts: ['madeleines-octobre-rose', 'macarons'],
    faq: [
      { q: "Qu'est-ce qu'Octobre Rose ?", a: "C'est la campagne annuelle de sensibilisation au dépistage du cancer du sein, qui se déroule chaque mois d'octobre en France, portée notamment par l'association Ruban Rose." },
      { q: "Quel est l'engagement de L'Écrin Traiteur pour Octobre Rose ?", a: "1 € reversé à la recherche contre le cancer du sein pour chaque convive servi sur l'ensemble des commandes d'octobre, pas seulement sur les sélections roses. Un montant supplémentaire d'1 € est reversé pour chaque Coffret de madeleines Octobre Rose vendu." },
      { q: "Quels produits composent une sélection rose ?", a: "Le Coffret de 10 madeleines Octobre Rose signé Mado, un plateau de macarons et cakes fruits rouges, des tartelettes framboise, et un smoothie fruits rouges pour accompagner." },
      { q: "Peut-on commander en dernière minute ?", a: "La règle reste une commande avant 14h la veille. Pour un événement prévu tôt en octobre, mieux vaut commander dès maintenant pour sécuriser votre date." },
      { q: "Quel budget pour 20 personnes ?", a: "À partir de 120€ HT pour une pause gourmande dédiée (6€ HT/pers), ou à partir de 250€ HT pour un petit-déjeuner complet (12,50€ HT/pers). Plus 29€ HT de livraison." },
    ],
  },
