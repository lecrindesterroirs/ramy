...
export const articles = [
  {
    ...
    contenu: `
      ...
      <ul>
        <li><strong>Les madeleines</strong> → Mado Normandie, beurre AOP de Normandie</li>
    ...
    `,
    relatedProducts: ['madeleines-20', 'viennoiseries-melangees', 'plateau-fruits-frais'],
    faq: [
