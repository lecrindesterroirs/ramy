...
export const articles = [
  ...
  },
  {
    ...
    isoDate: '2026-09-25',
    extrait: "Chaque mois d'octobre, de nombreuses entreprises marquent Octobre Rose par un petit-déjeuner ou une pause en équipe. Sélection rose, organisation, budget : comment mettre en place ce moment à Paris et en Île-de-France.",
    img: '/prod-macarons.webp',
    contenu: `
      ...
      <p>Cet article couvre le côté pratique : comment composer une sélection à dominante rose, quel budget prévoir, et comment l'organiser sans y passer des heures.</p>
      ...
      <h3>✓ Facile à associer à une action de solidarité</h3>
      <p>Beaucoup d'entreprises couplent ce moment à une collecte au profit d'une association comme Ruban Rose ou la Ligue contre le cancer, ou à une participation collective à une course caritative (type Odysséa ou La Parisienne). Le petit-déjeuner devient alors le point de rassemblement de l'action.</p>

      <h2>Une sélection à dominante rose</h2>
      <p>Chez L'Écrin Traiteur, tout est halal et sans porc par défaut, avec des options sans gluten sur demande. Pour Octobre Rose, nous composons une sélection qui joue sur les teintes roses et rouges, sans forcer sur le thème :</p>
      <ul>
        <li><strong>Macarons Pierre Morel</strong>, en particulier les parfums fraise, framboise, passion cœur framboise et pistache cœur framboise, pour un camaïeu naturellement rose</li>
        <li><strong>Madeleines Mado Paris</strong>, parfum signature pistache framboise, marbrées de rose</li>
        <li><strong>Cake framboise maison</strong>, tranché sur plateau, la mie colorée de rose à la coupe</li>
        <li><strong>Grande tarte aux framboises</strong>, en format à partager : un geste fédérateur pour marquer le moment ensemble</li>
        <li><strong>Gâteau roulé fraise et vanille</strong>, autre option à partager pour les équipes plus nombreuses</li>
      </ul>
      ...
      <p>C'est un format comparable à un petit-déjeuner ou une pause gourmande classique, sans surcoût lié au thème. Quelques repères pour une équipe de 20 à 30 personnes :</p>
      <table>
        <thead>
          <tr><th>Format</th><th>Ce qui est inclus</th><th>Idéal pour</th></tr>
        </thead>
        <tbody>
          <tr><td>Pause simple</td><td>Coffret de macarons et madeleines parfum framboise, dressés sur plateau</td><td>Pause courte, budget maîtrisé</td></tr>
          <tr><td>Petit-déjeuner complet</td><td>Viennoiseries, café, jus et sélection rose (macarons, cake framboise), grande tarte à partager</td><td>Moment fédérateur en équipe</td></tr>
        </tbody>
      </table>
      ...
      <p>Commande avant <strong>14h la veille</strong>, livraison dès 6h30 dans vos bureaux à Paris et en Île-de-France. Facturation entreprise avec TVA. Si vous couplez le moment à une collecte, nous pouvons ajuster la sélection selon votre budget et le nombre de participants. <a href="/devis">Demandez votre devis</a>.</p>
      ...
      <div style="margin-top: 40px;">
        ...
        <details>
          ...
          <p>Principalement les macarons Pierre Morel (fraise, framboise, pistache cœur framboise), les madeleines Mado Paris parfum pistache framboise, le cake framboise et la tarte aux framboises en grand format à partager.</p>
        </details>
        <details>
    ...
    `,
    relatedProducts: ['macarons', 'cake-framboise', 'madeleines-20'],
    faq: [
      ...
      { q: "Quels produits composent une sélection rose ?", a: "Principalement les macarons Pierre Morel (fraise, framboise, pistache cœur framboise), les madeleines Mado Paris parfum pistache framboise, le cake framboise et la tarte aux framboises en grand format à partager." },
