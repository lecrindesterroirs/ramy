export const articles = [
  ...
  },
  {
    ...
    contenu: `
      ...
      <p>Pour les entreprises qui ont un bilan carbone ou un rapport RSE annuel, le poste "restauration d'entreprise" peut faire l'objet d'une section dédiée. Nous pouvons vous fournir une liste de nos fournisseurs, leurs certifications, et les informations nécessaires à votre reporting. Contactez-nous à <a href="mailto:commercial@lecrin-traiteur.fr">commercial@lecrin-traiteur.fr</a> pour un devis traiteur adapté à vos engagements RSE.</p>
    `,
  ...
  },
  {
    ...
    contenu: `
      ...
      <h2>1. La pause thé Mariage Frères</h2>
      <p>Un thermos de thé de qualité accompagné de quelques pâtisseries fines change complètement l'atmosphère d'une salle de réunion. Les thés Mariage Frères ont cet avantage d'être reconnaissables et appréciés : vos équipes remarquent immédiatement la différence avec un sachet de supermarché. Parfait pour une réunion de début d'après-midi ou une pause de 16h.</p>
