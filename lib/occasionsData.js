...
export const OCCASIONS = [
  ...
  },
  {
    ...
    seoDescription: 'Traiteur afterwork d\'entreprise à Paris : 8 à 16 pièces par personne, livrées en fin de journée, prêtes à poser. Sans minimum de commande, devis sous 24h.',
    productCategory: 'cocktails',
    seoArticle: `
      ...
      <p>Trois formats, selon le ton que vous voulez donner à la soirée. La formule <strong>Cocktail</strong> (8 pièces par personne) couvre l\'afterwork classique entre collègues : samoussas, mini quiches, bruschettas, brochettes, et deux pièces sucrées pour finir. La formule <strong>Signature</strong> (12 pièces) ajoute des bouchées terre et mer, pour un after work où vous recevez des invités externes. La formule <strong>Prestige</strong> (16 pièces) remplace le dîner. Toutes sont détaillées sur notre page <a href="/creations/cocktails">formules cocktail</a>.</p>
      ...
      <h2>Un afterwork sans minimum de commande</h2>
      <p>Pas besoin d\'un événement d\'ampleur pour justifier un afterwork. Nous livrons pour une dizaine de collègues comme pour soixante. Facturation entreprise et TVA sur demande, <a href="/devis">devis sous 24h</a>.</p>
    `,
    ...
    faq: [
      { q: 'Combien coûte un traiteur afterwork à Paris ?', a: 'Le budget dépend de la formule et du nombre de participants. La formule Cocktail (8 pièces par personne) est notre entrée de gamme pour un afterwork d\'équipe, la formule Signature (12 pièces) pour un afterwork avec invités externes. La livraison est à 29 € sur Paris et les Hauts-de-Seine. Demandez un devis, vous l\'avez sous 24h.' },
