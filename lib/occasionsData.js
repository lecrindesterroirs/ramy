...
export const OCCASIONS = [
  {
    ...
    seoTitle: 'Plateau repas CODIR COMEX Paris — Traiteur déjeuner réunion de direction livraison bureau',
    ...
    faq: [
      ...
      { q: 'Pour combien de personnes livrez-vous un plateau repas CODIR ou COMEX ?', a: 'Nous livrons à partir de 2 personnes, sans minimum de commande. Un COMEX de 6 personnes comme un CODIR de 14 personnes sont des commandes standard pour nous.' },
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <p>Pour un séminaire, nous recommandons des produits énergisants et variés : <strong>plateaux de viennoiseries artisanales</strong> pour l'accueil du matin, <strong>brochettes de fruits frais</strong> pour maintenir l'énergie, <strong>chouquettes</strong> et <strong>madeleines Mado Paris</strong> pour les pauses de l'après-midi. Des produits qui plaisent à tout le monde sans lourdeur.</p>
  ...
  },
  {
    ...
    seoTitle: 'Petit-déjeuner d\'entreprise Paris — traiteur viennoiseries artisanales livrées dès 6h30',
  ...
  },
  {
    ...
    seoTitle: 'Déjeuner d\'entreprise Paris — traiteur plateaux repas livrés au bureau',
    seoDescription: 'Traiteur déjeuner d\'entreprise à Paris et en Île-de-France. Plateaux repas complets et artisanaux, livraison à l\'heure du déjeuner, commande avant 14h la veille.',
    productCategory: 'plateaux-repas',
    seoArticle: `
      <p>Certains jours, sortir déjeuner n\'est pas une option — réunion qui s\'éternise, deadline serrée, journée de formation. Le <strong>déjeuner d\'entreprise</strong> livré directement au bureau permet à l\'équipe de rester concentrée sans sacrifier la qualité du repas.</p>
      <h2>Nos plateaux repas pour le déjeuner en entreprise</h2>
      <p>Notre collection couvre tous les goûts : <strong>Le Nordique</strong> (saumon fumé, crème citronnée) pour les amateurs de poisson, <strong>Le Prestige Bœuf</strong> (tataki, chimichurri) pour les envies plus généreuses, <strong>Le César</strong> pour une valeur sûre, et <strong>L\'Italien</strong> (burrata, pesto) en option végétarienne.</p>
      <h2>Livraison déjeuner d\'entreprise — Paris et Île-de-France</h2>
      <p>Précisez votre heure de livraison et le nombre de plateaux : nous livrons directement en salle de réunion ou en espace de restauration, prêts à être servis. Commande avant <strong>14h la veille</strong>.</p>
      <h2>Un déjeuner sans interruption de votre journée de travail</h2>
      <p>Chaque plateau est individuel et complet — pas de service à organiser, pas de vaisselle à gérer. Vos équipes déjeunent sur place, sans perdre de temps, avec un repas artisanal digne d\'un vrai déjeuner.</p>
    `,
    ...
    faq: [
      { q: 'Peut-on mélanger plusieurs plateaux différents dans une même commande ?', a: 'Oui, c\'est même recommandé pour satisfaire tous les goûts. Précisez la répartition souhaitée (végétarien, poulet, viande, poisson) lors de votre commande.' },
      { q: 'Livrez-vous à une heure précise pour le déjeuner ?', a: 'Oui, indiquez l\'heure souhaitée lors de la commande — nous livrons à l\'heure convenue, directement en salle ou en espace de restauration.' },
    ],
  },
  {
    ...
    seoTitle: 'Cocktail d\'entreprise Paris — traiteur formules cocktail salé-sucré livrées',
  ...
  },
  {
    ...
    piliers: [
      ...
      { icon: '✦', title: 'Prêt en quelques clics', text: 'Une commande simple, sans minimum, pour un afterwork improvisé ou planifié.' },
      { icon: '✦', title: 'Livré à l\'heure du pot', text: 'Livraison en fin de journée, à l\'heure qui vous arrange.' },
    ],
    seoTitle: 'Afterwork entreprise Paris — traiteur formules cocktail livrées en fin de journée',
    seoDescription: 'Traiteur afterwork d\'entreprise à Paris : formules cocktail salées et sucrées livrées en fin de journée pour vos pots d\'équipe et moments conviviaux.',
    productCategory: 'cocktails',
    seoArticle: `
      <p>L\'<strong>afterwork</strong> est devenu un rituel dans beaucoup d\'entreprises : un moment informel de fin de journée pour souffler ensemble, sans nécessairement organiser un grand événement. Quelques pièces salées et sucrées suffisent à créer ce moment.</p>
      <h2>Nos formules pour un afterwork réussi</h2>
      <p>La formule <strong>Cocktail</strong> (8 pièces/personne) est idéale pour un afterwork régulier entre collègues — samoussas, mini quiches, bruschettas et une touche sucrée. La formule <strong>Signature</strong> convient pour un afterwork un peu plus marquant, avec des invités ou partenaires.</p>
      <h2>Livraison afterwork — en fin de journée, partout en Île-de-France</h2>
      <p>Indiquez l\'heure de votre afterwork : nous livrons en fin de journée, prêt à poser sur la table, sans dressage nécessaire. Commande avant <strong>14h la veille</strong> pour une organisation sans stress.</p>
      <h2>Un moment simple à organiser, sans minimum de commande</h2>
      <p>Pas besoin d\'un grand événement pour justifier un afterwork : quelques plateaux suffisent pour une dizaine de collègues comme pour cinquante. L\'Écrin Traiteur s\'adapte à la taille de votre équipe.</p>
    `,
    ...
    faq: [
      ...
      { q: 'Y a-t-il un minimum de personnes pour un afterwork ?', a: 'Non, aucun minimum de commande. Nous livrons aussi bien pour une dizaine de collègues que pour un afterwork de plusieurs dizaines de personnes.' },
    ],
  },
]
