...
export const OCCASIONS = [
  ...
  },
  {
    ...
    productCategory: 'cocktails',
    seoArticle: `
      <p>L\'<strong>afterwork</strong> est devenu un rituel dans beaucoup d\'entreprises : un moment informel de fin de journée pour souffler ensemble, sans nécessairement organiser un grand événement. Quelques pièces salées et sucrées suffisent à créer ce moment, qu\'il s\'agisse d\'un simple pot ou d\'un véritable apéritif dinatoire.</p>
