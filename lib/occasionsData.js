...
export const OCCASIONS = [
  {
    ...
    seoArticle: `
      ...
      <p>Nos collections sont conçues pour le repas assis en réunion : portion individuelle complète, conditionnement propre, présentation sobre et élégante. La <strong>collection Toscane</strong> (poulet citron confit, quinoa aux légumes rôtis) et la <strong>collection Bistrot</strong> (tataki de bœuf, tian de légumes) sont nos bestsellers pour les instances de direction.</p>
    ...
    linkedProducts: ['toscane', 'bistrot', 'jardin', 'ocean'],
