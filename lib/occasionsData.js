...
export const OCCASIONS = [
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <p>Trois formats, selon le ton que vous voulez donner à la soirée. <strong>L\'Invitation</strong> (8 pièces par personne, 29,90 € HT) couvre l\'afterwork classique entre collègues : gougères, chou craquelin à la tapenade, tartelette pissaladière, brochette de poulet tandoori, mini cheeseburger, et deux pièces sucrées pour finir. <strong>La Réception</strong> (12 pièces, 39,90 € HT) ajoute des bouchées terre et mer, pour un after work où vous recevez des invités externes. <strong>La Célébration</strong> (16 pièces, 51,90 € HT) remplace le dîner. Le détail des compositions est sur notre page <a href="/creations/cocktails">formules cocktail</a>.</p>
