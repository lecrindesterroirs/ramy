...
export const OCCASIONS = [
  {
    ...
    name: 'Petit-déjeuner CODIR & COMEX',
    navLabel: 'CODIR, COMEX & Direction',
    heroTitle: 'Petit-déjeuner CODIR & COMEX à Paris',
    heroDescription: 'CODIR ou COMEX — chaque réunion de direction mérite une attention particulière. L\'Écrin Traiteur livre vos sélections artisanales premium directement en salle, dès 6h30.',
    piliers: [
      { icon: '✦', title: 'Présentation irréprochable', text: 'Conditionnement soigné, produits disposés pour être servis directement — sans mise en scène de votre part.' },
      { icon: '✦', title: 'Qualité à la hauteur du moment', text: 'Macarons Pierre Morel, madeleines bio Mado Paris, viennoiseries pur beurre AOP. Des produits que vos membres de direction reconnaissent.' },
      { icon: '✦', title: 'Ponctualité sans faille', text: 'Livraison dès 6h30 — votre CODIR ou COMEX peut démarrer à 8h sans aucune incertitude logistique.' },
    ],
    seoTitle: 'Petit-déjeuner CODIR COMEX Paris — Traiteur réunion de direction livraison bureau dès 6h30',
    seoDescription: 'Traiteur pour vos petits-déjeuners CODIR et COMEX à Paris. L\'Écrin Traiteur livre viennoiseries artisanales et coffrets premium dès 6h30, directement en salle de réunion.',
    seoArticle: `
      <p>Le <strong>petit-déjeuner CODIR</strong> ou <strong>COMEX</strong> n'est pas une réunion ordinaire. C'est le moment où se prennent les décisions stratégiques, où l'on accueille parfois des administrateurs extérieurs, où l'image de la direction se construit dans les détails. Le traiteur que vous choisissez pour ce moment parle de votre culture d'entreprise.</p>
      <h2>CODIR vs COMEX — deux formats, une même exigence de qualité</h2>
      <p>Un <strong>CODIR</strong> (Comité de Direction) rassemble généralement 8 à 15 personnes — les directeurs de l'entreprise. Un <strong>COMEX</strong> (Comité Exécutif) est plus restreint : 5 à 8 membres maximum, souvent le cercle le plus stratégique de l'organisation, parfois complété d'administrateurs ou de membres du conseil. Dans les deux cas, l'exigence est au maximum. L'Écrin Traiteur s'y adapte.</p>
      <h2>Nos produits recommandés pour un CODIR ou un COMEX</h2>
      <p>Pour un CODIR de 8 à 15 personnes, nous recommandons un plateau de <strong>viennoiseries pur beurre</strong> accompagné d'un coffret de <strong>madeleines bio Mado Paris</strong>. Pour un COMEX de 5 à 8 personnes, une sélection de <strong>macarons Pierre Morel</strong> ou un assortiment de <strong>cakes maison</strong> à la pistache et au citron suffit à marquer le moment. Des produits qui créent une conversation, pas seulement une dégustation.</p>
      <h2>Traiteur CODIR & COMEX Paris — de 6h30 à votre heure de réunion</h2>
      ...
      <h2>Traiteur COMEX Paris — discrétion et excellence pour les plus hautes instances</h2>
      <p>Le COMEX réunit les décideurs ultimes. Discrétion de la livraison, présentation sans défaut, produits au meilleur niveau artisanal — L'Écrin Traiteur a conçu son offre pour être à la hauteur de ces moments. Aucun détail ne doit distraire de l'essentiel : votre agenda stratégique.</p>
      <h2>Livré dès 6h30, le matin même de votre CODIR ou COMEX</h2>
      <p>Pas besoin de courir chercher des viennoiseries avant la réunion. L'Écrin Traiteur livre à l'heure que vous choisissez, directement en salle, dès <strong>6h30</strong>. Votre CODIR peut démarrer à 8h — vos produits sont là depuis 7h45, disposés et prêts. Commande la veille avant 14h, livraison ponctuelle garantie.</p>
      <h2>Artisans identifiés — des produits que vos membres de direction reconnaissent</h2>
      <p>Macarons <strong>Pierre Morel</strong>, madeleines bio <strong>Mado Paris</strong>, jus artisanaux <strong>Alain Milliat</strong> : chaque produit que nous sélectionnons porte un nom. Ces maisons sont reconnues des amateurs — et vos membres de direction les connaissent souvent déjà. C'est ce qui fait la différence entre un "plateau de viennoiseries" et une <strong>sélection artisanale</strong> dont on parle encore après la réunion.</p>
    `,
    testimonial: {
    ...
    linkedProducts: ['macarons', 'viennoiseries-melangees', 'madeleines-20'],
    linkedCities: ['paris', 'la-defense', 'neuilly-sur-seine', 'boulogne-billancourt', 'levallois-perret', 'issy-les-moulineaux'],
    faq: [
      { q: 'Quelle est la différence entre un CODIR et un COMEX pour votre prestation ?', a: 'Un COMEX est généralement plus restreint (5-8 personnes) et plus stratégique qu\'un CODIR (8-15 personnes). Pour un COMEX, nous recommandons une sélection plus exclusive : macarons Pierre Morel, cakes maison, assortiment premium. Pour un CODIR, un plateau de viennoiseries artisanales accompagné de madeleines bio est idéal.' },
      { q: 'Pour combien de personnes livrez-vous un petit-déjeuner CODIR ou COMEX ?', a: 'Nous livrons à partir de 2 personnes, sans minimum de commande. Un COMEX de 6 personnes comme un CODIR de 14 personnes sont des commandes standard pour nous.' },
      { q: 'Quel budget prévoir pour un petit-déjeuner CODIR ou COMEX ?', a: 'Comptez entre 8€ et 20€ par personne selon les produits choisis. Nos coffrets macarons et sélections premium (COMEX) sont dans la fourchette haute. Nos plateaux de viennoiseries artisanales (CODIR) dans la fourchette basse.' },
      { q: 'Peut-on personnaliser la présentation pour un COMEX avec membres du conseil ?', a: 'Nos produits arrivent dans un conditionnement professionnel soigné, prêt à être servi directement. Pour une personnalisation plus poussée (ruban, carte nominative, message), contactez-nous pour un devis sur mesure.' },
    ],
  },
  {
    ...
    seoTitle: 'Traiteur séminaire entreprise Paris IDF — Pauses café et petits-déjeuners artisanaux livrés',
    seoDescription: 'Pauses café et petits-déjeuners artisanaux pour vos séminaires d\'entreprise en Île-de-France. Livraison dès 6h30, produits frais, commande avant 14h la veille.',
    seoArticle: `
      <p>Un <strong>séminaire d'entreprise</strong> est un investissement important — en temps, en énergie, en budget. La qualité des pauses et du petit-déjeuner d'accueil contribue directement à l'ambiance de la journée et à la concentration des participants. Un bon traiteur, c'est un détail qui fait la différence.</p>
      <h2>Traiteur séminaire Paris — des produits qui tiennent la journée</h2>
      <p>Pour un séminaire, nous recommandons des produits énergisants et variés : <strong>plateaux de viennoiseries artisanales</strong> pour l'accueil du matin, <strong>brochettes de fruits frais</strong> pour maintenir l'énergie, <strong>chouquettes</strong> et <strong>madeleines bio</strong> pour les pauses de l'après-midi. Des produits qui plaisent à tout le monde sans lourdeur.</p>
      <h2>Livraison traiteur séminaire en Île-de-France — hôtels, centres de conférence, sièges</h2>
      <p>Que votre séminaire se tienne dans un hôtel de Versailles, un centre de conférence à La Défense ou les locaux d'un client à Boulogne-Billancourt, L'Écrin Traiteur livre dans toute l'Île-de-France. Nous adaptons notre logistique à chaque type de lieu — entrée livraison, contact cuisine, heure de montage.</p>
      <h2>Comment commander votre traiteur pour un séminaire</h2>
      <p>Pour les séminaires, nous recommandons de passer commande <strong>48h à l'avance</strong> pour les volumes importants, ou la veille avant 14h pour les groupes jusqu'à 50 personnes. Un devis personnalisé est disponible sur demande pour les événements de plus de 30 personnes.</p>
      <h2>Traiteur séminaire dès 6h30 — partout en Île-de-France, sans engagement</h2>
      <p>Que votre séminaire soit à Paris, à Versailles, à La Défense ou dans un hôtel de Rueil-Malmaison, L'Écrin Traiteur livre à l'heure de votre pause. <strong>Livraison dès 6h30</strong>, adaptée aux contraintes de chaque lieu (entrée livraison, contact cuisine, heure de montage). Aucun engagement de volume, aucune exclusivité demandée — vous choisissez L'Écrin Traiteur parce que c'est le meilleur choix, pas parce que vous y êtes contraint.</p>
      <h2>De 20 à 500 participants — même niveau de fraîcheur, même qualité artisanale</h2>
      <p>Un séminaire de 20 personnes reçoit exactement les mêmes produits qu'un séminaire de 500. Pas de "grande commande, qualité réduite". Nos viennoiseries pur beurre AOP, nos madeleines bio et nos jus artisanaux sont préparés le matin même quelle que soit la quantité. C'est le standard L'Écrin — non négociable.</p>
    `,
    testimonial: {
    ...
    faq: [
      { q: 'Livrez-vous pour des groupes de plus de 50 personnes ?', a: 'Oui, nous gérons des commandes jusqu\'à 500 personnes. Pour les groupes importants, nous recommandons un devis personnalisé pour garantir la disponibilité des produits.' },
  ...
  },
  {
    ...
    seoTitle: 'Traiteur accueil client Paris — Livraison petits-déjeuners et réceptions bureau dès 6h30',
    ...
    seoArticle: `
      ...
      <p>Un client averti reconnaît un macaron <strong>Pierre Morel</strong>. Un connaisseur goûte la différence d'une madeleine bio <strong>Mado Paris</strong>. Un jus <strong>Alain Milliat</strong> sur la table dit quelque chose de votre exigence. Ces produits ne sont pas anonymes — ils portent un nom, une histoire, une qualité reconnaissable. C'est précisément ce qui transforme un accueil en message de marque.</p>
  ...
  },
  {
    ...
    seoTitle: 'Traiteur journée formation entreprise Paris IDF — Pauses café artisanales livraison',
  ...
  },
  {
    ...
    seoTitle: 'Traiteur team building Paris IDF — Petits-déjeuners et pauses artisanales pour événements équipe',
  ...
  },
  {
    ...
    seoTitle: 'Goûter d\'entreprise Paris — traiteur pauses artisanales livrées dans vos bureaux',
    ...
    seoArticle: `
      ...
      <ul>
        ...
        <li><strong>Financiers bio Mado Paris</strong> — légers, moelleux, déclinés en plusieurs parfums. Idéaux pour ceux qui préfèrent le délicat au gourmand.</li>
      ...
      <p>Comptez entre <strong>6€ et 15€ par personne HT</strong> selon les produits choisis. Un goûter standard (cookies + chouquettes + eau) tourne autour de 6–8€/personne. Un goûter premium (macarons + financiers + fruits + boissons) monte à 12–15€/personne. Pour des commandes régulières, L'Écrin Traiteur propose des tarifs préférentiels sur volume.</p>
    ...
    faq: [
      ...
      { q: 'Quels produits recommandez-vous pour un goûter d\'équipe de 20 personnes ?', a: 'Pour 20 personnes, nous recommandons : 1 plateau de macarons (20 pièces), 20 cookies artisanaux, 2 brochettes de fruits (ou 1 corbeille de saison) et des boissons froides. Budget indicatif : 10–12€/personne HT.' },
