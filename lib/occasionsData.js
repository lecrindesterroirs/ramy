...
export const OCCASIONS = [
  ...
  },
  {
    ...
    seoTitle: 'Déjeuner d\'entreprise : plateaux repas dès 28,90€',
    seoDescription: 'Plateaux repas pour vos réunions : entrée, plat, dessert. Dès 28,90 € HT/pers, livrés à l\'heure exacte en salle. Commande avant 14h la veille.',
    productCategory: 'plateaux-repas',
    seoArticle: `
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <p>Chaque formule associe des pièces salées (gougères, choux craquelin, brochettes, mini cheeseburgers) et des pièces sucrées (tartelettes, dôme praliné, brochettes de fruits) pour un équilibre pensé du début à la fin de votre réception.</p>
    `,
  ...
  },
  {
    ...
    seoArticle: `
      ...
      <p>Trois formats, selon le ton que vous voulez donner à la soirée. <strong>L\'Invitation</strong> (8 pièces par personne, 29,90 € HT) couvre l\'afterwork classique entre collègues : gougères, chou craquelin à la tapenade, tartelette pissaladière, brochette de poulet tandoori, mini cheeseburger, et deux pièces sucrées pour finir. <strong>La Réception</strong> (12 pièces, 40,90 € HT) ajoute des bouchées terre et mer, pour un after work où vous recevez des invités externes. <strong>La Célébration</strong> (16 pièces, 51,90 € HT) remplace le dîner. Le détail des compositions est sur notre page <a href="/creations/cocktails">formules cocktail</a>.</p>
