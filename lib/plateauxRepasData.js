...
export const PLATEAUX_REPAS = [
  {
    ...
    seoTitle: 'Plateau repas Méditerranéen entreprise Paris — livraison déjeuner bureau Île-de-France',
    seoArticle: `
  ...
  },
  {
    ...
    seoTitle: 'Plateau repas Riviera — poisson frais livraison Paris déjeuner entreprise',
    seoArticle: `
