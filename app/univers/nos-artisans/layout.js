export const metadata = {
  ...
  description: "Mado Paris, Maison Marques, Alain Milliat, Mariage Frères, Laura Todd, Pierre Morel... Les artisans et producteurs choisis par L'Écrin Traiteur pour leurs savoir-faire.",
  openGraph: {
