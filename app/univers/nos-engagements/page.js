  ...
  return (
    <>
      ...
      <main style={{ background: '#FFFFFF', minHeight: '100vh', paddingTop: 'var(--header-h)' }}>
        ...
        {/* Hero texte */}
        <div className="eng-hero" style={{ background: '#111111', padding: '100px 72px 80px' }}>
          <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
            ...
            <h1 style={{ fontFamily: "'Baskerville Display PT', Georgia, serif", fontSize: 'clamp(36px, 5.5vw, 76px)', fontWeight: 400, lineHeight: 1.0, letterSpacing: '-0.01em', color: '#FFFFFF', marginBottom: '32px', maxWidth: '800px' }}>
              Ce qui est vrai<br />dans ce qu'on fait.
            </h1>
            <p style={{ fontFamily: "'Neue Montreal', sans-serif", fontSize: '16px', lineHeight: 1.8, color: 'rgba(255,255,255,0.55)', maxWidth: '560px' }}>
        ...
        {/* Chiffres */}
        <div className="eng-chiffres" style={{ borderBottom: '1px solid rgba(17,17,17,0.07)', maxWidth: '1440px', margin: '0 auto', padding: '0 72px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', borderLeft: '1px solid rgba(17,17,17,0.07)' }}>
            {chiffres.map((c, i) => (
              <div key={i} style={{ padding: '48px 40px', borderRight: '1px solid rgba(17,17,17,0.07)' }}>
                <p style={{ fontFamily: "'Baskerville Display PT', Georgia, serif", fontSize: 'clamp(36px, 4vw, 56px)', fontWeight: 400, color: 'var(--accent)', lineHeight: 1, marginBottom: '8px' }}>
                  {c.val}<span style={{ fontSize: '0.5em', color: 'var(--text-secondary)', fontFamily: "'Neue Montreal', sans-serif', verticalAlign: 'middle', marginLeft: '4px'" }}>{c.unit}</span>
                </p>
