export const FORMULES = [
  /* ── COCKTAILS ─────────────────────────────────────────────────── */
  {
    ...
    prixNum: 22,
    descCourt: "Une sélection raffinée de pièces sucrées artisanales pour vos pauses premium et accueils clients.",
    ...
    seoArticle: `
      ...
      <h2>Pourquoi choisir le cocktail sucré pour vos événements ?</h2>
      <p>Un plateau de biscuits industriels, tout le monde sait ce que c'est. Une sélection de pièces sucrées artisanales — madeleine fleur d'oranger, macaron signature, panna cotta vanille — c'est une autre expérience. Vos clients, partenaires ou collaborateurs le remarquent immédiatement. C'est ce détail qui transforme une pause en moment mémorable.</p>

      <h2>Format et quantités</h2>
      <p>Comptez <strong>8 pièces par personne</strong> pour une pause de 45 minutes à 1h. Pour un accueil client ou une conférence, ce format est idéal : suffisamment généreux pour créer un vrai moment, assez léger pour ne pas peser sur l'après-midi. Commandez au minimum <strong>48h à l'avance</strong> pour garantir la fraîcheur et la disponibilité des pièces artisanales.</p>

      <h2>Livraison à Paris et en Île-de-France</h2>
      <p>L'Écrin Traiteur livre dès <strong>6h30</strong>, du lundi au vendredi, dans tout Paris et l'Île-de-France. Facturation entreprise avec TVA disponible. Devis personnalisé sous 24h pour les volumes ou les événements récurrents.</p>
    `,
  },
  {
    ...
    prixNum: 36,
    descCourt: "Un cocktail généreux et moderne pour vos déjeuners debout, réunions et moments de networking.",
    ...
    seoArticle: `
      ...
      <h2>Pourquoi ce format s'impose pour les déjeuners de travail ?</h2>
      <p>Un repas assis demande une salle dédiée, un service, une logistique. Le cocktail déjeunatoire s'installe dans n'importe quelle salle de réunion ou espace de convivialité. Tout le monde circule, les échanges sont naturels, la réunion peut reprendre sans transition. Pour les journées de formation, les séminaires ou les réunions de direction, c'est le format le plus apprécié des équipes RH parisiennes.</p>

      <h2>Composition et équilibre</h2>
      <p>9 pièces salées — focaccias, navettes, wraps, clubs sandwiches, verrines — et 3 pièces sucrées pour finir sur une note gourmande. L'équilibre est pensé pour que chacun soit rassasié, quelle que soit son appétit. Les régimes alimentaires spécifiques (végétarien, sans gluten) peuvent être adaptés sur demande.</p>

      <h2>Commander votre cocktail déjeunatoire à Paris</h2>
      <p>Livraison <strong>dès 6h30</strong>, commandez avant <strong>14h la veille</strong>. Pour les volumes de plus de 30 personnes, anticipez 48h. Facturation entreprise disponible. Devis sous 24h.</p>
    `,
  },
  {
    ...
    prixNum: 58,
    descCourt: "Cocktail dînatoire d'entreprise à Paris : 18 pièces salées et sucrées par personne pour vos soirées, lancements et réceptions. Livré en Île-de-France.",
    ...
    seoArticle: `
      ...
      <p>Soirées d'entreprise, lancements de produit, événements presse, réceptions client, team buildings en soirée : le cocktail dînatoire s'adapte à tous les contextes où vous voulez créer un moment fort sans la rigidité d'un repas assis. Le format favorise les rencontres, les échanges informels et la circulation naturelle entre les invités.</p>

      <h2>Composition pensée pour durer</h2>
      <p>14 pièces salées — brioches, focaccias, tartares, fingerfood — et 4 pièces sucrées pour conclure avec élégance. La variété des produits garantit qu'il n'y a pas deux bouchées identiques au cours de la soirée. Chaque pièce est pensée pour se déguster facilement debout, sans couvert, sans assiette.</p>

      <h2>Livraison et logistique</h2>
      <p>Livraison dans vos locaux ou dans l'espace événementiel de votre choix, partout en Île-de-France. Pour les soirées, livraison possible jusqu'à 20h. Commandez <strong>72h à l'avance</strong> pour les événements de plus de 20 personnes. Devis personnalisé sous 24h.</p>
    `,
  },
  {
    ...
    prixNum: 78,
    descCourt: "L'expérience événementielle signature de la maison. Pour les événements les plus exclusifs.",
    ...
    seoArticle: `
      <h2>La Signature L'Écrin : notre formule la plus exclusive</h2>
      <p>La <strong>Signature L'Écrin</strong> est notre création la plus ambitieuse. 22 pièces par personne — 16 salées et 6 sucrées — entièrement composées de créations artisanales premium. Chaque pièce a été sélectionnée pour son niveau d'exécution, sa présentation et son impact sensoriel. C'est la formule que nous recommandons pour les événements qui doivent marquer durablement les esprits.</p>

      <h2>Une composition d'exception</h2>
      <p>Mini lobster roll, brioche saumon gravlax, focaccia truffe & burrata, tartare de daurade aux agrumes : la partie salée de la Signature L'Écrin sort résolument du registre classique. Les pièces sucrées — chou praliné, macaron signature, verrine citron & lemon curd — concluent l'expérience avec la même exigence. Aucun produit industriel, aucune concession sur la qualité.</p>

      <h2>Pour quels événements ?</h2>
      <p>Lancements de produit, réceptions VIP, événements presse, soirées de prestige d'entreprise : la Signature L'Écrin est pensée pour les occasions où l'ordinaire ne suffit pas. Elle s'adresse aux entreprises qui souhaitent que leur traiteur soit à la hauteur de leur image.</p>
