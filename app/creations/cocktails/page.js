...
export const FORMULES = [
  {
    ...
    sale: [
      'Gougères',
      'Chou Craquelin, Tapenade, Tomate & Mozzarella',
      'Pissaladière',
      'Millefeuille Betterave & Chèvre',
  ...
  },
  {
    ...
    seoHtml: `<p>La formule La Célébration est notre cocktail le plus abouti : 16 pièces salées et sucrées par personne, pour les réceptions les plus soignées. Langoustine au poireau et au gingembre, saumon mariné, crevette à la mangue : une palette large et travaillée qui tient lieu de vrai dîner debout pour une grande soirée d'entreprise.</p><h2>16 pièces pour une grande réception</h2><p>Côté salé : poireau, langoustine et gingembre, saumon mariné et betterave jaune, radis noir, mangue et crevette bio, brochette de poulet tandoori, mini cheeseburger servi chaud, gougères, chou craquelin à la tapenade, pissaladière, millefeuille betterave et chèvre, patate douce, feta et kalamata, gâteau de carotte au cerfeuil, melon, feta et menthe. Côté sucré : dôme praliné, tartelette tout chocolat, tartelette myrtilles et brochette de fruits frais.</p><h2>Organiser votre cocktail à Paris et en Île-de-France</h2><p>Prestation sur devis selon l'effectif, la date et le lieu. Livraison sur votre lieu de réception, installation possible, facturation entreprise avec TVA. Devis personnalisé sous 24h.</p>`,
...
export default function Cocktails() {
  return (
    <>
      ...
      <CategoryJsonLd
        name="Cocktails"
        path="/creations/cocktails"
        items={FORMULES.map(f => ({ name: `Cocktail ${f.label}`, url: `/creations/cocktails/${f.key}` }))}
      />
      <Footer />
    </>
  )
