...
export const PAUSES = [
  ...
  { id: 'cake-poire',
    seoTitle: `Cake poire pour vos goûters et pauses d'entreprise à Paris`,
    seoHtml: `<p>Un cake à la poire fait maison, servi tranché, une part par personne. Les morceaux de poire gardent la mie humide et allègent la bouche, c'est celui qu'on choisit quand on veut du fruit sans partir sur une tarte.</p><h2>Commander votre cake poire à Paris et en Île-de-France</h2><p>Format à partager selon l'effectif, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cake poire maison',                  img: '/prod-cake-poire.webp',     prix: '5/6 pers, 13,90 €', description: 'Cake poire fait maison, tranché sur plateau.' },
  { id: 'cake-framboise',
    seoTitle: `Cake framboise pour vos goûters et pauses d'entreprise à Paris`,
    seoHtml: `<p>Un cake à la framboise fait maison, servi tranché, une part par personne. L'acidité du fruit casse le sucre et réveille un plateau un peu sage, sans jamais dominer la mie.</p><h2>Commander votre cake framboise à Paris et en Île-de-France</h2><p>Format à partager selon l'effectif, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cake framboise maison',              img: '/prod-cake-framboise.webp', prix: '5/6 pers, 13,90 €', description: 'Cake framboise fait maison, tranché sur plateau.' },
  { id: 'cake-chocolat',
    seoTitle: `Cake pépites de chocolat pour vos pauses d'entreprise à Paris`,
    seoHtml: `<p>Un cake aux pépites de chocolat fait maison, servi tranché, une part par personne. Plus dense que ses cousins fruités, c'est celui qui tient au corps sur une matinée de réunions à rallonge, avec un café serré.</p><h2>Commander votre cake pépites de chocolat à Paris et en Île-de-France</h2><p>Format à partager selon l'effectif, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cake pépites de chocolat maison',    img: '/prod-cake-chocolat.webp',  prix: '5/6 pers, 13,90 €', description: 'Cake pépites de chocolat fait maison, tranché sur plateau.' },
  { id: 'cake-pistache',
    seoTitle: `Cake pistache pour vos accueils et pauses d'entreprise à Paris`,
    seoHtml: `<p>Un cake à la pistache fait maison, servi tranché, une part par personne. Pâte de pistache travaillée dans la masse et éclats concassés : couleur naturelle, goût torréfié. Celui qu'on sort pour un accueil qu'on veut soigner. Contient des fruits à coque.</p><h2>Commander votre cake pistache à Paris et en Île-de-France</h2><p>Format à partager selon l'effectif, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cake pistache maison',               img: '/prod-cake-pistache.webp',  prix: '5/6 pers, 13,90 €', description: 'Cake pistache fait maison, tranché sur plateau. Contient des fruits à coque.' },
  { id: 'cookie',
