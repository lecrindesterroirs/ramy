...
export const PAUSES = [
  ...
  { id: 'brownie',
    ...
    nom: 'Brownie fondant maison',                     img: '/prod-brownie.webp', prix: '6 pièces, 19,90 €',        description: 'Brownie fondant au chocolat intense, coupé.' },
  { id: 'carrot-cake',
    ...
    nom: 'Carrot cake maison',           img: '/prod-carrot-cake.webp', prix: '5/6 pers, 14,90 €',    description: 'Tranché sur plateau' },
  { id: 'cake-citron',
    ...
    nom: 'Cake citron pavot maison',           img: '/prod-cake-citron-pavot.webp', prix: '5/6 pers, 14,90 €', description: 'Tranché sur plateau' },
  { id: 'cake-marbre',
    ...
    nom: 'Cake marbré maison',                 img: '/prod-cake-marbre.webp',    prix: '5/6 pers, 14,90 €', description: 'Tranché sur plateau' },
  { id: 'cookie',
    ...
    nom: 'Assortiments de cookies signature',            img: '/prod-cookies.webp',        prix: '6 pièces, 17,90 €', description: 'Pause · Caramel beurre salé, Pépite de chocolat, Pistache, Chocolat blanc' },
  ...
  { id: 'mousse-chocolat',
    ...
    nom: 'Véritable mousse au chocolat',           img: '/prod-mousse-chocolat.webp', prix: '6 pièces, 18,90 €', description: 'Mousse au chocolat intense, texture aérienne.' },
  { id: 'panna-cotta',
    ...
    nom: 'Panna cotta maison',                 img: '/prod-panna-cotta.webp',    prix: '6 pièces, 16,90 €', description: 'Crème fleurette entière, fruits rouges frais. Texture crémeuse et délicate avec coulis généreux.' },
  { id: 'verrine-citron',
    ...
    nom: 'Verrine Lemon Curd', img: '/prod-verrine-citron.webp', prix: '6 pièces, 16,90 €', description: 'Verrine lemon curd, fraîcheur acidulée en fin de repas.' },
  { id: 'choux',
