...
export const PAUSES = [
  ...
  { id: 'macarons',
    ...
    seoHtml: `<p>Nos macarons jouent la carte des ganaches délicates et d'un assortiment de saveurs qui change à chaque bouchée. En pause d'après-midi ou sur un buffet de réception, ils apportent une touche fine et colorée qui se remarque. Un classique de la pâtisserie qui fait toujours son effet auprès des équipes comme des clients.</p><h2>Commander vos macarons à Paris et en Île-de-France</h2><p>Assortiment à adapter à l'effectif et à l'occasion, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis personnalisé sous 24h.</p>`,
    nom: 'Macarons d\'exception',                    img: '/prod-macarons.webp',       prix: '24 pièces, 64,00 €', description: 'Macarons aux ganaches délicates, assortiment de saveurs.' },
  { id: 'brownie',
    seoTitle: `Brownie fondant pour vos goûters et pauses d'entreprise à Paris`,
    seoHtml: `<p>Notre brownie fondant au chocolat intense se sert à couper, en parts généreuses. C'est la valeur sûre d'un goûter d'équipe : réconfortant, facile à partager et suffisamment riche pour caler une fin d'après-midi de travail. Une douceur simple et efficace, préparée maison.</p><h2>Commander votre brownie à Paris et en Île-de-France</h2><p>Format à ajuster selon le nombre de gourmands, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Brownie fondant maison',                     img: '/prod-brownie.webp', prix: '6 pièces, 19,90 €',        description: 'Brownie fondant au chocolat intense, servi à couper.' },
  { id: 'carrot-cake',
    seoTitle: `Carrot cake pour vos pauses gourmandes d'entreprise à Paris`,
    seoHtml: `<p>Notre carrot cake moelleux aux épices se sert à couper, en tranches parfumées à la cannelle et aux fruits secs. En pause d'après-midi, il change du chocolat et séduit ceux qui aiment les gâteaux un peu plus caractériels. Une part suffit à transformer une réunion en moment convivial.</p><h2>Commander votre carrot cake à Paris et en Île-de-France</h2><p>Format à partager selon l'effectif, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis personnalisé sous 24h.</p>`,
    nom: 'Carrot Cake',           img: '/prod-carrot-cake.webp', prix: '5/6 pers, 14,90 €',    description: 'Carrot cake moelleux aux épices, servi à couper.' },
  { id: 'cake-citron',
    seoTitle: `Cake citron pavot pour vos pauses d'entreprise à Paris`,
    seoHtml: `<p>Notre cake au citron et graines de pavot est préparé maison et servi tranché. Acidulé, moelleux et pas trop sucré, il accompagne parfaitement un café de milieu d'après-midi ou une réunion qui s'étire. Une douceur légère qui plaît à ceux qui fuient le trop-riche.</p><h2>Commander votre cake citron pavot à Paris et en Île-de-France</h2><p>Format à partager selon le nombre de convives, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cake Citron Pavot',           img: '/prod-cake-citron-pavot.webp', prix: '5/6 pers, 14,90 €', description: 'Cake maison au citron et graines de pavot, tranché.' },
  { id: 'cake-marbre',
    seoTitle: `Cake marbré pour vos goûters et pauses d'entreprise à Paris`,
    seoHtml: `<p>Notre cake marbré chocolat-vanille, servi tranché, est le goûter d'enfance qui met tout le monde d'accord. Moelleux et sans chichi, il accompagne un café d'équipe ou une pause de l'après-midi sans jamais décevoir. Une valeur sûre, préparée maison.</p><h2>Commander votre cake marbré à Paris et en Île-de-France</h2><p>Format à partager selon l'effectif, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cake Marbré',                 img: '/prod-cake-marbre.webp',    prix: '5/6 pers, 14,90 €', description: 'Cake marbré chocolat-vanille, tranché.' },
  { id: 'cookie',
    seoTitle: `Cookie pour vos pauses et goûters d'entreprise à Paris`,
    seoHtml: `<p>Notre cookie généreux aux pépites de chocolat est le format nomade par excellence : on l'attrape entre deux réunions, on le partage sans couvert, il ne fait pas de miettes de logistique. Croustillant sur les bords, fondant au centre, c'est la douceur qui accompagne un café d'après-midi sans chichi.</p><h2>Commander vos cookies à Paris et en Île-de-France</h2><p>Quantité à ajuster selon l'effectif, commande avant 14h la veille, livraison dès 6h30 dans vos bureaux. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Cookie Signature',            img: '/prod-cookies.webp',        prix: '6 pièces, 17,90 €', description: 'Cookie généreux aux pépites de chocolat.' },
  { id: 'tartelette-citron',
    seoTitle: `Tartelette citron pour vos pauses et réceptions d'entreprise à Paris`,
    seoHtml: `<p>Notre tartelette au citron meringuée joue le contraste : un crémeux acidulé, une meringue légère, une pâte croustillante. En fin de déjeuner ou en pause d'après-midi, elle apporte une note fraîche qui réveille après un repas. Une pâtisserie individuelle, nette à servir debout.</p><h2>Commander vos tartelettes citron à Paris et en Île-de-France</h2><p>Quantité à adapter à l'effectif, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis personnalisé sous 24h.</p>`,
    nom: 'Tartelette Citron',        img: '/prod-tartelette-citron.webp', prix: '6 pièces, 17,90 €', description: 'Tartelette au citron meringuée, crémeux acidulé.' },
  { id: 'tartelette-praline',
    seoTitle: `Tartelette praliné pour vos pauses gourmandes d'entreprise à Paris`,
    seoHtml: `<p>Notre tartelette au praliné maison mise sur le croustillant noisette et une ganache généreuse. Plus gourmande que la version citron, elle ravit les amateurs de chocolat et de fruits secs lors d'une pause d'après-midi ou d'une réception. Une pièce individuelle, dressée avec soin.</p><h2>Commander vos tartelettes praliné à Paris et en Île-de-France</h2><p>Quantité selon l'effectif, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Tartelette Praliné',      img: '/prod-tartelette-praline.webp', prix: '6 pièces, 17,90 €', description: 'Tartelette au praliné maison, croustillant noisette.' },
  { id: 'mousse-chocolat',
    seoTitle: `Mousse au chocolat pour vos pauses et déjeuners d'entreprise à Paris`,
    seoHtml: `<p>Notre mousse au chocolat intense joue la texture aérienne et le chocolat qui a du caractère. Dressée en verrine individuelle, elle se sert à la cuillère, sans découpe ni service compliqué. Un dessert qui clôt un déjeuner d'équipe ou ponctue une pause gourmande avec élégance.</p><h2>Commander vos mousses au chocolat à Paris et en Île-de-France</h2><p>Nombre de verrines selon l'effectif, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Mousse au chocolat maison',           img: '/prod-mousse-chocolat.webp', prix: '6 pièces, 18,90 €', description: 'Mousse au chocolat intense, texture aérienne.' },
  { id: 'panna-cotta',
    seoTitle: `Panna cotta pour vos pauses et déjeuners d'entreprise à Paris`,
    seoHtml: `<p>Notre panna cotta vanille est dressée en verrine individuelle, prête à servir. Douce, crémeuse et légère, elle finit un déjeuner d'équipe sans lourdeur et se déguste à la cuillère, debout ou assis. Un dessert simple et net, qui plaît à tous les palais.</p><h2>Commander vos panna cottas à Paris et en Île-de-France</h2><p>Nombre de verrines selon l'effectif, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis personnalisé sous 24h.</p>`,
    nom: 'Panna cotta maison',                 img: '/prod-panna-cotta.webp',    prix: '6 pièces, 16,90 €', description: 'Panna cotta vanille, dressée en verrine individuelle.' },
  { id: 'verrine-citron',
    seoTitle: `Verrine citron lemon curd pour vos pauses d'entreprise à Paris`,
    seoHtml: `<p>Notre verrine au lemon curd mise sur la fraîcheur acidulée : un crémeux citron vif, servi en verrine individuelle. En fin de repas ou en pause d'après-midi, elle réveille les papilles après un plat et se déguste sans couvert compliqué. Une note légère et vive.</p><h2>Commander vos verrines citron à Paris et en Île-de-France</h2><p>Nombre de verrines selon l'effectif, commande avant 14h la veille, livraison dès 6h30. Facturation entreprise avec TVA, devis sous 24h.</p>`,
    nom: 'Verrine Citron / Lemon Curd', img: '/prod-verrine-citron.webp', prix: '6 pièces, 16,90 €', description: 'Verrine lemon curd, fraîcheur acidulée en fin de repas.' },
  { id: 'choux',
    ...
    nom: 'Choux',                       img: '/prod-choux.webp', prix: '24 pièces, 64,00 €',          description: 'Choux garnis assortis, glaçages et crèmes aux parfums variés.' },
  { id: 'babka',
    ...
    nom: 'Babka',                       img: '/prod-babka.webp', prix: '5/6 pers, 24,90 €',          description: 'Babka briochée roulée au chocolat, tranchée.' },
  { id: 'tartes-fines',
    ...
    nom: 'Tartes Fines',                img: '/prod-tartes-fines.webp', prix: '6 pièces, 24,90 €',   description: 'Tartes fines aux fruits de saison, à partager.' },
  { id: 'yaourt-fruits',
  ...
  { id: 'brochettes-fruits',
    ...
    nom: 'Brochettes de Fruits',    img: '/prod-brochettes.webp',    prix: '20 brochettes, 48,90 €', description: 'Brochettes de fruits frais de saison, à picorer.' },
  ...
  { id: 'crepes',
    ...
    nom: 'Crêpes',                      img: '/prod-crepes.webp',         prix: '20 crêpes, 58,90 €', description: 'Crêpes sucrées préparées le jour même, garnitures au choix.' },
]
