...
export const PAUSES = [
  ...
  { id: 'carrot-cake',
    ...
    nom: 'Carrot cake maison',           img: '/prod-carrot-cake.webp', prix: '5/6 pers, 14,90 €',    description: 'Carrot cake signé notre chef pâtissier, tranché sur plateau.' },
  { id: 'cake-citron',
    ...
    nom: 'Cake citron pavot maison',           img: '/prod-cake-citron-pavot.webp', prix: '5/6 pers, 14,90 €', description: 'Cake citron pavot fait maison, tranché sur plateau.' },
  { id: 'cake-marbre',
    ...
    nom: 'Cake marbré maison',                 img: '/prod-cake-marbre.webp',    prix: '5/6 pers, 14,90 €', description: 'Cake marbré fait maison, tranché sur plateau.' },
  { id: 'cookie',
  ...
  { id: 'tarte-framboise-grand-format',
    ...
    nom: 'Grande Tarte aux Framboises',   img: '/prod-tarte-framboise-partager.webp', prix: '10-12 pers, 54,90 €', description: 'Pâte sablée, crémeux vanille et framboises fraîches. Le grand gâteau à partager pour vos anniversaires et moments d\'équipe.' },
  { id: 'gateau-praline-noisette-partager',
    ...
    nom: 'Grand Gâteau Praliné Noisette',  img: '/prod-gateau-praline-partager.webp', prix: '10-12 pers, 59,90 €', description: 'Dacquoise croustillante, praliné généreux et mousse légère. Le grand gâteau à partager pour vos célébrations d\'équipe.' },
  { id: 'fraisier-grand-format',
    ...
    nom: 'Fraisier à Partager',           img: '/prod-fraisier-partager.webp', prix: '10-12 pers, 54,90 €', description: 'Biscuit léger, crème mousseline et fraises fraîches. Le grand gâteau à partager pour vos anniversaires d\'équipe.' },
  { id: 'tarte-citron-meringuee-grande',
    ...
    nom: 'Grande Tarte au Citron Meringuée', img: '/prod-tarte-citron-partager.webp', prix: '10-12 pers, 49,90 €', description: 'Crémeux citron vif et meringue dorée à la torche. Le grand gâteau à partager pour vos célébrations d\'équipe.' },
  { id: 'gateau-roule-fraise-partager',
    ...
    nom: 'Gâteau Roulé Fraise & Vanille',  img: '/prod-buche-fraise-partager.webp', prix: '8-10 pers, 44,90 €', description: 'Biscuit moelleux, crème légère et fraises fraîches, roulé. Le gâteau à partager pour vos goûters d\'anniversaire d\'équipe.' },
]
