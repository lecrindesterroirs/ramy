...
const fallback = [
  ...
  { name: 'Cake marbré maison',                label: '6/8 pers — 12,90€',    img: '/creations-2.png' },
  { name: 'Cake poire maison',                 label: '6/8 pers — 12,90€',    img: '/creations-featured.webp' },
  { name: 'Cake framboise',                    label: '6/8 pers — 12,90€',    img: '/creations-3.png' },
  { name: 'Cake pépites de chocolat',          label: '6/8 pers — 12,90€',    img: '/creations-4.png' },
  { name: 'Cake pistache maison',              label: '6/8 pers — 12,90€',    img: '/creations-1.png' },
  { name: 'Cake citron maison',                label: '6/8 pers — 12,90€',    img: '/creations-2.png' },
