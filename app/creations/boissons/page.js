...
const SEO_ARTICLE = `
  ...
  <p>Nos jus artisanaux sont issus de fruits entiers, sans concentré, sans sucre ajouté. Les jus <strong>Alain Milliat</strong> (nectar de fraise, poire Williams, pur jus d'orange) sont reconnus des connaisseurs. Les jus du <strong>Verger de Plaisir</strong> (Yvelines) sont produits en circuit ultra-court. Les thés <strong>Mariage Frères</strong> et nos thermoss de café ou chocolat chaud complètent une offre pensée pour tous les moments de la journée.</p>

  <h2>Boissons froides et chaudes, du matin à l'après-midi</h2>
  <p>Pour un <strong>petit-déjeuner</strong> : jus froids + thermos de café ou thé. Pour une <strong>pause après-midi</strong> : boissons froides sans alcool, citronnade JOMO, jus de saison. Pour un <strong>cocktail</strong> : jus Alain Milliat premium + eaux pétillantes. Nos thermoss maintiennent vos boissons chaudes plusieurs heures après la livraison, pratique pour les séminaires de journée entière.</p>
  ...
  return (
    <ProductsPageTemplate
      ...
      editorial={{
        ...
        title: 'Jus d\'exception et boissons artisanales',
        body: "Jus de fruits entiers Alain Milliat, thés Mariage Frères, cafés servis en thermos : la boisson est le détail que vos invités remarquent. Nous la choisissons avec la même exigence que le reste de la table.",
      }}
    />
  )
}
