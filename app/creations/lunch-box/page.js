...
export const BOXES = [
  {
    ...
    nom: "La Parisienne",
    prix: "19,90",
    img: "/lunchbox-parisienne.webp",
    sousTitre: "Poulet Mayonnaise · Baguette ou viennois",
    entree: "Salade de concombre à la ciboulette ou tomate & mozzarella, au choix",
    plat: "Poulet Mayonnaise, en baguette ou pain viennois",
    dessert: "Part de cake ou madeleine, au choix",
  ...
  },
  {
    ...
    nom: "L'Épicée",
    prix: "19,90",
    img: "/lunchbox-cesar.webp",
    sousTitre: "Poulet Curry · Baguette ou viennois",
    entree: "Salade de concombre à la ciboulette ou tomate & mozzarella, au choix",
    plat: "Poulet Curry, en baguette ou pain viennois",
    dessert: "Part de cake ou madeleine, au choix",
    description: "Un sandwich en baguette ou pain viennois, une entrée et un dessert au choix, serviette & couverts. Boisson en option.",
  },
  {
    seoTitle: `La Croustillante : la lunch box poulet croustillant pour vos déjeuners d'entreprise à Paris`,
    seoHtml: `<p>La Croustillante mise sur la gourmandise : un sandwich au poulet croustillant, qui cale un déjeuner de travail chargé. Le sandwich est préparé en baguette de notre boulanger partenaire ou en pain viennois, au choix, avec une salade de concombre à la ciboulette ou de tomate et mozzarella en entrée, et une part de cake ou une madeleine en dessert.</p><h2>Le poulet croustillant, en sandwich</h2><p>Sandwich poulet croustillant, entrée et dessert au choix, serviette et couverts inclus. Préparée le matin même, prête à emporter en réunion ou à servir en salle.</p><h2>Commander vos lunch box à Paris et en Île-de-France</h2><p>Commande avant 14h la veille, livraison dès 6h30 sur site. Effectifs variables, régimes particuliers, facturation entreprise avec TVA. Devis personnalisé sous 24h.</p>`,
    id: "lb8",
    categorie: "poulet",
    nom: "La Croustillante",
    prix: "19,90",
    img: "/lunchbox-cesar-baguette.webp",
    sousTitre: "Poulet Croustillant · Baguette ou viennois",
    entree: "Salade de concombre à la ciboulette ou tomate & mozzarella, au choix",
    plat: "Poulet Croustillant, en baguette ou pain viennois",
    dessert: "Part de cake ou madeleine, au choix",
    description: "Un sandwich en baguette ou pain viennois, une entrée et un dessert au choix, serviette & couverts. Boisson en option.",
  },
  {
    ...
    nom: "La Fermière",
    prix: "19,90",
    img: "/plateau-baguettes.webp",
    sousTitre: "Œuf & Emmental · Baguette ou viennois",
    entree: "Salade de concombre à la ciboulette ou tomate & mozzarella, au choix",
    plat: "Œuf & Emmental, en baguette ou pain viennois",
    dessert: "Part de cake ou madeleine, au choix",
    description: "Un sandwich en baguette ou pain viennois, une entrée et un dessert au choix, serviette & couverts. Boisson en option.",
  },
  {
    ...
    nom: "La Nordique",
    prix: "19,90",
    img: "/lunchbox-nordique.webp",
    sousTitre: "Saumon & Avocat · Baguette ou viennois",
    entree: "Salade de concombre à la ciboulette ou tomate & mozzarella, au choix",
    plat: "Saumon & Avocat, en baguette ou pain viennois",
    dessert: "Part de cake ou madeleine, au choix",
    description: "Un sandwich en baguette ou pain viennois, une entrée et un dessert au choix, serviette & couverts. Boisson en option.",
  },
  {
    ...
    nom: "L'Océane",
    prix: "19,90",
    img: "/lunchbox-thon.webp",
    sousTitre: "Thon Mayonnaise · Baguette ou viennois",
    entree: "Salade de concombre à la ciboulette ou tomate & mozzarella, au choix",
    plat: "Thon Mayonnaise, en baguette ou pain viennois",
    dessert: "Part de cake ou madeleine, au choix",
    description: "Un sandwich en baguette ou pain viennois, une entrée et un dessert au choix, serviette & couverts. Boisson en option.",
  },
  {
    ...
    nom: "La Marine",
    prix: "24,90",
    img: "/lunchbox-marine.webp",
    sousTitre: "Coffret Signature · Club Saumon Fumé",
    entree: "Au choix : semoule à l'orange & pois chiches, salade grecque, mafaldine tomates confites & mozzarella, ou avocat & grenade",
    plat: "Club Saumon Fumé",
    dessert: "Au choix : tarte abricot-amande, Paris-Brest déstructuré, moelleux au chocolat, ou panna cotta aux fruits rouges",
  ...
  {
    seoTitle: `La Piémontaise : le coffret déjeuner wrap vitello tonnato pour vos réunions d'entreprise à Paris`,
    seoHtml: `<p>La Piémontaise revisite un classique italien : un wrap au quasi de veau façon vitello tonnato, avec salade et oignons frits. Le coffret complet se compose de la salade et du dessert de votre choix, avec une bouteille d'eau, pour un déjeuner de travail plus soigné qu'un simple sandwich.</p><h2>Le vitello tonnato, en wrap</h2><p>Salades au choix : semoule à l'orange et pois chiches, salade grecque, mafaldine aux tomates confites et mozzarella, avocat et grenade. Desserts au choix : tarte abricot-amande, Paris-Brest déstructuré, moelleux au chocolat, panna cotta aux fruits rouges.</p><h2>Commander vos lunch box à Paris et en Île-de-France</h2><p>Commande avant 14h la veille, livraison dès 6h30 sur site. Effectifs variables, régimes particuliers, facturation entreprise avec TVA. Devis personnalisé sous 24h.</p>`,
    id: "lb6",
    categorie: "viande",
    nom: "La Piémontaise",
    prix: "24,90",
    img: "/plateau-wraps.webp",
    sousTitre: "Coffret Signature · Wrap Vitello Tonnato",
    entree: "Au choix : semoule à l'orange & pois chiches, salade grecque, mafaldine tomates confites & mozzarella, ou avocat & grenade",
    plat: "Wrap Vitello Tonnato",
    dessert: "Au choix : tarte abricot-amande, Paris-Brest déstructuré, moelleux au chocolat, ou panna cotta aux fruits rouges",
    boisson: "Bouteille d'eau incluse",
    description: "Un coffret individuel complet : un sandwich, une salade et un dessert au choix, bouteille d'eau incluse.",
  },
